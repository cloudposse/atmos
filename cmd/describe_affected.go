...
func init() {
	...
	describeAffectedCmd.PersistentFlags().Bool("upload", false, "Upload the affected components and stacks to a specified endpoint: atmos describe affected --upload=true")
