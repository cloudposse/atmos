...
func init() {
	...
	describeComponentCmd.PersistentFlags().Bool("process-templates", true, "Enable/disable Go template processing in Atmos stack manifests when executing the command: atmos describe component &ltcomponent&gt -s &ltstack&gt --process-templates=false")
	describeComponentCmd.PersistentFlags().Bool("process-functions", true, "Enable/disable YAML functions processing in Atmos stack manifests when executing the command: atmos describe component &ltcomponent&gt -s &ltstack&gt --process-functions=false")
	describeComponentCmd.PersistentFlags().StringSlice("skip", nil, "Skip executing a YAML function in the Atmos stack manifests when executing the command: atmos describe component &ltcomponent&gt -s &ltstack&gt --skip=terraform.output")
