...
func init() {
	...
	describeComponentCmd.PersistentFlags().Bool("process-yaml-functions", true, "Enable/disable YAML functions processing in Atmos stack manifests when executing the command: atmos describe component <component> -s <stack> --process-yaml-functions=false")
