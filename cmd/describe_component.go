...
func init() {
	...
	describeComponentCmd.PersistentFlags().Bool("process-templates", false, "Enable/disable Go template processing in Atmos stack manifests when executing the command: atmos describe component <component> -s <stack> --process-templates=false")
