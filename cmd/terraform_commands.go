...
func attachTerraformCommands(parentCmd *cobra.Command) {
	...
	parentCmd.PersistentFlags().Bool("include-dependents", false, "Include the dependent components and process them in the dependency order: atmos terraform <sub-command> --affected --include-dependents=true")
