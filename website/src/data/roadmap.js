  ...
  initiatives: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: '`atmos aws security` CLI command', status: 'shipped', quarter: 'q1-2026', docs: '/cli/commands/aws/security', prd: 'atmos-aws-security-compliance', description: 'Primary command for security analysis. Fetches findings, maps to components, and generates reports with severity and source filtering.', benefits: 'Single command replaces navigating multiple AWS console pages. See all findings mapped to your infrastructure code.' },
        { label: '`atmos aws compliance` CLI command', status: 'shipped', quarter: 'q1-2026', docs: '/cli/commands/aws/compliance', prd: 'atmos-aws-security-compliance', description: 'Compliance posture reports against CIS AWS, PCI DSS, SOC 2, HIPAA, and NIST frameworks.', benefits: 'Compliance score at a glance. Failing controls mapped to components with remediation steps.' },
