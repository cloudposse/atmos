...
export const roadmapConfig = {
  ...
  initiatives: [
    ...
    },
    {
      ...
      status: 'in-progress',
      milestones: [
        { label: 'Multi-provider AI support (7 providers)', status: 'shipped', quarter: 'q4-2025', docs: '/ai/providers', changelog: 'introducing-atmos-ai', description: 'Support for Anthropic Claude, OpenAI GPT, Google Gemini, xAI Grok, Ollama (local), AWS Bedrock, and Azure OpenAI.', benefits: 'Choose the right AI for your needs—cloud, local, or enterprise. Switch providers mid-conversation.' },
        { label: 'Interactive AI chat (`atmos ai chat`)', status: 'shipped', quarter: 'q4-2025', docs: '/cli/commands/ai/chat', changelog: 'introducing-atmos-ai', description: 'Interactive terminal chat with persistent sessions, markdown rendering, and conversation history.', benefits: 'Have natural conversations about your infrastructure. Context is preserved across sessions.' },
        { label: 'Session management with SQLite storage', status: 'shipped', quarter: 'q4-2025', docs: '/ai/sessions', changelog: 'introducing-atmos-ai', description: 'SQLite-backed persistent sessions with full CRUD operations, auto-compact, and retention policies.', benefits: 'Resume conversations days or weeks later with full context. Sessions are provider-aware.' },
        { label: 'Tool execution with permission controls', status: 'shipped', quarter: 'q4-2025', docs: '/ai/tools', changelog: 'introducing-atmos-ai', description: 'AI can execute read-only Atmos commands with three-tier permission system (allowed/restricted/blocked).', benefits: 'AI can inspect your infrastructure automatically. Granular control over what tools AI can use.' },
        { label: 'Persistent permission cache', status: 'shipped', quarter: 'q4-2025', docs: '/ai/tools', changelog: 'introducing-atmos-ai', description: 'Permission decisions persist across sessions in .atmos/ai.settings.local.json.', benefits: '80%+ reduction in permission prompts. Decisions are remembered across all AI sessions.' },
        { label: 'Project memory (ATMOS.md)', status: 'shipped', quarter: 'q4-2025', docs: '/ai/memory', changelog: 'introducing-atmos-ai', description: 'Persistent project context via ATMOS.md file that AI references across all sessions.', benefits: 'AI knows your project conventions. Reduce repetitive context loading.' },
        { label: 'Built-in specialized agents (5 agents)', status: 'shipped', quarter: 'q4-2025', docs: '/ai/agents', changelog: 'introducing-atmos-ai', description: 'General, Stack Analyzer, Component Refactor, Security Auditor, and Config Validator agents.', benefits: 'Task-specific AI expertise. Each agent has focused tools and system prompts.' },
        { label: 'MCP server integration', status: 'shipped', quarter: 'q4-2025', docs: '/ai/mcp-server', changelog: 'introducing-atmos-ai', description: 'Model Context Protocol server for Claude Desktop, VSCode, and other MCP clients.', benefits: 'Use Atmos tools from any MCP-compatible client. Standardized AI-to-tool communication.' },
        { label: 'LSP client for YAML/Terraform validation', status: 'shipped', quarter: 'q4-2025', docs: '/lsp/lsp-client', changelog: 'introducing-atmos-ai', description: 'Language Server Protocol client integrating yaml-language-server and terraform-ls with AI.', benefits: 'IDE-quality validation in AI chat. Precise error locations with suggested fixes.' },
        { label: 'LSP server for Atmos-specific features', status: 'shipped', quarter: 'q4-2025', docs: '/lsp/lsp-server', changelog: 'introducing-atmos-ai', description: 'Native LSP server with autocomplete, hover documentation, and validation for Atmos configurations.', benefits: 'IDE integration for any LSP-compatible editor. 13+ editors supported.' },
        { label: 'Token caching for cost savings', status: 'shipped', quarter: 'q4-2025', docs: '/ai/providers', changelog: 'introducing-atmos-ai', description: 'Prompt caching saves up to 90% on API costs by reusing system prompts and project memory.', benefits: 'Significant cost reduction for heavy AI usage. Automatic caching for most providers.' },
        { label: 'Non-interactive execution (`atmos ai exec`)', status: 'shipped', quarter: 'q4-2025', docs: '/cli/commands/ai/exec', changelog: 'introducing-atmos-ai', description: 'Execute AI prompts non-interactively with JSON output for CI/CD and scripting.', benefits: 'Automate AI-powered analysis in pipelines. Standard exit codes for error handling.' },
        { label: 'Session export/import', status: 'shipped', quarter: 'q4-2025', docs: '/cli/commands/ai/sessions', changelog: 'introducing-atmos-ai', description: 'Export sessions to JSON/YAML/Markdown for team collaboration and backup.', benefits: 'Share troubleshooting sessions with your team. Archive incident resolutions.' },
        { label: 'Automatic context discovery', status: 'shipped', quarter: 'q4-2025', docs: '/ai', changelog: 'introducing-atmos-ai', description: 'Intelligent file discovery using glob patterns with gitignore filtering and caching.', benefits: 'AI automatically finds relevant files. Better responses without manual file selection.' },
        { label: 'GitHub Actions integration', status: 'shipped', quarter: 'q4-2025', docs: '/integrations/github-actions/atmos-ai', changelog: 'introducing-atmos-ai', description: 'Official GitHub Action for automated PR reviews, security scans, and cost analysis.', benefits: 'Automated AI-powered PR reviews. Security scanning in CI/CD pipelines.' },
        { label: 'AI example with documentation', status: 'shipped', quarter: 'q1-2026', description: 'Complete example in examples/ai/ demonstrating all AI features with inline documentation links.', benefits: 'Learn AI features from working examples. Quick start for new users.' },
