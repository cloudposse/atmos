  ...
  initiatives: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'Project instructions (ATMOS.md)', status: 'shipped', quarter: 'q1-2026', docs: '/ai/memory', changelog: 'introducing-atmos-ai', description: 'Persistent project instructions via ATMOS.md file that AI references across all sessions.', benefits: 'AI knows your project conventions. Reduce repetitive context loading.' },
