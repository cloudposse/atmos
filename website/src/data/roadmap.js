  ...
  initiatives: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'Parallel acceptance tests', status: 'shipped', quarter: 'q1-2026', changelog: 'parallel-acceptance-tests', description: 'Acceptance tests now run in parallel by default using t.Parallel(). Eliminates CI env mutation, Terraform state-lock races, and stale-file pollution between runs. Individual tests opt out with parallel: false.', benefits: 'More reliable CI: fewer intermittent failures from shared state. Up to 23% faster on 2-core CI runners (Windows). Proportionally larger gains on multi-core developer machines.' },
