  ...
  initiatives: [
    {
      ...
      milestones: [
        ...
        { label: 'Lazy auth detection for list/describe commands', status: 'planned', quarter: 'q1-2026', prd: 'lazy-auth-detection', pr: 1957, description: 'Scan stack configurations for auth-requiring patterns (!terraform.state, !terraform.output, store.get) and only prompt for identity when those functions are actually used.', benefits: 'No unnecessary identity prompts for simple list/describe operations. Auth only triggers when stack configs require it.' },
      ],
      issues: [],
      prs: [
