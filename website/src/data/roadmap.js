  ...
  initiatives: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'Hands-on Labs (complete, copy-and-run reference projects)', status: 'shipped', quarter: 'q2-2026', changelog: 'introducing-hands-on-labs', docs: '/labs/aws-ami-packer-github-actions/guide', description: 'A new docs-site content tier of complete, end-to-end projects that combine multiple Atmos features into a working solution for a real-world use case. The first Lab builds, scans, approves, and shares hardened AWS AMIs with Atmos + Packer + GitHub Actions.', benefits: 'Clone a Lab, change a few documented values, and you have a working, production-shaped Atmos solution—instead of stitching together a dozen separate examples.' },
      ],
      issues: [],
      prs: [
