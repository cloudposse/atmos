  ...
  initiatives: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'Component-level retry for transient Terraform errors', status: 'shipped', quarter: 'q2-2026', docs: '/stacks/components/terraform/retry', changelog: 'terraform-component-retry', description: 'Per-component `retry:` block with regex-driven `conditions:` matched against captured terraform output. Wraps init, workspace, and main subprocess invocations independently with exponential/linear/constant backoff. Inherits across abstract components.', benefits: 'Unattended pipelines recover from 502 Bad Gateways, registry rate limits, and TLS handshake timeouts without manual re-runs. Real Terraform failures still fail fast because retry is opt-in per-pattern.' },
      ],
      issues: [],
      prs: [
        { number: 1891, title: 'Native CI Integration with Summary Templates and Terraform Command Registry' },
