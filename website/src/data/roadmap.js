  ...
  initiatives: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'Unified task execution (`pkg/runner`)', status: 'in-progress', quarter: 'q1-2026', pr: 1901, description: 'A single execution engine for all task types—Terraform, Helmfile, shell, and custom commands.', benefits: 'Consistent behavior across all command types. Same output handling, error reporting, and logging.' },
      ],
      issues: [],
      prs: [
