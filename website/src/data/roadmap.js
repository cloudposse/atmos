  ...
  initiatives: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: '3.5× faster deep merge', status: 'shipped', quarter: 'q1-2026', changelog: 'faster-deep-merge', description: 'Replace the reflection-based mergo pre-copy loop with a single-pass, reflection-free native merge. Reduces N full pre-copies per merge to 1 and eliminates mergo reflection overhead.', benefits: 'Faster atmos describe component, terraform plan, apply, and any command that reads stacks. Impact scales with stack depth and import chain length.' },
