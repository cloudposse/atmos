  ...
  initiatives: [
    {
      ...
      milestones: [
        ...
        { label: 'Azure Portal console access', status: 'shipped', quarter: 'q4-2025', docs: '/cli/commands/auth/console', description: 'Open Azure Portal in your browser using authenticated Atmos identity credentials.', benefits: 'Access Azure Portal with one command. No manual login or credential copying required.' },
        ...
        { label: 'AWS_REGION export from `atmos auth env`', status: 'shipped', quarter: 'q1-2026', docs: '/cli/commands/auth/env', description: 'Export AWS_REGION environment variable from atmos auth env when region is configured in the identity.', benefits: 'External tools like Terraform and AWS CLI automatically use the correct region without additional configuration.' },
