  ...
  initiatives: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'Reduce ExecuteDescribeStacks complexity 98%', status: 'shipped', quarter: 'q1-2026', pr: 0, changelog: 'describe-stacks-complexity-reduction', description: 'Broke down ExecuteDescribeStacks (cyclomatic 247 → 10, cognitive 1252 → 22) into 19 focused helper functions with 47 unit tests at 100% coverage for all pure helpers.', benefits: 'Easier to read, test, and extend the core stack processing pipeline. New component types can be added in one line.' },
      ],
      issues: [],
      prs: [],
    },
