  ...
  initiatives: [
    {
      ...
      milestones: [
        ...
        { label: 'Concurrent identities for multi-account components (auth.needs)', status: 'shipped', quarter: 'q1-2026', changelog: 'auth-needs-concurrent-identities', description: 'Components declare required identities via auth.needs. All identities are authenticated before Terraform runs, with profiles written to the shared credentials file.', benefits: 'Multi-account Terraform patterns with provider aliases work in CI with OIDC. No manual credential setup for hub-spoke networking or cross-account deployments.' },
      ],
      issues: [],
      prs: [
