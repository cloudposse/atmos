  ...
  initiatives: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'Native CI integration with summary templates', status: 'in-progress', quarter: 'q1-2026', pr: 1891, description: 'GitHub/GitLab-native summaries with formatted plan output, cost estimates, and approval workflows.', benefits: 'PR reviewers see formatted plans directly in GitHub. No clicking through to CI logs.' },
