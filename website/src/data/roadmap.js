  ...
  initiatives: [
    {
      ...
      milestones: [
        ...
        { label: 'Azure Service Principal', status: 'shipped', quarter: 'q1-2026', pr: 1974, changelog: 'azure-service-principal-provider', description: 'OAuth2 client credentials authentication for Azure service principals in automated environments.', benefits: 'Automate Azure deployments without human interaction. Service principals work identically in CI and locally.' },
