  ...
  initiatives: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'IDE integration via generate-config', status: 'shipped', quarter: 'q1-2026', pr: 2267, changelog: 'mcp-server-integrations', description: '`atmos mcp generate-config` produces a `.mcp.json` file compatible with Claude Code, Cursor, and other MCP-aware IDEs. Auth-wrapped servers use `atmos auth exec` to inject credentials into IDE-launched server processes.', benefits: 'IDEs get the same MCP servers configured in atmos.yaml without duplicate configuration. One source of truth for all MCP tooling.' },
