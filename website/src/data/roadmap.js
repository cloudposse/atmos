  ...
  initiatives: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'PR artifact installation via --use-version', status: 'shipped', quarter: 'q1-2026', pr: 2040, changelog: 'pr-artifact-installation', description: 'Test features from any PR by specifying pr:NNNN with --use-version. Automatically downloads the correct platform binary from GitHub Actions, caches it locally, and re-executes.', benefits: 'Test PR features without compiling from source or navigating GitHub Actions. One command to switch to any PR build.' },
