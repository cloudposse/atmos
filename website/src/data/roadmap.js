  ...
  initiatives: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'AI Agent Skills (16 domain skills)', status: 'shipped', quarter: 'q1-2026', changelog: 'ai-agent-skills', docs: '/integrations/ai/agent-skills', description: 'Atmos ships 16 domain-specific agent skills covering stacks, components, vendoring, terraform, helmfile, packer, ansible, workflows, custom-commands, auth, stores, schemas, gitops, validation, templates, and design-patterns. Compatible with Claude Code, Gemini CLI, Cursor, Windsurf, GitHub Copilot, and more.', benefits: 'AI coding assistants get deep knowledge of Atmos conventions and patterns. Contributors and users get AI assistance that understands Atmos stack configuration, orchestration, and best practices.' },
      ],
      issues: [],
      prs: [
