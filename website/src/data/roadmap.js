  ...
  initiatives: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'First-class `description` field on components and stacks', status: 'shipped', quarter: 'q1-2026', changelog: 'description-field-on-components-and-stacks', description: 'Native description field for stack manifests and individual components, surfaced in atmos describe output and available as a filterable section. Enables AI tooling to answer "what does this component do?" with meaningful context.', benefits: 'Large orgs can document 50+ components inline. AI assistants understand your infrastructure from stack definitions. Descriptions are schema-validated and show up in describe output.', category: 'featured', priority: 'high' },
      ],
      issues: [],
      prs: [
