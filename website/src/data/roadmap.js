  ...
  initiatives: [
    {
      ...
      milestones: [
        ...
        { label: 'Zero-config AWS SSO identity management', status: 'shipped', quarter: 'q4-2025', changelog: 'aws-sso-identity-auto-provisioning', version: 'v1.200.0', description: 'Automatic SSO identity provisioning without manual configuration—Atmos detects and configures SSO settings. Identities display with original case while supporting case-insensitive resolution.', benefits: 'Get started with AWS SSO instantly. No manual identity configuration required. Identity names are readable and match what you see in the AWS console.' },
