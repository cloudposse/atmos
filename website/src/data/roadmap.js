  ...
  initiatives: [
    {
      ...
      milestones: [
        ...
        { label: 'EKS Kubeconfig integration', status: 'in-progress', quarter: 'q4-2025', pr: 1884, description: 'Automatic kubeconfig generation for EKS clusters using Atmos-managed AWS credentials.' },
        { label: 'ECR Authentication', status: 'planned', quarter: 'q1-2026', pr: 1859, description: 'Native ECR login for container image operations without external tooling.' },
