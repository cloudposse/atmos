  ...
  initiatives: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'Tag-based finding-to-code mapping', status: 'shipped', quarter: 'q1-2026', prd: 'atmos-aws-security-compliance', description: 'Map findings to Atmos components using atmos:stack and atmos:component resource tags via Resource Groups Tagging API.', benefits: 'Instant, deterministic mapping from security findings to the exact Terraform code that manages the affected resource.' },
        { label: 'Heuristic finding-to-code mapping', status: 'shipped', quarter: 'q1-2026', prd: 'atmos-aws-security-compliance', description: 'Multi-strategy heuristic pipeline for resources without atmos tags: naming convention analysis and resource type matching.', benefits: 'Security analysis works even without resource tags. Multiple strategies provide confidence-scored matches.' },
        { label: '`atmos aws security analyze` CLI command', status: 'shipped', quarter: 'q1-2026', docs: '/cli/commands/aws/security/analyze', prd: 'atmos-aws-security-compliance', description: 'Primary command for security analysis. Fetches findings, maps to components, and generates reports with severity and source filtering.', benefits: 'Single command replaces navigating multiple AWS console pages. See all findings mapped to your infrastructure code.' },
        { label: '`atmos aws compliance report` CLI command', status: 'shipped', quarter: 'q1-2026', docs: '/cli/commands/aws/compliance/report', prd: 'atmos-aws-security-compliance', description: 'Compliance posture reports against CIS AWS, PCI DSS, SOC 2, HIPAA, and NIST frameworks.', benefits: 'Compliance score at a glance. Failing controls mapped to components with remediation steps.' },
        { label: 'Multi-format output (Markdown, JSON, YAML, CSV)', status: 'shipped', quarter: 'q1-2026', prd: 'atmos-aws-security-compliance', description: 'All commands support --format flag for different output formats. Markdown for terminal, structured formats for automation.', benefits: 'Pipe findings to dashboards, ticketing systems, Slack, or compliance reporting tools.' },
        { label: 'AI-powered analysis via `--ai` flag', status: 'shipped', quarter: 'q1-2026', prd: 'atmos-aws-security-compliance', description: 'Opt-in AI analysis adds root cause analysis, code-level remediation guidance, and deploy commands using any supported AI provider.', benefits: 'AI reads your component source code and generates targeted fixes with exact atmos terraform apply commands.' },
