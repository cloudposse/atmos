  ...
  initiatives: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'Lifecycle hooks and outputs for custom component types', status: 'shipped', quarter: 'q2-2026', pr: 2469, docs: '/stacks/hooks', changelog: 'custom-component-hooks', description: 'Custom component types fire before/after.<type>.<subcommand> lifecycle hooks and publish outputs via $ATMOS_OUTPUTS, so a store hook can persist results — the same apply→outputs→next-run loop Terraform has.', category: 'featured', priority: 'high', benefits: 'Persist what a custom command created (IDs, ARNs) to a store and read it back on the next run. Declarative write-back for any component type.' },
      ...
      prs: [
        ...
        { number: 2469, title: 'Lifecycle hooks and outputs for custom component types' },
