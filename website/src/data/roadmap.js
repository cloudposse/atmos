  ...
  initiatives: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'Raw Markdown pages and "Copy Markdown" button', status: 'shipped', quarter: 'q2-2026', changelog: 'copy-markdown-button', pr: 'TODO', description: 'Every doc page is now served as raw Markdown at <url>.md. A "Copy Markdown" / "View Markdown" button appears on each page. A <link rel="alternate" type="text/markdown"> tag enables crawler discovery. The MDX→Markdown normalizer also improves llms-full.txt.', benefits: 'LLMs, agents, and tools that consume Markdown documentation get clean, normalized content. Users can copy page Markdown in one click for use in AI prompts or issue reports.' },
      ],
      issues: [],
      prs: [],
    },
