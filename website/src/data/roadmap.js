...
export const roadmapConfig = {
  ...
  featured: [
    ...
    },
    {
      ...
      description: 'Unified authentication across AWS, Azure, GCP, and Okta. SSO, OIDC, SAML, device code, and keyring backends—all in one place. Zero local config required.',
  ...
  initiatives: [
    {
      ...
      milestones: [
        ...
        { label: 'Native Okta Authentication (Device Code Flow)', status: 'shipped', quarter: 'q1-2026', prd: 'okta-auth-identity', changelog: 'okta-authentication-support', docs: '/cli/configuration/auth/providers#okta-device-code', description: 'Native Okta authentication using OAuth 2.0 Device Authorization Grant. Enables Okta as a central IdP for AWS, Azure, and GCP federation, plus direct Okta API access for Terraform.', benefits: 'Use Okta as your single identity hub. Authenticate once with Okta and federate to any cloud. No browser automation or SAML complexity.' },
