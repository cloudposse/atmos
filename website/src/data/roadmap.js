  ...
  initiatives: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: '`atmos init` command for project initialization', status: 'shipped', quarter: 'q4-2025', pr: 1687, changelog: 'introducing-atmos-init-and-scaffold', docs: '/cli/commands/init', description: 'Initialize new Atmos projects from built-in or custom templates with interactive prompts.', category: 'featured', priority: 'high', benefits: 'New projects start with correct structure. No manual setup or copy-paste from examples.' },
        { label: '`atmos scaffold generate` for template-based code generation', status: 'shipped', quarter: 'q4-2025', pr: 1687, changelog: 'introducing-atmos-init-and-scaffold', docs: '/cli/commands/scaffold/generate', description: 'Generate stacks, components, and configurations from templates with variable substitution.', category: 'featured', priority: 'high', benefits: 'Encode team patterns as templates. Generate consistent code without copy-paste.' },
        { label: '`atmos scaffold list` to discover available templates', status: 'shipped', quarter: 'q4-2025', pr: 1687, changelog: 'introducing-atmos-init-and-scaffold', docs: '/cli/commands/scaffold/list', description: 'List available scaffold templates from embedded and custom sources.', benefits: 'Discover what templates are available. See template descriptions and sources.' },
        { label: '`atmos scaffold validate` for template validation', status: 'shipped', quarter: 'q4-2025', pr: 1687, changelog: 'introducing-atmos-init-and-scaffold', docs: '/cli/commands/scaffold/validate', description: 'Validate scaffold.yaml files against JSON schema.', benefits: 'Catch template configuration errors before generation. Clear validation messages.' },
        { label: 'Three-way merge for scaffold updates', status: 'shipped', quarter: 'q4-2025', pr: 1687, changelog: 'introducing-atmos-init-and-scaffold', docs: '/cli/commands/scaffold/generate', description: 'Smart merging preserves local customizations when updating from templates.', benefits: 'Update templates without losing local changes. Merge conflicts are highlighted clearly.' },
