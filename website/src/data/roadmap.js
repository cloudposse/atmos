  ...
  initiatives: [
    {
      ...
      milestones: [
        ...
        { label: 'Concurrent identities for multi-account components (auth.needs)', status: 'shipped', quarter: 'q1-2026', changelog: 'auth-needs-concurrent-identities', description: 'Components declare additional identities via auth.needs. The default identity stays primary; needs lists extras that are authenticated and written to the shared credentials file.', benefits: 'Multi-account Terraform patterns with provider aliases work in CI with OIDC. No manual credential setup for hub-spoke networking or cross-account deployments.' },
      ],
      issues: [],
      prs: [
