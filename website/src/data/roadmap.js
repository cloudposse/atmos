  ...
  featured: [
    {
      ...
      description: 'First-class Dev Container support with automatic container lifecycle management. Start, stop, and attach to containers seamlessly.',
      status: 'shipped',
      quarter: 'q4-2025',
    ...
    },
    {
      ...
      description: 'Automatically install and manage the right versions of Terraform, OpenTofu, Helmfile, and other tools. No more manual version juggling.',
      status: 'shipped',
      quarter: 'q4-2025',
    },
    {
      ...
      description: 'Unified authentication across AWS, Azure, and GCP. SSO, OIDC, SAML, and keyring backends—all in one place.',
      status: 'shipped',
      quarter: 'q3-2025',
    ...
    },
    {
      ...
      description: 'Beautiful PR comments with formatted plans, cost estimates, and approval buttons. What works locally works in CI.',
      status: 'in-progress',
      quarter: 'q4-2025',
      pr: 1891,
    },
  ...
  initiatives: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'Native Dev Containers', status: 'shipped', quarter: 'q4-2025', docs: '/cli/configuration/devcontainer', changelog: 'native-devcontainer-support', description: 'First-class Dev Container support with automatic container lifecycle management and seamless development.' },
        ...
        { label: 'Automatic toolchain installation and version management', status: 'shipped', quarter: 'q4-2025', description: 'Automatically install and manage the right versions of Terraform, OpenTofu, Helmfile, and other tools for components, workflows, and custom commands.' },
      ],
      issues: [],
      prs: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'Provider auto-generation', status: 'shipped', quarter: 'q3-2025', docs: '/components/terraform/providers', description: 'Generate provider.tf with proper credentials and region configuration from stack metadata.' },
