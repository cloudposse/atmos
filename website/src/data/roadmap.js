  ...
  initiatives: [
    {
      ...
      milestones: [
        ...
        { label: 'EKS exec credential plugin (atmos auth eks-token)', status: 'shipped', quarter: 'q1-2026', pr: 2149, changelog: 'eks-kubeconfig-authentication', docs: '/cli/commands/auth/eks-token', description: 'Short-lived EKS token generation via STS pre-signed URLs without the AWS CLI. Automatically called by kubectl.', benefits: 'kubectl authentication is seamless. Tokens refresh automatically without manual intervention.' },
