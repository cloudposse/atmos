  ...
  initiatives: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'Built-in specialized skills (5 skills)', status: 'shipped', quarter: 'q1-2026', docs: '/ai/skills', changelog: 'introducing-atmos-ai', description: 'General, Stack Analyzer, Component Refactor, Security Auditor, and Config Validator skills following the Agent Skills open standard.', benefits: 'Task-specific AI expertise. Each skill has focused tools and system prompts.' },
