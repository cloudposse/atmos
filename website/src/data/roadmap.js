  ...
  initiatives: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'TTY and interactive shell steps (`tty: true`, `interactive: true`)', status: 'shipped', quarter: 'q2-2026', pr: 2602, changelog: 'tty-interactive-steps', description: 'Shell steps in custom commands and workflows can set `tty: true` to allocate a PTY for the child process and `interactive: true` to hand the terminal directly to tools like `aws ssm start-session`, `ssh`, or `psql`. Secret masking is preserved, Ctrl-C is forwarded to the child instead of killing Atmos, and exit codes propagate correctly.', benefits: 'Interactive CLI tools work inside workflow and custom-command steps without wrapper scripts. Terminal sessions, database clients, and SSH tunnels launch directly from atmos.yaml.' },
      ],
      issues: [],
      prs: [
