...
export const roadmapConfig = {
  ...
  initiatives: [
    ...
    },
    {
      ...
      icon: 'RiFlagLine',
      title: 'Feature Flags',
      tagline: 'Declarative cross-cutting capabilities for stacks',
      description:
        'Features are mixins with CLI control and discoverability. Ideal for versioned components (EKS versions), compliance requirements, and deployment strategies. Features provide context via .features accessible in templates.',
      progress: 0,
      status: 'planned',
      milestones: [
        { label: 'Feature directory discovery', status: 'planned', quarter: 'q2-2026', prd: 'feature-flags', description: 'Discover available features from configurable directory (default: stacks/features/).', benefits: 'Features are organized alongside stacks. No separate tooling or configuration needed.' },
        { label: 'Stack `features` declaration parsing', status: 'planned', quarter: 'q2-2026', description: 'Parse features list in stack configuration files.', benefits: 'Declare which features apply to a stack in a single line. No complex import hierarchies.' },
        { label: 'Merge feature configs into stack resolution', status: 'planned', quarter: 'q2-2026', description: 'Integrate feature configuration into the stack resolution pipeline with proper merge semantics.', benefits: 'Features use the same merge behavior as imports. Predictable, familiar configuration inheritance.' },
        { label: '`--features` CLI flag', status: 'planned', quarter: 'q2-2026', description: 'Set features at runtime (replaces stack-declared features). Accepts single value or comma-separated list.', codeExample: 'atmos terraform plan vpc -s prod --features deployment/blue', benefits: 'Explicit control over features. Test different configurations without modifying stack files.' },
        { label: '`ATMOS_FEATURES` environment variable', status: 'planned', quarter: 'q2-2026', description: 'Set features via environment variable (replaces stack-declared features). Comma-separated list for CI/CD integration.', benefits: 'CI pipelines can specify exact features. Same mechanism locally and in automation.' },
        { label: '`atmos feature list` command', status: 'planned', quarter: 'q2-2026', description: 'List all available features with descriptions.', codeExample: 'atmos feature list', benefits: 'Discover what features exist without searching directories. New team members find capabilities quickly.' },
        { label: '`atmos describe feature <name>` command', status: 'planned', quarter: 'q2-2026', description: 'Display merged configuration for a specific feature.', benefits: 'Understand exactly what a feature does before enabling it. Debug feature configuration issues.' },
        { label: 'Feature resolution in `atmos describe stacks`', status: 'planned', quarter: 'q2-2026', description: 'Show fully resolved configuration with features applied in describe output.', benefits: 'See the complete picture of how features affect your stack configuration.' },
        { label: 'Profile-based default features', status: 'planned', quarter: 'q2-2026', description: 'Profiles can define features.defaults list that automatically enables features when the profile is active.', codeExample: 'features:\n  defaults:\n    - compliance/hipaa\n    - sizing/small', benefits: 'Environment consistency via profiles. CI profiles enable cost-saving features; production profiles mandate compliance.' },
        { label: 'Feature metadata support', status: 'planned', quarter: 'q3-2026', description: 'Support metadata block in features for name, description, and documentation.', benefits: 'Self-documenting features. Feature list shows meaningful descriptions.' },
        { label: 'Feature context and templating', status: 'planned', quarter: 'q2-2026', description: 'Features provide context via .features block, accessible in templates as .features.<setting>. Multiple features are deep merged.', codeExample: 'vars:\n  kubernetes_version: {{ .features.eks_version || "1.29" }}', benefits: 'Components reference feature settings dynamically. Version-specific configs without duplication.' },
        { label: 'Parameterized features', status: 'planned', quarter: 'q3-2026', description: 'Features can accept parameters via map syntax with templating support.', codeExample: 'features:\n  - policies/retention:\n      days: 90', benefits: 'Reusable features with customizable behavior. One feature handles multiple use cases.' },
        { label: 'Feature validation (requires/conflicts)', status: 'planned', quarter: 'q3-2026', description: 'Validate feature combinations with requires and conflicts declarations.', benefits: 'Catch incompatible feature combinations before deployment. Enforce compliance requirements.' },
      ],
      issues: [],
      prs: [],
    },
