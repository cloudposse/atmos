  ...
  initiatives: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'Customizable list output', status: 'shipped', quarter: 'q4-2025', changelog: 'customizable-list-command-output', description: 'Format list output as tables, JSON, YAML, or custom templates for scripting and CI integration.' },
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'Stack `name` field (alternative to name_template)', status: 'shipped', quarter: 'q4-2025', docs: '/stacks/name', changelog: 'stack-manifest-name-override', description: 'Simple stack naming with a direct name field instead of complex name templates.' },
        ...
        { label: 'Generate section inheritance', status: 'shipped', quarter: 'q4-2025', description: 'Inherit and override generate blocks from parent stacks for consistent backend/provider patterns.' },
        { label: 'Backend provisioning', status: 'shipped', quarter: 'q4-2025', docs: '/components/terraform/backend-provisioning', description: 'Automatic backend.tf generation from stack configuration—no manual backend files needed.' },
        ...
        { label: 'Metadata inheritance', status: 'planned', quarter: 'q1-2026', description: 'Inherit metadata fields from parent stacks with selective override capabilities.' },
