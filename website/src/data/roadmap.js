  ...
  initiatives: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'Per-key merge trace with --explain', status: 'shipped', quarter: 'q1-2026', changelog: 'describe-component-explain-merge-trace', docs: '/cli/commands/describe/component', description: 'The --explain flag on describe component shows a per-key merge trace: which file "won," which earlier files were overridden, and what value each file contributed.', benefits: 'Instantly debug why any configuration value has a particular setting. Shows the complete override history—no more grepping through stack files to trace inheritance chains.' },
