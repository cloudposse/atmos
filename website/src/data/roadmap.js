...
export const roadmapConfig = {
  ...
  initiatives: [
    ...
    },
    {
      ...
      status: 'shipped',
      milestones: [
        { label: 'Changelog introduction', status: 'shipped', quarter: 'q4-2025', version: 'v1.198.0', docs: '/changelog', description: 'Detailed changelogs for every release with feature announcements and migration guides.', category: 'featured', priority: 'high', benefits: 'Know exactly what changed in each release. Plan upgrades with full visibility into breaking changes.' },
