  ...
  initiatives: [
    {
      ...
      milestones: [
        ...
        { label: 'Automatic EKS kubeconfig tied to identities', status: 'in-progress', quarter: 'q4-2025', pr: 1884, description: 'Automatic kubeconfig generation for EKS clusters using Atmos-managed AWS credentials.' },
        { label: 'Automatic ECR authentication tied to identities', status: 'planned', quarter: 'q1-2026', pr: 1859, description: 'Native ECR login for container image operations without external tooling.' },
        ...
        { label: 'GitHub Apps', status: 'planned', quarter: 'q1-2026', pr: 1683, description: 'GitHub App authentication for fine-grained repository access and elevated rate limits.' },
      ],
      issues: [],
      prs: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'Parent directory search & git root discovery', status: 'shipped', quarter: 'q3-2025', changelog: 'parent-directory-search-and-git-root-discovery', description: 'Run Atmos from any directory within your project—automatic discovery of atmos.yaml by searching parent directories up to the git repository root.' },
        ...
        { label: 'Streaming Terraform UI', status: 'in-progress', quarter: 'q4-2025', pr: 1908, description: 'Real-time Terraform plan/apply visualization with resource-level progress tracking.' },
        { label: 'Native CI integration with summary templates', status: 'in-progress', quarter: 'q4-2025', pr: 1891, description: 'GitHub/GitLab-native summaries with formatted plan output, cost estimates, and approval workflows.' },
        ...
        { label: 'Filesystem paths for components', status: 'shipped', quarter: 'q4-2025', description: 'Reference components by filesystem path instead of component name—just cd into a component directory and run Atmos.', codeExample: 'atmos terraform plan ./components/vpc -s plat-ue1-prod' },
      ],
      issues: [],
      prs: [
    ...
    },
    {
      ...
      status: 'in-progress',
      milestones: [
        { label: '`atmos list stacks` to browse all configured stacks', status: 'shipped', quarter: 'q1-2025', docs: '/cli/commands/list/stacks', description: 'List all stacks in your infrastructure with filtering and formatting options.', codeExample: 'atmos list stacks --format json' },
        { label: '`atmos list components` to discover available components', status: 'shipped', quarter: 'q1-2025', docs: '/cli/commands/list/components', description: 'Discover all available components across your infrastructure catalog.', codeExample: 'atmos list components' },
        { label: '`atmos list workflows` to explore automation patterns', status: 'shipped', quarter: 'q3-2025', docs: '/cli/commands/list/workflows', description: 'Browse available workflows with their descriptions and step counts.', codeExample: 'atmos list workflows' },
        { label: '`atmos list affected` to identify changes for targeted CI/CD', status: 'shipped', quarter: 'q4-2025', docs: '/cli/commands/list/affected', changelog: 'list-affected-command', description: 'Identify which stacks and components are affected by your changes—perfect for targeted CI/CD.' },
        { label: 'Customizable list columns for tailored views', status: 'shipped', quarter: 'q4-2025', changelog: 'customizable-list-command-output', description: 'Create custom views of your configuration with customizable columns—display exactly the data you need.' },
        { label: 'JMESPath queries (`--query`) for precise filtering', status: 'shipped', quarter: 'q4-2025', docs: '/cli/commands/list/stacks', description: 'Filter and transform list output with JMESPath queries for precise data extraction.', codeExample: 'atmos list stacks --query "[?components.terraform.vpc]"' },
      ],
      issues: [],
      prs: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'Unified task execution (`pkg/runner`)', status: 'shipped', quarter: 'q4-2025', pr: 1901, description: 'A single execution engine for all task types—Terraform, Helmfile, shell, and custom commands.' },
        { label: 'New workflow step types', status: 'in-progress', quarter: 'q4-2025', pr: 1899, docs: '/cli/configuration/workflows', description: 'Additional step types including parallel execution, conditional branching, and error handlers.' },
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'Added `!unset` YAML function', status: 'planned', quarter: 'q1-2026', pr: 1521, description: 'Delete keys from inherited configuration for clean overrides.', codeExample: 'deprecated_setting: !unset' },
        { label: 'Added `!append` YAML function', status: 'planned', quarter: 'q1-2026', pr: 1513, description: 'Append items to inherited lists instead of replacing them.', codeExample: 'extra_tags: !append [new-tag]' },
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'Vendor registry pattern migration', status: 'in-progress', quarter: 'q4-2025', pr: 1889, description: 'Refactoring vendoring to use a pluggable registry pattern for different source types.' },
        ...
        { label: 'Just-in-time vendoring', status: 'planned', quarter: 'q1-2026', pr: 1877, description: 'Automatically vendor components on first use—no separate vendor step needed.' },
        { label: 'Component workdir provisioning', status: 'planned', quarter: 'q1-2026', pr: 1876, description: 'Automatic working directory setup for components with dependencies and generated files.' },
      ],
      issues: [],
      prs: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'CI Summary Templates (`--ci` flag)', status: 'in-progress', quarter: 'q4-2025', pr: 1891, description: 'Beautiful PR comments with formatted Terraform plans, cost estimates, and approval buttons.' },
        { label: 'Terraform command registry', status: 'in-progress', quarter: 'q4-2025', pr: 1891, changelog: 'terraform-command-registry-pattern', description: 'Centralized Terraform command configuration for consistent behavior across CI and local.' },
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'Multi-stack formats', status: 'planned', quarter: 'q2-2026', pr: 1842, description: 'Support for alternative stack formats including single-file stacks and Terragrunt-style layouts.' },
      ],
      issues: [],
      prs: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'Push for stability', status: 'shipped', quarter: 'q4-2025', description: 'Focused effort on bug fixes, edge cases, and reliability improvements across the codebase.' },
