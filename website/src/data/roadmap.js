  ...
  initiatives: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'Parallel acceptance tests', status: 'shipped', quarter: 'q1-2026', changelog: 'parallel-acceptance-tests', description: 'Acceptance tests now run in parallel by default, reducing CI suite time from 15–20 minutes to ~4–6 minutes. Individual tests can opt out with parallel: false for shared mutable state.', benefits: 'Faster CI feedback for contributors. Pull requests validate in a fraction of the time.' },
