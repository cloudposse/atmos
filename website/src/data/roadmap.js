  ...
  initiatives: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: '`--feature` CLI flag', status: 'planned', quarter: 'q2-2026', description: 'Add or override features at runtime without modifying stack files.', codeExample: 'atmos terraform plan vpc -s prod --feature blue-green', benefits: 'Test features without committing changes. Enable deployment strategies on-demand.' },
        { label: '`ATMOS_FEATURE` environment variable', status: 'planned', quarter: 'q2-2026', description: 'Enable features via environment variable for CI/CD integration.', benefits: 'CI pipelines can enable features without modifying commands. Same workflow locally and in automation.' },
        ...
        { label: '`--features-override` flag', status: 'planned', quarter: 'q3-2026', description: 'Replace stack-declared features entirely at runtime.', benefits: 'Full control over which features apply. Testing different feature combinations without modifying files.' },
