  ...
  initiatives: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: '`atmos lint stacks` with 10 built-in quality rules', status: 'shipped', quarter: 'q1-2026', pr: 2203, changelog: 'atmos-lint-stacks', docs: '/cli/commands/lint/stacks', description: 'Static analysis command for stack YAML configurations with 10 built-in rules covering inheritance cycles, abstract component leaks, redundant overrides, dead vars, import depth, orphaned files, sensitive vars, env shadowing, cohesion, and DRY violations.', benefits: 'Catch misconfigurations and anti-patterns before `terraform plan`. JSON output enables CI pipeline integration.', category: 'featured', priority: 'high' },
      ],
      issues: [],
      prs: [
