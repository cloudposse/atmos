  ...
  initiatives: [
    {
      ...
      milestones: [
        ...
        { label: 'ECR Public registry authentication', status: 'shipped', quarter: 'q1-2026', changelog: 'ecr-public-authentication', description: 'Authenticated pulls from public.ecr.aws to eliminate rate limits on public ECR images.', benefits: 'CI builds pulling BuildKit, binfmt, or other public ECR images no longer hit unauthenticated rate limits.' },
