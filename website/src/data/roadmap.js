  ...
  initiatives: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'Bash-like command aliases with command-path rewrites', status: 'shipped', quarter: 'q2-2026', pr: 2572, docs: '/cli/configuration/aliases', description: 'Command aliases now rewrite argv prefixes before command parsing, including top-level commands and subcommand paths such as `terraform apply`. Same-name aliases can inject default flags while user-provided CLI flags still win by appearing later in argv.', benefits: 'Use one familiar aliases interface for shortcuts and command defaults. Disable identity or add common Terraform flags by default without introducing another config surface.' },
      ],
      issues: [],
      prs: [
