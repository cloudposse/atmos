  ...
  initiatives: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'Custom component types with registry', status: 'shipped', quarter: 'q4-2025', docs: '/cli/configuration/commands', changelog: 'custom-component-types', description: 'Register custom component types that integrate seamlessly with Atmos commands and workflows.', benefits: 'Your custom commands get the same tab completion, list commands, and workflow integration as built-ins.' },
        { label: 'Semantic type completion', status: 'shipped', quarter: 'q4-2025', docs: '/cli/commands/completion', changelog: 'custom-component-types', description: 'Context-aware shell completion that understands your component types and suggests valid options.', benefits: 'Tab completion suggests values that make sense for each argument, not just filenames.' },
