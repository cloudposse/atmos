  ...
  initiatives: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'Terraform state migrations with `tfmigrate`', status: 'shipped', quarter: 'q2-2026', docs: '/cli/commands/terraform/migrate', changelog: 'terraform-tfmigrate', pr: 2534, prd: 'terraform-tfmigrate', description: 'Run user-authored tfmigrate migrations through Atmos component context, including auth identities, source/workdir provisioning, generated files, workspace selection, lifecycle hooks, and per-instance history helpers.', benefits: 'Teams can migrate Terraform state safely from the same Atmos commands and automation they already use, while reusing backend buckets and identities for durable tfmigrate history.' },
