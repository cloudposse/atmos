  ...
  initiatives: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'SARIF output and Atmos Pro upload (experimental)', status: 'shipped', quarter: 'q2-2026', changelog: 'aws-security-sarif-and-upload', description: 'New `--format=sarif` emits SARIF 2.1.0 for GitHub code scanning and other SARIF viewers. New `--upload` flag (experimental) ships SARIF to Atmos Pro for centralized triage.', benefits: 'Atmos security findings plug directly into existing code-scanning surfaces and the Atmos Pro platform.' },
