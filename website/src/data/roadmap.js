  ...
  initiatives: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'Project memory (ATMOS.md)', status: 'shipped', quarter: 'q1-2026', docs: '/ai/memory', changelog: 'introducing-atmos-ai', description: 'Persistent project context via ATMOS.md file that AI references across all sessions.', benefits: 'AI knows your project conventions. Reduce repetitive context loading.' },
        ...
        { label: 'Token caching for cost savings', status: 'shipped', quarter: 'q1-2026', docs: '/ai/providers', changelog: 'introducing-atmos-ai', description: 'Prompt caching saves up to 90% on API costs by reusing system prompts and project memory.', benefits: 'Significant cost reduction for heavy AI usage. Automatic caching for most providers.' },
