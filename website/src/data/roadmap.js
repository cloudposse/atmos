  ...
  initiatives: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'Streaming Terraform UI', status: 'shipped', quarter: 'q4-2025', pr: 1908, changelog: 'streaming-terraform-ui', description: 'Real-time Terraform plan/apply visualization with resource-level progress tracking, dependency trees, and line-by-line diffs.', benefits: 'See exactly what Terraform is doing as it happens. Identify slow resources, view dependency relationships, and understand attribute changes at a glance.' },
