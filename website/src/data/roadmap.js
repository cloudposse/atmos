  ...
  initiatives: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'Unified import adapter registry', status: 'shipped', quarter: 'q1-2026', pr: 1897, changelog: 'import-adapter-registry', prd: 'import-adapter-registry', description: 'Pluggable import adapter system enabling custom configuration sources. Foundation for Terragrunt import support.', category: 'featured', priority: 'high', benefits: 'Extensible architecture for importing configurations from various sources including Terragrunt.' },
        { label: 'Terragrunt import adapter', status: 'planned', quarter: 'q1-2026', prd: 'terragrunt-support', description: 'Import existing Terragrunt configurations directly into Atmos stacks using terragrunt:// imports. Parse HCL, synthesize to Atmos components.', category: 'featured', priority: 'high', benefits: 'Migrate from Terragrunt incrementally. Run Terragrunt-sourced and native Atmos components side-by-side.' },
      ...
      prs: [
        ...
        { number: 1897, title: 'Implement unified import adapter registry' },
