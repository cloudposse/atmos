  ...
  initiatives: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: '`--feature` CLI flag', status: 'planned', quarter: 'q2-2026', description: 'Add or override features at runtime without modifying stack files.', codeExample: 'atmos terraform plan vpc -s prod --feature blue', benefits: 'Test features without committing changes. Enable deployment strategies on-demand.' },
