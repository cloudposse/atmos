  ...
  initiatives: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'SARIF output for security findings', status: 'shipped', quarter: 'q2-2026', pr: 2483, changelog: 'aws-security-sarif', description: 'New `--format=sarif` emits SARIF 2.1.0 documents that GitHub code scanning, Azure DevOps, and other SARIF viewers ingest directly. Findings keep their Atmos context (stack, component, remediation) as SARIF result properties.', benefits: 'Atmos security findings plug directly into existing code-scanning surfaces — no translation layer required.' },
