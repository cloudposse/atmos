  ...
  initiatives: [
    ...
    },
    {
      ...
      milestones: [
        ...
        { label: 'Built-in specialized agents (5 agents)', status: 'shipped', quarter: 'q1-2026', docs: '/ai/agents', changelog: 'introducing-atmos-ai', description: 'General, Stack Analyzer, Component Refactor, Security Auditor, and Config Validator agents.', benefits: 'Task-specific AI expertise. Each agent has focused tools and system prompts.' },
