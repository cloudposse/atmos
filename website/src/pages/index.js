            ...
            <div className="intro">
              ...
              <h1>
                ...
                <span className="typing-container" aria-hidden="true">
                  <TypingAnimation words={['Terraform', 'OpenTofu', 'Packer', 'Helmfile', 'Devcontainers', 'Ansible']} />
                </span>
                <span className="visually-hidden">Terraform, OpenTofu, Packer, Helmfile, Devcontainers, and Ansible</span>
              </h1>
