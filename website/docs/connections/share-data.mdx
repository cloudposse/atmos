...
When you combine data sources with [vendoring](/vendor), [terraform backends](/components/terraform/backends) and [provider](/components/terraform/providers) generation, you can leverage any Terraform module as a "root module" and provision it as a component with Atmos.
:::
...
<ActionCard>
  ...
  <PrimaryCTA to="/stacks/templates/datasources">Learn More</PrimaryCTA>
</ActionCard>
