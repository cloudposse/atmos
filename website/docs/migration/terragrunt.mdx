...
<Tabs>
  ...
  <TabItem value="atmos" label="Atmos">
    ...
    **GitOps-native:** Atmos goes beyond simple "run all" with intelligent change detection:
    ...
    ```bash
    # See what changed between commits (compares current branch to main; table output for humans)
    atmos list affected
