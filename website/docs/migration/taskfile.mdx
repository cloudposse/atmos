...
- [ ] Turn `sources:`/`generates:` into step `inputs.sources`/`artifacts.paths`
...
successful run, the same as Task's own check. It does not carry over automatically; you add it to
the migrated step yourself. See
