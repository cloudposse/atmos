...
<EmbedFile filePath="examples/native-terraform/components/terraform/vpc/envs/dev.tfvars" language="hcl" />
...
<EmbedExample example="native-terraform" title="Native Terraform Migration" />
