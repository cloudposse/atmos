...
- ✅ **Your `.tfvars` files** still work (Atmos can generate them)
...
- ✅ **After**: `{{ (atmos.Component "vpc" .stack).outputs.vpc_id }}`
...
- ✅ **You're just going to fall in love with it** ❤️
...
- [Remote State Integration](/connections/remote-state)
