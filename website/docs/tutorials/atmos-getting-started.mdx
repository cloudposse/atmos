...
your Terraform and Helmfile [components](/components/components) from your local machine or in your CI/CD pipelines.
...
modules ([components](/components/components)) is that you then need to orchestrate them in an order that makes sense for what you're building.
