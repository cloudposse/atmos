...
<dl>
  ...
  <dd>Adds the Atmos Pro MCP server (`https://atmos-pro.com/mcp`) as `mcp.servers.atmos-pro`. If Atmos Pro is already configured (`pro.workspace_id`) but this preset hasn't been added, `atmos mcp list`/`status` print a reminder.</dd>
</dl>
