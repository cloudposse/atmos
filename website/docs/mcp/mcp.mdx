...
#### 1. Configure servers in atmos.yaml
...
Then add Atmos to your AI client's MCP config. Each client has its own config file and format — see [MCP Server Integration](/ai/mcp-server) for exact copy-paste steps for Claude Desktop, Claude Code, Cursor, VS Code, Windsurf, Cline, Continue, Codex, Gemini CLI, and Grok CLI, plus transport modes and security considerations for remote (HTTP) access.
