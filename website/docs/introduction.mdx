...
It's especially adept at [overcoming Terraform's limitations](/reference/terraform-limitations/) with [established conventions](/core-concepts) and [design patterns](/design-patterns/) that 
...
- Team collaboration with [reusable service catalogs](/core-concepts/stacks/catalogs), and [GitOps-style automation](/integrations).
...
- Break terraliths into smaller pieces ([“components”](/core-concepts/components/))
...
Part of the benefit of working with Atmos is we have many [established conventions](/core-concepts) that you can adopt.
