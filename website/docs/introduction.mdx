...
[![Last Commit](https://img.shields.io/github/last-commit/cloudposse/.github/main?style=social)](https://github.com/cloudposse/.github/commits/main/)
...
- **Atmos is not a competitor to Terraform Cloud or Terraform Enterprise.** It’s a command-line tool that makes working with other
  CLI’s like `terraform`, `helm` and other infrastructure management tools better. It steamsline infrastructure comfiguration management
