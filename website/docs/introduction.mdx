...
:::info
By running a [single command](/cli/commands/terraform-generate-varfile.md), you can eject from Atmos and never touch it again.
:::
...
A generalized tool will always suffer for a specialized use case, even Atmos and it’s custom workflows.
