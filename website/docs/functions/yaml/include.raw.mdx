...
3. **`base_path`-relative paths** — all other relative paths resolve relative to the
   [`base_path`](/cli/configuration#base-path) setting in `atmos.yaml`: `!include.raw stacks/catalog/template.tf`
