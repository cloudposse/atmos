...
<Slide layout="content">
  ...
  <SlideList>
    ...
    <li>Organize it any way that makes sense for your organization</li>
...
<Slide layout="title">
  <SlideTitle>
    ...
    <SlideImage src="/img/slides/atmos-intro/strikethrough.png" alt="crossed out - this is a controversial statement" width={200} />
  </SlideTitle>
  <SlideNotes>
