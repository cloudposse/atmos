...
<Slide layout="split">
  ...
  <SlideNotes>
    Cloud Posse is a DevOps Accelerator that helps venture-backed startups,
    typically Series A through D, build and own their AWS infrastructure. We
    work alongside their teams, building infrastructure together and teaching
    them best practices along the way.
  </SlideNotes>
</Slide>
