...
Do not use the old Actions in new workflows. Existing workflows that use them still work. New
workflows need only `actions/checkout` and an `atmos` command, as shown below.
:::
