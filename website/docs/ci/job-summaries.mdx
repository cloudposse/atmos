...
operation-specific `release` block with the effective wait strategy, timeout, chart-hook state,
and applicable recovery, Job-wait, CRD, cleanup, and history values. For external delivery,
