...
If the retry policy should apply to every component in the stack, put `retry:` at the stack-manifest root instead — see [Stack-Level Defaults](/stacks/components/terraform/retry#stack-level-defaults). No mixin file or import needed. Reach for the mixin pattern below when the policy should apply to only part of a stack.
:::
...
<PrimaryCTA to="/design-patterns/component-catalog/mixins">Learn Design Pattern</PrimaryCTA>
</ActionCard>
