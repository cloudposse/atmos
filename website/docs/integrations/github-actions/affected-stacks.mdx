...
<Intro>
The [Atmos Affected Stacks GitHub Action](https://github.com/cloudposse/github-action-atmos-affected-stacks) makes it easy identify the affected [atmos stacks](/learn/stacks/) for a pull request. Use it to build a matrix so you can run other actions based on what was affected.
</Intro>
