...
:::warning
Always review deleted components before running `terraform destroy`. Consider adding manual approval steps for destruction workflows to prevent accidental resource deletion.
:::
