...
Use Cloud Posse's GitHub Action for updating [Atmos components](/components) (e.g. [like the ones provided by Cloud Posse](https://github.com/cloudposse-terraform-components/)) to streamline your infrastructure management.
