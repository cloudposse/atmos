...
<img width="250" align="right" src={useBaseUrl('/img/opentofu-icon.svg')} /> Atmos natively supports [OpenTofu](https://opentofu.org),
...
work with multiple different versions of it concurrently, and can even work along side with [HashiCorp Terraform](/integrations/terraform). 
...
of OpenTofu; it assumes that any required commands are already installed on your system.
