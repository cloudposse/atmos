...
<Step>
    ...
    <ActionCard>
        ...
        <PrimaryCTA to="/components/components">Learn Atmos Components</PrimaryCTA>
    </ActionCard>
</Step>
...
<Step>
    ...
    Use Terraform's native ability to read the remote state or configuration of any other component, for a "loosely coupled" architecture. Atmos provides [methods that make this easy](/connections).
    ...
    <ActionCard>
        ...
        <PrimaryCTA to="/connections">Learn How</PrimaryCTA>
    </ActionCard>
</Step>
...
or delve deeper into the [syntax and concepts](/learn/why-atmos) used in this tutorial.
