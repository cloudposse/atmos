...
Atmos supports [Atmos Manifests Validation](/cli/schemas) and [Atmos Components Validation](/core-concepts/validate/components)
...
To configure Atmos components validation, complete the steps described in [Atmos Components Validation](/core-concepts/validate/components).
