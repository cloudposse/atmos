...
- Copy the `vpc-flow-logs-bucket` component from the open-source component repository
  [vpc-flow-logs-bucket](https://github.com/cloudposse-terraform-components/aws-vpc-flow-logs-bucket)
...
- Copy the `vpc` component from the open-source component repository
  [vpc](https://github.com/cloudposse-terraform-components/aws-vpc)
...
To vendor the components from the open-source component repository [cloudposse-terraform-components](https://github.com/cloudposse-terraform-components),
...
from 'github.com/cloudposse-terraform-components/aws-vpc.git//src?ref=v1.539.0'
into 'components/terraform/vpc'

Pulling sources for the component 'vpc-flow-logs-bucket'
from 'github.com/cloudposse-terraform-components/aws-vpc-flow-logs-bucket.git//src?ref=v1.537.0'
into 'components/terraform/vpc-flow-logs-bucket/v1.537.0'
