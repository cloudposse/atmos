...
from 'github.com/cloudposse-terraform-components/aws-vpc.git//src?ref=1.343.1'
into 'components/terraform/vpc'

Pulling sources for the component 'vpc-flow-logs-bucket'
from 'github.com/cloudposse-terraform-components/aws-vpc-flow-logs-bucket.git//src?ref=1.343.1'
