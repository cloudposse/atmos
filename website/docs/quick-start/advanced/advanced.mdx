---
title: AWS Advanced Tutorial
sidebar_position: 4
sidebar_label: AWS Advanced Tutorial
...
<PillBox>AWS Advanced</PillBox>

# AWS Advanced Tutorial

Take 30 minutes to learn the most important Atmos concepts.
We recommend starting with the [Simple Quick Start](/quick-start/simple) tutorial before diving into this advanced tutorial.
This tutorial will take you through the process of configuring and provisioning infrastructure on AWS using Atmos.
It requires administrative access to an AWS organization.
