...
Atmos supports the [Catalog](/stacks/catalogs) pattern to configure default settings for Atmos components.
...
[Mixins](/stacks/mixins) are a special kind of "[import](/stacks/imports)".
