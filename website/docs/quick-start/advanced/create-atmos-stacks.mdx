...
`catalog/backend` is imported here at the tenant level, **every account and region under `plat` gets the full backend catalog, including the emulator, automatically**.
