...
Atmos can automatically provision S3 backends with secure defaults. See [Backend Provisioning](/components/terraform/backend-provisioning)
...
[tfstate-backend](https://github.com/cloudposse-terraform-components/aws-tfstate-backend) Terraform component (root module).

The [tfstate-backend](https://github.com/cloudposse-terraform-components/aws-tfstate-backend) Terraform component
