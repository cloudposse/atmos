...
<Intro>
When you [design cloud architectures with Atmos](/learn/mindset), you will first break them apart into pieces called [components](/components/components). Then, you will implement [Terraform "root modules"](/components/terraform) for each of those components.
</Intro>
