...
<EmbedFile filePath="examples/demo-stacks/components/terraform/myapp/variables.tf" />
<EmbedFile filePath="examples/demo-stacks/components/terraform/myapp/main.tf" />
...
<EmbedFile filePath="examples/demo-stacks/components/terraform/myapp/outputs.tf" />

### Implement `versions.tf`

<EmbedFile filePath="examples/demo-stacks/components/terraform/myapp/versions.tf" />
