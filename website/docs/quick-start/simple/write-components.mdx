...
<Intro>
When you [design cloud architectures with Atmos](/quick-start/mindset), you will first break them apart into pieces called [components](/components/components). Then, you will implement [Terraform "root modules"](/components/terraform) for each of those components.
</Intro>
...
<ActionCard title="Ready to take the next step?">
    ...
    <div>
      ...
      <SecondaryCTA to="/components/terraform">Deep Dive</SecondaryCTA>
    </div>
</ActionCard>
