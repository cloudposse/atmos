...
<Note title="TIP">
Refer to [Atmos Custom Commands](/custom-commands/custom-commands) for more information about Atmos Custom Commands
</Note>
...
<ActionCard title="Want to go deeper on this topic?">
    ...
    <PrimaryCTA to="/custom-commands/custom-commands">Learn More</PrimaryCTA>
</ActionCard>
