...
<ActionCard title="Want to go deeper on this topic?">
    For a deep-dive on configuring projects to work with Atmos, we have additional documentation.
    <PrimaryCTA to="/core-concepts/projects">Advanced Project Configuration</PrimaryCTA>
</ActionCard>
