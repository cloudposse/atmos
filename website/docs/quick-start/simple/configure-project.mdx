...
The source code for this Quick Start guide can be found in the [Atmos repo](https://github.com/cloudposse/atmos/tree/master/examples/demo-stacks) demo repository. (It's the same demo you see on the Atmos landing page)
...
<ActionCard title="Want to go deeper on this topic?">
    For a deep dive into configuring projects to work with Atmos, we have additional documentation.
