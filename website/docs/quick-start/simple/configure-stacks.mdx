...
but we recommend a hierarchical layout. We share some [different ways to organize your stacks in the Catalog](/core-concepts/stacks/catalogs), but for this example, we will use a simple layout.
...
We recommend using a hierarchical layout that follows the way AWS thinks about infrastructure. This works very well when you have dozens or hundreds of accounts and regions in which you operate.
