...
Therefore, this file should exist in the project repository, along side your Terraform components and Atmos stacks. It's also where you can [configure integrations](/integrations), like with our [GitHub Actions](/integrations/github-actions).
...
Let's make sure you've [properly installed Atmos](/install), by running the following command.
