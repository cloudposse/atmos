...
<SecondaryCTA to="/quick-start/advanced">Try our Advanced Tutorial</SecondaryCTA>

## Explore an Example Project

Browse the complete source code for our Quick Start example.

<EmbedExample example="quick-start-simple" showReadme={false} />
