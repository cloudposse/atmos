...
modern fonts installed and working with your terminal. Nerd Fonts are popular fonts that are patched to include icons.
...
Go to https://www.nerdfonts.com/ for more information. We recommend the "Fira Code" NerdFont version, which is whatall our
