...
components:
  terraform:
    ...
    vpc-1:
      ...
      # Optional backend configuration for the component
      # If not specified, the Atmos component name `vpc-1` will be used
      backend:
        s3:
    ...
    vpc-2:
      ...
      # Optional backend configuration for the component
      # If not specified, the Atmos component name `vpc-2` will be used
      backend:
        s3:
...
`components/terrafrom/vpc` folder:
