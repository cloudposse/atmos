...
Refer to [`atmos workflow`](/cli/commands/workflow) for the complete description of the CLI command used to execute workflows.
...
:::tip
View the full Workflow configuration schema in the [Workflow Schema](/schemas/workflow) reference section.
:::
