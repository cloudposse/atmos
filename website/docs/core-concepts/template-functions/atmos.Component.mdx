...
The following configurations shows different ways of using the `atmos.Component` template function to read values from
different Atmos components, including the outputs of other components, directly in Atmos stack manifests.
