...
more [derived the configuration is due to inheritance](/core-concepts/stacks/inheritance), the harder it may be to understand what the final
...
For more powerful filtering options, consider [describing stacks](/core-concepts/describing/stacks) instead.

The other helpful use-case for describing components and stacks is when developing polices for [validation](/core-concepts/validating/components) of
