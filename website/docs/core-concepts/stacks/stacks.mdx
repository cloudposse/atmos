...
When you design cloud architectures with Atmos, you break them apart into pieces called components. Then, you implement Terraform "root modules" for each of those components. Stacks are how you connect your components with configuration, so that everything comes together. 
