...
<Intro>
Atmos supports [Go templates](https://pkg.go.dev/text/template) in stack manifests. Use functions to customize Stack configurations _prior_ to interpretting them as YAML.
</Intro>
