...
<Intro>
Use templates as an _escape hatch_, when standard [inheritance](/core-concepts/stacks/inheritance) is insufficient. Atmos supports [Go templates](https://pkg.go.dev/text/template) in stack manifests and functions to customize Stack configurations _prior_ to interpreting them as YAML.
</Intro>
