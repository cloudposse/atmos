...
description: Read the remote state of any Atmos component directly from the configured backends
---
...
of components in Atmos stack manifests directly from the configured backends.
</Intro>
