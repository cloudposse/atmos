...
### Key Differences from [`!store`](/core-concepts/stacks/yaml-functions/store)
...
[`!store`](/core-concepts/stacks/yaml-functions/store) function instead, as it provides better integration with Atmos component dependencies.
:::
