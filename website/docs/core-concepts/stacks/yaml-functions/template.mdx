...
The results are JSON-encoded strings, not objects.

They can be sent to the `var1` and `var2` Terraform variables, but the variables need to be of type `string`, and
