...
YQ requires the strings in the default values to be qouble-qouted as well.
This means that you have to escape the double-qoutes in the default values by using two double-qoutes.
:::
