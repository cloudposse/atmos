...
```yaml
vars:
  # Always returns content as string
...
```yaml
vars:
  # ❌ This will likely fail as YQ expects structured data
...
- [YAML Functions](/core-concepts/stacks/yaml-functions) - Overview of all YAML functions in Atmos