  ...
  terraform:
    ...
    tgw/cross-region-hub-connector:
      settings:
        depends_on:
          1:
            # `tgw/cross-region-hub-connector` depends on the `vpc` component
            # from the same Atmos stack (same tenant, account and region)
            component: vpc
          2:
...
Execute the following Atmos command to see the component dependencies:
...
[
  {
    ...
    "stack": "ue1-network",
    "stack_slug": "ue1-network-tgw-attachment",
  },
  {
    "component": "tgw/cross-region-hub-connector",
    "component_type": "terraform",
    "stack": "ue1-network",
    "stack_slug": "ue1-network-tgw-cross-region-hub-connector",
  }
]
```
