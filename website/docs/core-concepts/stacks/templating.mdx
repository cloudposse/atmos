...
- In [Atmos Component Vendoring](/core-concepts/vendoring/components)
...
- `Go` templates in [Atmos Vendoring](/core-concepts/vendoring) and [Atmos Component Vendoring](/core-concepts/vendoring/components)
