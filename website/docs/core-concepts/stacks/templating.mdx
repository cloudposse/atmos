...
- In [Atmos Component Vendoring](/core-concepts/vendoring/component-manifest)
...
- `Go` templates in [Atmos Vendoring](/core-concepts/vendoring) and [Atmos Component Vendoring](/core-concepts/vendoring/component-manifest)
