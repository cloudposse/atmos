...
In the `Go` templates, you can use the following functions and datasources:
 ...
 - [Atmos Template Functions](#atmos-template-functions)
...
Atmos provides the following template functions for Go’s template language:
