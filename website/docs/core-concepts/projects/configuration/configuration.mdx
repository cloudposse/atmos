...
__NOTE:__ For the detailed description of all the sections, refer to [CLI Configuration](/cli/configuration).

### Stack Names (Slugs)

Atmos uses “slugs” to refer to stacks, so you don't need to pass multiple arguments to idenitfy a stack or a component in a stack.
...
Well-known paths are how Atmos knows how to find all your stack configurations, comoponents and workflows. Here are the essnetial paths that you need to configure:
