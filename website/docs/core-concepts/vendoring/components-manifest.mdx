...
Atmos natively supports the concept of "vendoring" individual components by defining a `component.yaml` inside of the component directory.
, which is making a copy of 3rd-party components or other dependencies in your own repo. 
