...
using the [`atmos.Component`](/core-concepts/stacks/templates/functions/atmos.Component) Go template function and
the [`!terraform.output`](/core-concepts/stacks/yaml-functions/terraform.output) Atmos YAML function instead of using
