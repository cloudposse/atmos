---
title: Using OpenTofu
sidebar_position: 2
sidebar_label: Using OpenTofu
---
...
similar to the way it supports [Terraform](/core-concepts/components/terraform/configuration). It's compatible with every version of `opentofu` and designed to
work with multiple different versions of it concurrently, and can even work alongside with [HashiCorp Terraform](/core-concepts/components/terraform/configuration).

Please see the complete configuration options for [Terraform](/core-concepts/components/terraform/configuration), as they are the same for OpenTofu. We'll focus
