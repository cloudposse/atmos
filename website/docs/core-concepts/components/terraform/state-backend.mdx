...
and [Remote State](/core-concepts/components/terraform/remote-state) to get the outputs
...
provisioning the backend resources themselves, is the responsibility of a Terraform component.
