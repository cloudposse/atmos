...
The [Open Policy Agent](https://www.openpolicyagent.org/docs/latest/) (OPA, pronounced “oh-pa”) is the open-source industry standard for policy validation. It provides a general-purpose policy engine to unify policy enforcement across your stacks. 
...
This is powerful stuff: because you can define many policies, it's possible to validate the same components differently for different environments or teams.
...
<EmbedFile filePath="examples/quick-start/stacks/catalog/vpc/defaults.yaml" />
...
<EmbedFile filePath="examples/quick-start/stacks/schemas/opa/catalog/constants/constants.rego" />
...
<EmbedFile filePath="examples/quick-start/stacks/schemas/opa/vpc/validate-vpc-component.rego" />
