...
This is powerful stuff: because you can define many policies, it's possible to apply different policies depending on where a component is defined in the stsacks. For example, it could validate differently for based on environments or teams.
