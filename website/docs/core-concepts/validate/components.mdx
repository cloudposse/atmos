...
<File title="examples/quick-start/stacks/catalog/vpc/defaults.yaml">
```yaml 
components:
  terraform:
    vpc:
...
<File title="examples/quick-start/stacks/schemas/jsonschema/vpc/validate-vpc-component.json">
```json 
{
  "$id": "vpc-component",
...
<File title="examples/quick-start/stacks/schemas/opa/catalog/constants/constants.rego">
```rego
...
<File title="examples/quick-start/stacks/schemas/opa/vpc/validate-vpc-component.rego">
```rego 
