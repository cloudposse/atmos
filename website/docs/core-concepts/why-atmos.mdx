...
<PrimaryCTA to="/introduction/why-atmos">
...
1. [Understand Core Concepts](/core-concepts/concepts-overview) - Component and Stack fundamentals
2. [Create Your First Stack](/core-concepts/first-stack) - Simplest possible example
3. [Learn YAML in Atmos](/core-concepts/yaml-guide) - Deep merge, scope, and functions
