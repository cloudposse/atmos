...
In Atmos, this is considered an anti-pattern; instead, this should be broken down into [components](/components/components) and configured with [stacks](/learn/stacks).
