...
[Cloud Posse](https://github.com/cloudposse) publishes their [Terraform Best Practices](https://docs.cloudposse.com/reference/best-practices/terraform-best-practices/) which are more general and not specific to Atmos.
