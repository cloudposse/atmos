...
description: Use the command setting to override the default executable for Terraform, Helmfile, Packer, Ansible, or Rain.
id: command
---
...
<Intro>
The `command` setting allows you to override the executable that Atmos uses to run Terraform, Helmfile, Packer, Ansible, or Rain commands. This is useful for using alternative tools like OpenTofu, custom wrappers, or specific binary versions.
</Intro>
