...
Terraform/OpenTofu linter that catches errors, deprecated syntax, and
provider-specific issues the compiler won't. The `tflint` kind runs tflint
over the component's sources and feeds the SARIF output through Atmos's shared
