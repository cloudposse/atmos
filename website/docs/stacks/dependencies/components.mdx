...
<dl>
  ...
  <dd>The Atmos stack name where the component is provisioned (e.g., `tenant1-ue2-prod`). If omitted, the component is assumed to be in the same stack. Use templates to construct stack names dynamically.</dd>
...
[
  ...
  },
  {
    "component": "subnet",
    "stack": "tenant1-ue1-dev",
    "affected": "stack.settings.depends_on.folder"
  }
]
```
</Terminal>
