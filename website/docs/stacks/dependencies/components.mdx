...
<dl>
  ...
  <dt>required <em>(boolean, default: true)</em></dt>
  <dd>Whether the target must be concrete and enabled. Set to `false` when the dependency should provide ordering only when that target is available.</dd>
</dl>
