...
description: Use the vars section to pass variables to your Terraform, Helmfile, Packer, or Ansible components.
id: vars
---
...
:::info
For a complete explanation of how variables are resolved through imports, inheritance, and overrides — including
how import order interacts with scope levels — see [Variable Merge Order](/learn/merge-order).
:::
