...
description: Use the vars section to pass variables to components and share values across stack configuration.
id: vars
---
...
- **Component Configuration:** Pass input variables to Terraform root modules, Helmfile releases, Packer templates, or Ansible playbooks, and share values used by Rain component configuration.
...
Variables defined under `terraform`, `helmfile`, `packer`, `ansible`, or `rain` apply to all components of that type:
