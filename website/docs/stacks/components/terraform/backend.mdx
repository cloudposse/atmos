...
if it doesn't exist. See [Component Provisioning](/stacks/components/provision) for the
full schema, or [Backend Provisioning](/components/terraform/backend-provisioning) for the
