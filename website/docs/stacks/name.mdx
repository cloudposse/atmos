...
<EmbedExample example="stack-names" title="Stack Names Example" />
...
- **Dependencies**: Reference stacks by name with `dependencies.components[].stack`
...
- [Migrating from Terramate](/migration/terramate)
