...
and [`metadata`](/learn/stacks/define-components) component's configuration section.
...
In **Component-Oriented Programming (COP)** implemented in Atmos, a [mixin](/stacks/mixins) is an abstract base component that is never
