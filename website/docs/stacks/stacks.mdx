...
<Intro>
Stacks are configuration files that define your environments. They specify which components to deploy, with what settings, and how they relate to each other. This is where configuration lives—separate from your Terraform code. Write stacks in YAML, JSON, or HCL.
</Intro>
...
A single configuration file can define multiple stacks, allowing you to group related environments or configurations together. Each stack should have an explicit `name` field to identify it:
