...
- **[Components](/core-concepts/concepts-overview)** - What they are and how they work
- **[Stacks](/core-concepts/concepts-overview)** - Basic stack concepts
- **[YAML in Atmos](/core-concepts/yaml-guide)** - Scope, deep merge, tags vs templates
- **[Imports Basics](/core-concepts/imports-basics)** - Simple import patterns
- **[Inheritance Basics](/core-concepts/inheritance-basics)** - Single inheritance

If you haven't read these yet, **start with the [Learn Atmos](/core-concepts/) section first**.
