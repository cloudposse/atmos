...
<Intro>
Stacks are YAML files that configure your environments. They define which components to deploy, with what settings, and how they relate to each other. This is where configuration lives, separate from your component implementation code.
</Intro>
...
Atmos supports five component types, each with specific configuration options:
...
| [Rain](/stacks/components/rain) | CloudFormation management | AWS CloudFormation stacks |
