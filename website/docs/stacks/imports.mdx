...
Atmos also supports [inheritance](/stacks/inheritance) and [overrides](/stacks/overrides) to manage configuration variations without templating. When those methods don't fit your use-case, [templating](/templates) is available as an escape hatch.
