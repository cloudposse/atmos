...
<dl>
  ...
  <dd>
    ...
    **Note**: Use quotes around the value to preserve spaces and prevent shell splitting when passing pager arguments. To disable, use `--pager=false`.
  </dd>
...
<dl>
  ...
  <dd>
    ...
    - Available in: most operational commands (`terraform`, `helmfile`, `describe`, etc.)
  ...
  <dd>
    ...
    - Available in: component-related commands (`terraform`, `helmfile`, etc.)
    - Supports tab completion
  </dd>
</dl>
