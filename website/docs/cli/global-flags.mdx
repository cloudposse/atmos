...
<dl>
    ...
    <dd>
        ...
        - When enabled, command output is sent to the configured AI provider for analysis and description
        - Requires AI to be configured in `atmos.yaml` (`ai.enabled: true` with a provider)
        - Currently used with [`atmos aws security`](/cli/commands/aws/security) and [`atmos aws compliance`](/cli/commands/aws/compliance) commands
        - Can also use `ATMOS_AI` environment variable
        - Example: `atmos aws security --ai -s prod`
        - See [AI Configuration](/cli/configuration/ai) for provider setup
    </dd>
...
<dl>
    ...
    <dd>
        ...
        - CLI flag takes precedence over this environment variable
        - Example: `ATMOS_AI=true atmos aws security -s prod`
    </dd>
</dl>
...
atmos aws security --ai -s prod

# Enable AI analysis via environment variable
ATMOS_AI=true atmos aws security --severity=critical -s prod

# AI analysis with compliance reports
atmos aws compliance --ai --framework=cis-aws -s prod
```
