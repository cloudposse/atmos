...
<dl>
    ...
    <dd>
        ...
        - Currently used with [`atmos aws security analyze`](/cli/commands/aws/security-analyze) and [`atmos aws compliance report`](/cli/commands/aws/compliance-report) commands
        - Can also use `ATMOS_AI` environment variable
        - Example: `atmos aws security analyze --ai -s prod`
