...
<dl>
  ...
  <dd>
    ...
    **Note:** This value is read once when Atmos starts. Setting it via `os.Setenv` after the
    process starts has no effect; set it in the process environment before launching Atmos.
  </dd>
