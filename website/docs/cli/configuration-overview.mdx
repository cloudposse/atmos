...
[Learn more about CLI Configuration →](/cli/configuration/configuration)
...
[Learn more about Vendoring →](/vendoring)
...
- [CLI Configuration](/cli/configuration/configuration) — Configure Atmos behavior
- [Stack Configuration](/stacks) — Define your environments
- [Components](/learn/stacks/define-components) — Configure components in stacks
- [Vendoring](/vendoring) — Manage external dependencies
