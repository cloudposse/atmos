...
id: providers
description: Configure authentication providers for AWS SSO, SAML, GitHub OIDC, GCP Workload Identity Federation, and Azure (Device Code, OIDC, CLI) in your `atmos.yaml`.
---
...
3. Atmos acquires tokens for Azure Resource Manager, Microsoft Graph, and Azure KeyVault
