...
<dl>
  ...
  <dt>`write_file`</dt>
  <dd>Create a new file or overwrite an existing file. Requires confirmation by default.</dd>
...
<dl>
  <dt>Location</dt>
  <dd>**Atmos AI Skills:** Inside Atmos AI. **[Claude Code Integration](/ai/claude-code-integration):** External (IDE).</dd>

  <dt>Activation</dt>
  <dd>**Atmos AI Skills:** Ctrl+A in `atmos ai chat`. **Claude Code:** `@atmos-expert` in IDE.</dd>

  <dt>Purpose</dt>
  <dd>**Atmos AI Skills:** Task specialization. **Claude Code:** Development integration.</dd>

  <dt>Tool Access</dt>
  <dd>**Atmos AI Skills:** Direct Atmos tools. **Claude Code:** Via MCP protocol.</dd>

  <dt>Configuration</dt>
  <dd>**Atmos AI Skills:** `atmos.yaml` skills section. **Claude Code:** `.claude/agents/*.md`.</dd>

  <dt>Use Case</dt>
  <dd>**Atmos AI Skills:** Operations workflows. **Claude Code:** Code development.</dd>
</dl>
