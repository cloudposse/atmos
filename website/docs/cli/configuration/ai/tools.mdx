...
description: Configure AI tool execution and permissions in the `settings.ai.tools` section of your `atmos.yaml`.
---
...
<Intro>
The `settings.ai.tools` section controls which Atmos commands the AI assistant can execute and whether user
...
For tool execution workflow, permission prompts, and skill-specific tool access, see [AI Tools](/ai/tools).
