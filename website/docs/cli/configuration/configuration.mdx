...
<File title="atmos.yaml">
    ...
    settings:
      ...
      # DEPRECATED: Use settings.terminal instead
      docs:
        max-width: 120  # DEPRECATED: Use settings.terminal.max_width instead
        pagination: true # DEPRECATED: Use settings.terminal.pager instead
    ```
</File>
