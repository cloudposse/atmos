...
The --config-path flag designates a directory containing Atmos configuration files (atmos.yaml, .atmos.yaml,atmos.yml, .atmos.yml). Only files from the specified directory will be loaded.
