...
Think of this file as where you bootstrap the settings of your project. If you'll be using [Terraform](/components/terraform), then this is where you'd specify the command to run (e.g. [`opentofu`](/cli/configuration/components#opentofu)), the base path location of the components, and so forth.
...
- [`atmos describe config`](/cli/commands/describe/config) — Inspect your merged configuration
