...
| ATMOS_PROFILE                                         | N/A                                             | Activate configuration profiles (comma-separated). Equivalent to the `--profile` flag. For more details, refer to [Configuration Profiles](/cli/commands/profile)                                                                                                   |
