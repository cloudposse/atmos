...
| ATMOS_VENDOR_YAML_PATH                                | vendor.vendor_yaml_path                         | Path to the vendor configuration file (vendor.yaml). Supports both absolute and relative paths. Used to configure vendor-specific settings for the Atmos CLI.                                                                                                                                                                                        |
