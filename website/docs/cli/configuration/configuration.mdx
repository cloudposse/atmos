...
| Section | Description |
|---------|-------------|
| [Components](/cli/configuration/components) | Component type configuration (Terraform, Helmfile, Packer, Ansible, Rain) |
...
| [Ansible](/cli/configuration/components/ansible) | Ansible component settings |
| [Rain](/cli/configuration/components/rain) | Rain component settings |
