...
be confused with [Stack configurations](/learn/stacks/), which have a different schema.

Think of this file as where you [bootstrap the settings or configuration of your project](/projects). If you'll be using
[terraform](/components/terraform), then [this is where](/cli/configuration/components#terraform-component-behavior)
you'd specify the command to run (e.g. [`opentofu`](/projects/configuration/opentofu)),
...
- [Atmos Component Validation](/validation/validating)
:::
...
native commands like `terraform apply` or `describe stacks`, as well as [Atmos Custom Commands](/custom-commands/custom-commands).
