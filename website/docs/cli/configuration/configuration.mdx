...
| ATMOS_BITBUCKET_TOKEN                                 | N/A                                             | App password for Bitbucket API requests to avoid rate limits. Unauthenticated requests are limited to 60 requests per hour across all API resources.                                                                  |
