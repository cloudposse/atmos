...
Atmos extends standard YAML with several custom functions that can be used in stack manifests. These functions provide powerful tools for dynamic configuration:
