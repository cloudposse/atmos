...
description: Configure Atmos integrations with Atlantis and other tools.
id: integrations
...
<Intro>
Atmos supports integrations that extend its core functionality. Configure integrations to generate configuration for tools like Atlantis.
</Intro>
