...
settings:
  terminal:
    ...
    syntax_highlighting:
      ...
      pager: false                  # Separate pager setting for highlighted content
...
<dl>
  ...
  <dt>`pager`</dt>
  <dd>Whether to use a pager specifically for syntax-highlighted output (default: `false`). This controls paging only for syntax-highlighted content and is separate from the main terminal pager setting above.</dd>
  <dt>`line_numbers`</dt>
