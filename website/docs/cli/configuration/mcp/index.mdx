...
<DocCardList items={[
  ...
  {type: 'link', href: '/cli/commands/mcp/add', label: 'atmos mcp add', description: 'Add an MCP server to atmos.yaml'},
  {type: 'link', href: '/cli/commands/mcp/remove', label: 'atmos mcp remove', description: 'Remove an MCP server'},
