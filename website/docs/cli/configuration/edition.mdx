...
A project pinned to September 2025 predates nine of these changes (everything from the pager change onward), so it keeps the pager enabled, the Helmfile EKS integration on, metadata inheritance off, strict error modes, table-formatted listings, and provenance off:
