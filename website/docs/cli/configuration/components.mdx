...
For example, [Terraform "root modules"](/components/terraform) can be used as components in Atmos.
...
:::important
Do not confuse this configuration with [configuring components in stacks](/learn/stacks/define-components).
...
For additional details on configuring Terraform components, refer to the [Terraform](/projects/configuration/terraform)
and [OpenTofu](/projects/configuration/opentofu) documentation.
