...
<dl>
  ...
  <dd>
    Override the name of the summary template loaded from the
    [templates base path](/cli/configuration/ci/templates). For native Kubernetes components
    this loads `<base_path>/kubernetes/<template>.md`.
