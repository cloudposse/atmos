...
<Intro>
  Configure how Atmos executes Ansible commands for configuration management and
  infrastructure automation, including playbook execution and inventory
  management.
</Intro>
...
<DocCardList
  items={[
    {
      type: "link",
      href: "/cli/commands/ansible/usage",
      label: "atmos ansible",
      description: "Execute Ansible commands",
    },
    {
      type: "link",
      href: "/cli/commands/ansible/playbook",
      label: "atmos ansible playbook",
