...
<CastPlayer title="atmos secret --help" src="/casts/screengrabs/atmos-secret--help.cast" static chrome />
...
<dl>
  ...
  <dt>[`delete`](/cli/commands/secret/delete) <em>(aliases `rm`, `unset`)</em></dt>
