...
<CastPlayer title="atmos aws compliance report --help" src="/casts/screengrabs/atmos-aws-compliance-report--help.cast" static chrome />
...
<Terminal title="AI compliance analysis">
```bash
...
<dl>
  ...
  <dt>`nist`</dt>
  <dd>NIST 800-53. Security and privacy controls for federal information systems and organizations.</dd>
</dl>
