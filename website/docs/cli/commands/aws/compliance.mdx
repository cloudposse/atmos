...
# Save report to file
atmos aws compliance report --framework hipaa --format markdown > hipaa-report.md
```
</Terminal>
...
atmos aws compliance report --framework pci-dss --stack prod-us-east-1 --format json > compliance.json
