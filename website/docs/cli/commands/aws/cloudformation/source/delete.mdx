---
title: atmos aws cloudformation source delete
...
<Intro>
Use this command to delete the vendored source directory for an `aws/cloudformation` component. This removes the component directory that was created by `atmos aws cloudformation source pull`.
</Intro>
...
<CastPlayer title="atmos aws cloudformation source delete --help" src="/casts/screengrabs/atmos-aws-cloudformation-source-delete--help.cast" static chrome />

## Usage

```shell
atmos aws cloudformation source delete <component> --stack <stack> --force
```
...
Output:
```
Deleting directory: components/cloudformation/vpc
✓ Successfully deleted: components/cloudformation/vpc
```
...
```shell
atmos aws cloudformation source delete vpc --stack dev
```
...
- [`atmos aws cloudformation source pull`](/cli/commands/aws/cloudformation/source/pull) — Vendor component source
- [`atmos aws cloudformation source list`](/cli/commands/aws/cloudformation/source/list) — List components with sources
