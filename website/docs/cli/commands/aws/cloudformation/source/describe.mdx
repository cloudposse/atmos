---
title: atmos aws cloudformation source describe
...
<CastPlayer title="atmos aws cloudformation source describe --help" src="/casts/screengrabs/atmos-aws-cloudformation-source-describe--help.cast" static chrome />
...
<dl>
  <dt>`components."aws/cloudformation".<component>.source`</dt>
