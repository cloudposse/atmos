...
atmos describe stacks --show-provenance
atmos describe stacks --components=infra/vpc --show-provenance
```
...
<dl>
  ...
  <dd>Display the source file and line information for each configuration value, showing where each setting comes from in the inheritance chain. When enabled, the output includes provenance annotations alongside the configuration values for all components in the stacks.</dd>
</dl>
