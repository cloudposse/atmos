...
To simply enumerate what exists without resolving any values, use [`atmos list stacks`](/cli/commands/list/stacks) or [`atmos list components`](/cli/commands/list/components) — those commands never read remote state.
:::
