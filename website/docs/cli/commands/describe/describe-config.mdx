...
| `--query`  | Query the results of the command using `yq` expressions.<br/><br/>`atmos describe config --query <yq-expression>`.<br/><br/>For more details, refer to https://mikefarah.gitbook.io/yq | `-q`  | no       |
