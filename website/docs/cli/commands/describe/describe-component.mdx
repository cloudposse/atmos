...
<Intro>
Use this command to describe the complete configuration for an [Atmos component](/components/components) in
...
- `atmos_component` - [Atmos component](/components/components) name
