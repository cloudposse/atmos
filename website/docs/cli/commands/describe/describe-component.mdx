...
<dl>
  ...
  <dd>Atmos component name or filesystem path.<br/><br/>
  Supports both:<br/>
  - Component names: `vpc`, `infra/vpc`, `test/test-component`<br/>
  - Filesystem paths: `.` (current directory), `./vpc`, `components/terraform/vpc`<br/><br/>
