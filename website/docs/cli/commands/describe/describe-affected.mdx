...
| `--jsonpath`                       | JSONPath expression to query and filter the command output. https://goessner.net/articles/JsonPath                                                               | no       |
| `--jmespath`                       | JMESPath expression to query and filter the command output. https://jmespath.org  https://jmespath.site/main                                                     | no       |
