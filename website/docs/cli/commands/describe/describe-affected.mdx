...
Destruction of cloud resources is irreversible. Always review the list of deleted components before running
`terraform destroy`. Consider adding manual approval steps in your CI/CD pipeline for destruction workflows.
:::
