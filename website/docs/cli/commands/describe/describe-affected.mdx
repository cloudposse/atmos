...
```json
{
  ...
  "folder": ".....",
  "dependents": [],
  "included_in_other_dependents": "true | false"
}
```
...
- `dependents` - list of components that depend on the current affected component. It will be included only if the
...
- `included_in_other_dependents` - a boolean flag indicating if the affected component in the stack is also present in any of the `dependents`
  properties of the other affected components. It will be included only if the command-line flag `--include-dependents=true`
  is passed. If `included_in_other_dependents` is set to `true`, it indicates that the affected component in the stack is also
  ...
  [
    {
      ...
      "included_in_other_dependents": false,
      "dependents": [
        {
          "component": "component-2",
          "stack": "plat-ue2-dev",
    ...
    },
    {
      ...
      "stack": "plat-ue2-dev",
      "stack_slug": "plat-ue2-dev-component-2",
      "included_in_other_dependents": true,
      "dependents": [
        {
          "component": "component-3",
          "stack": "plat-ue2-dev",
...
The `component-1` component does not depend on any other component, and therefore it has the `included_in_other_dependents`
attribute set to `false`. The `component-2` and `component-3` components depend on other components and are included in
the `dependents` property of the other components, and hence the `included_in_other_dependents` attribute is set to `true`.

When processing the above output, you might decide to not plan/apply the `component-2` and `component-3` components
separately since they are in the `dependents` property of the `component-1` component. Instead, you might just
