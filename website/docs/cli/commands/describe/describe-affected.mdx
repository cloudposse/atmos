...
<dl>
    ...
    <dd>
        ...
        Refer to [Locking Components with `metadata.locked`](/learn/stacks/define-components/#locking-components-with-metadatalocked)
...
[Disabled Atmos components](/learn/stacks/define-components/#disabling-components-with-metadataenabled) (`metadata.enabled` is set to `false`)
