...
Run `atmos describe affected --format=matrix --output-file=$GITHUB_OUTPUT` directly in your workflow to fan out across affected components. See the [matrix workflow example](/ci#multi-component-matrix) for the full pattern.
:::
