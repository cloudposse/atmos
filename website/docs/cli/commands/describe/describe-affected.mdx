...
atmos describe affected --only-from <stack>
atmos describe affected --only-from <stack> --include-dependents
...
<dl>
    ...
    <dt>`--only-from` <em>(optional)</em></dt>
    <dd>
        Return the affected and dependent components from a specific stack.
