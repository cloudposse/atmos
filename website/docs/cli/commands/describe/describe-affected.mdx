...
- `included_in_dependents` - a boolean flag indicating if the affected component is also present in any of the `dependents`
  ...
  This flag can be used to decide whether to plan/apply the affected component - you can skip planning/applying the component
