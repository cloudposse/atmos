...
<dl>
    ...
    <dt>`--format` <em>(alias `-t`)</em><em>(optional)</em></dt>
    <dd>
    ...
    <dd>
        ...
        `atmos describe dependents <component> -s <stack> --process-templates`
    </dd>
    ...
    <dd>
        ...
        `atmos describe dependents <component> -s <stack> --process-functions`
    </dd>
