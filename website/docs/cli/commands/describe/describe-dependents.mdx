...
<dl>
  ...
  <dt>`--query` (`-q`)</dt>
  <dd>Query the results of the command using `yq` expressions</dd>
</dl>
...
<dl>
  <dt>`component`</dt>
  <dd>The dependent Atmos component</dd>

  <dt>`component_type`</dt>
  <dd>The type of the dependent component (`terraform` or `helmfile`)</dd>

  <dt>`component_path`</dt>
  <dd>The filesystem path to the `terraform` or `helmfile` component</dd>

  <dt>`namespace`</dt>
  <dd>The namespace where the dependent Atmos component is provisioned</dd>

  <dt>`tenant`</dt>
  <dd>The tenant where the dependent Atmos component is provisioned</dd>

  <dt>`environment`</dt>
  <dd>The environment where the dependent Atmos component is provisioned</dd>

  <dt>`stage`</dt>
  <dd>The stage where the dependent Atmos component is provisioned</dd>

  <dt>`stack`</dt>
  <dd>The Atmos stack where the dependent Atmos component is provisioned</dd>

  <dt>`stack_slug`</dt>
  <dd>The Atmos stack slug (concatenation of the Atmos stack and component)</dd>

  <dt>`spacelift_stack`</dt>
  <dd>The dependent Spacelift stack. Included only if Spacelift workspace is enabled for the dependent component</dd>

  <dt>`atlantis_project`</dt>
  <dd>The dependent Atlantis project name. Included only if the Atlantis integration is configured in the stack</dd>
</dl>
:::note
