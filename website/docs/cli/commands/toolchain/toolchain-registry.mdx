...
- [`atmos toolchain search`](/cli/commands/toolchain/toolchain-search) - Alias to `registry search`
- [`atmos toolchain install`](/cli/commands/toolchain/toolchain-install) - Install tools from registries
- [`atmos toolchain info`](/cli/commands/toolchain/toolchain-info) - View tool configuration details
