...
id: registry-list
description: List all configured registries or browse tools available in a specific registry.
---
...
<CastPlayer title="atmos toolchain registry list --help" src="/casts/screengrabs/atmos-toolchain-registry-list--help.cast" static chrome />
