...
- [`atmos toolchain registry search`](/cli/commands/toolchain/toolchain-registry-search) - Search for specific tools
- [`atmos toolchain install`](/cli/commands/toolchain/toolchain-install) - Install tools from registry
- [`atmos toolchain info`](/cli/commands/toolchain/toolchain-info) - View detailed tool information
- [`atmos toolchain list`](/cli/commands/toolchain/toolchain-list) - List installed tools
