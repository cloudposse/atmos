...
<DemoVideo id="completion" title="atmos completion" showCaption={false} />

<CastPlayer title="atmos completion --help" src="/casts/screengrabs/atmos-completion--help.cast" static chrome />
