...
<dl>
    ...
    <dd>
        ...
        If not specified, Atmos generates the planfile in the Terraform component directory with the name
        ...
        atmos terraform generate planfile <component> -s <stack> --format=yaml --file=planfile.yaml
