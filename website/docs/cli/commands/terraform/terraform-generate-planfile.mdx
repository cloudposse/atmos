...
<Intro>
Use this command to generate a Terraform planfile for an Atmos [component](/core-concepts/components) in a [stack](/core-concepts/stacks) and convert it to JSON or YAML format for review.
</Intro>
