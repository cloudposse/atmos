...
description: List components with metadata.source in a stack
---
import Intro from '@site/src/components/Intro'
import Screengrab from '@site/src/components/Screengrab'

<Intro>
Use this command to list all Terraform components that have `metadata.source` configured in a stack. This shows which components can be vendored using the source provisioner.
</Intro>
...
The `list` command scans a stack's component configurations and displays all components that have `metadata.source` defined. This helps identify:
