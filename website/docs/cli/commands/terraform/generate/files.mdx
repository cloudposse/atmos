...
id: files
description: Generate auxiliary configuration files for Terraform components
---
...
<CastPlayer title="atmos terraform generate files --help" src="/casts/screengrabs/atmos-terraform-generate-files--help.cast" static chrome />
...
<ActionCard title="Configure File Generation" ctaText="Learn More" ctaLink="/stacks/generate">
  Learn how to configure the `generate` section in your stack manifests to create auxiliary files for Terraform components.
</ActionCard>

## Working Example

<EmbedExample example="generate-files" title="File Generation Example" />
