...
<ActionCard title="Backend Configuration">
    ...
    <div>
      <PrimaryCTA to="/stacks/components/provision/backend">Configuration Reference</PrimaryCTA>
    </div>
</ActionCard>

<CastPlayer title="atmos terraform generate --help" src="/casts/screengrabs/atmos-terraform-generate--help.cast" static chrome />
