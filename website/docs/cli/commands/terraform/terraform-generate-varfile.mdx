...
<Intro>
Use this command to generate a `.tfvar.json` variable file for an Atmos [component](/core-concepts/components) in a [stack](/core-concepts/stacks) with all configured values.
</Intro>
