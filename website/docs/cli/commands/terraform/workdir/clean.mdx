...
<CastPlayer title="atmos terraform workdir clean --help" src="/casts/screengrabs/atmos-terraform-workdir-clean--help.cast" static chrome />
...
```
✓ Workdir cleaned for vpc in dev
```
...
```
▶ Cleaning all workdirs
✓ Cleaned all workdirs: .workdir
...
```
▶ Dry run: would clean 3 workdir(s):
▶ terraform/dev-vpc-bb03116d
▶ terraform/prod-vpc-0e327247
▶ terraform/staging-vpc-8ce5e903
```
