...
<Intro>
Use this command to start a new shell configured with the Terraform environment for an Atmos component in a stack. This allows executing native Terraform commands without Atmos-specific arguments.
</Intro>
