...
plat-ue2-dev       eks          github.com/cloudposse-terraform-components/aws-eks-cluster.git//src   1.450.0
plat-ue2-dev       vpc          github.com/cloudposse-terraform-components/aws-vpc.git//src   1.450.0
plat-ue2-prod      eks          github.com/cloudposse-terraform-components/aws-eks-cluster.git//src   1.451.0
plat-ue2-prod      vpc          github.com/cloudposse-terraform-components/aws-vpc.git//src   1.451.0
```
