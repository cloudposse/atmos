...
plat-ue2-dev       eks          github.com/cloudposse-terraform-components/aws-eks-cluster.git//src   v1.539.0
plat-ue2-dev       vpc          github.com/cloudposse-terraform-components/aws-vpc.git//src   v1.539.0
plat-ue2-prod      eks          github.com/cloudposse-terraform-components/aws-eks-cluster.git//src   v1.539.1
plat-ue2-prod      vpc          github.com/cloudposse-terraform-components/aws-vpc.git//src   v1.539.1
```
