...
<Screengrab title="atmos terraform cache mirror --help" slug="atmos-terraform-cache-mirror--help" />
...
2. [`components.terraform.cache.mirror.platforms`](/cli/configuration/components/terraform#cache) in your stack configuration.
...
```shell
# Mirror one component for the platforms declared in cache.mirror.platforms
