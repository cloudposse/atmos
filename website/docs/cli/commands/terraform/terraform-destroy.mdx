...
<CastPlayer title="atmos terraform destroy --help" src="/casts/screengrabs/atmos-terraform-destroy--help.cast" static chrome />
...
<dl>
    ...
    <dd>
        Enable streaming UI mode for real-time resource destruction progress. Shows a Docker-build-style progress view with spinners, a dependency tree, and resource states.
