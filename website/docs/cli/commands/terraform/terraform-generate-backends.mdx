...
<Intro>
Use this command to generate Terraform backend configuration files for all Atmos [components](/core-concepts/components) across all [stacks](/core-concepts/stacks).
</Intro>
