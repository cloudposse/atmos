...
- Updating to a new version after changing `metadata.source.version`
...
On success:
```
Re-vendoring component 'vpc' from metadata.source...
Downloading from github.com/cloudposse/terraform-aws-components//modules/vpc?ref=1.451.0
✓ Successfully re-vendored component to components/terraform/vpc
```
