...
Use this command to display the version of Terraform/OpenTofu being used.
 This command is a direct passthrough to the native `terraform version` command.
:::
...
<dl>
    ...
    <dd>
        This flag has no effect for the `version` command since it does not perform initialization.
    </dd>
