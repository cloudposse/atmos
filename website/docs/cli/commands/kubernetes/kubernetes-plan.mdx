...
atmos kubernetes plan --affected --labels cost-center=platform --labels compliance=sox
```
...
<dl>
  ...
  <dd>Atmos stack. Required when planning a named component; not required with `--all`/`--affected`/`--tags`/`--labels` bulk selection.</dd>
