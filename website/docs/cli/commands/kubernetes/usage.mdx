...
id: usage
description: Render, validate, diff, plan, apply, deploy, and delete Kubernetes components in Atmos stacks.
---
...
<ActionCard title="Configure Kubernetes Components">
  ...
  <div>
    <PrimaryCTA to="/cli/configuration/components/kubernetes">atmos.yaml Configuration</PrimaryCTA>
