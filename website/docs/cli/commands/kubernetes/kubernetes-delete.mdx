...
atmos kubernetes delete --affected --labels cost-center=platform --labels compliance=sox
```
...
<dl>
  ...
  <dd>Atmos stack. Required when deleting a named component; not required with `--all`/`--affected`/`--tags`/`--labels` bulk selection.</dd>
