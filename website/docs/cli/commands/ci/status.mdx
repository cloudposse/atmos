...
The `atmos ci` command group is an **experimental feature**. To suppress the experimental warning, add `settings.experimental: silence` to your `atmos.yaml`. See [Experimental Features](/cli/configuration#experimental-features) for details.
:::
