...
id: list
description: List Atmos releases or locally installed versions
---
...
<CastPlayer title="atmos version list --help" src="/casts/screengrabs/atmos-version-list--help.cast" static chrome />
...
<dl>
  <dt>`--installed`</dt>
  <dd>List locally installed versions instead of GitHub releases. Default: `false`</dd>
