...
<DemoVideo id="version" title="atmos version" showCaption={false} />

<CastPlayer title="atmos version show --help" src="/casts/screengrabs/atmos-version-show--help.cast" static chrome />
