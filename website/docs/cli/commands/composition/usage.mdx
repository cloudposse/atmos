...
|---------|----------------|-------------|
| `list` | Optional | Shows declared compositions and the stacks where each has fulfilled members. With `-s <stack>`, also shows which declared services are fulfilled in that stack. |
