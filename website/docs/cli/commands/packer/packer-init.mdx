...
<Intro>
Initialize Packer working directories for your Atmos components. Downloads and installs required plugins in parallel, caching them for subsequent runs. Essential before running build, validate or inspect commands.
</Intro>
