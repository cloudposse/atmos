...
<dl>
    ...
    <dd>
        Packer template file or directory path. Defaults to `.` (current directory), which tells Packer
...
<ActionCard title="Troubleshooting" ctaText="Learn More" ctaLink="/cli/commands/packer/packer-troubleshooting">
