...
<CastPlayer title="atmos packer source describe --help" src="/casts/screengrabs/atmos-packer-source-describe--help.cast" static chrome />
...
- [`atmos packer source list`](/cli/commands/packer/source/list) — List components with sources
