...
<CastPlayer title="atmos ansible playbook --help" src="/casts/screengrabs/atmos-ansible-playbook--help.cast" static chrome />
...
<EmbedFile filePath="examples/demo-ansible/stacks/catalog/hello-world.yaml" />

When you run `atmos ansible playbook hello-world -s dev`, Atmos:
...
<EmbedExample example="demo-ansible" />
