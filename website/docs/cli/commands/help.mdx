...
<Intro>
Display help information for any Atmos command. Shows available subcommands, arguments, and flags with their descriptions. Use this to explore Atmos capabilities and learn command syntax.
</Intro>
