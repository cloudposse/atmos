...
atmos scaffold generate \
  github.com/cloudposse/atmos-scaffolds.git//vpc \
...
Explore a working example that demonstrates scaffold template mechanics.

<EmbedExample example="scaffolding" />

### Real-World Example

For a real, ready-to-run template generated the same way — a full AWS
landing zone provisioned end to end on the local emulator — see the
`scaffolds` collection.

<EmbedExample example="scaffolds" />

## Learn More

- [Creating Custom Scaffold Templates](/cli/commands/scaffold)
- [Template Variables and Functions](/functions/template)
