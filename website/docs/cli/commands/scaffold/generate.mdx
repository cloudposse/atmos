...
<dl>
  ...
  <dd>
    ...
    `.atmos/scaffold.yaml`, not `--base-ref`.
  </dd>
  ...
  <dd>
    ...
    dependency on the target being a Git repository at all — it requires a prior generation's
    `.atmos/scaffold.yaml` record (so the original answers are recoverable).
  </dd>
