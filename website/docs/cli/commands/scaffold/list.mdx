...
<CastPlayer title="atmos scaffold list --help" src="/casts/screengrabs/atmos-scaffold-list--help.cast" static chrome />
...
- [Configuring Scaffold Templates](/cli/commands/scaffold/usage)
