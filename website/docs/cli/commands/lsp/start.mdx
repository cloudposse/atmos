...
<Intro>
Use this command to start the Atmos Language Server Protocol (LSP) server for IDE integration. The LSP server provides syntax validation, auto-completion, hover documentation, and go-to-definition for Atmos stack files.
</Intro>
