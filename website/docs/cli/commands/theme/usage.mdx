...
<DemoVideo id="theme" title="atmos theme" showCaption={false} />

<ActionCard title="Configure Terminal Settings">
    Learn how to configure terminal themes, colors, and display options in your atmos.yaml.
    <div>
      <PrimaryCTA to="/cli/configuration/settings/terminal">Configuration Reference</PrimaryCTA>
    </div>
</ActionCard>

## Usage

<CastPlayer title="atmos theme --help" src="/casts/screengrabs/atmos-theme--help.cast" static chrome />
