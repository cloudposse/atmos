...
<CastPlayer title="atmos helmfile --help" src="/casts/screengrabs/atmos-helmfile--help.cast" static chrome />
...
atmos helmfile <command> <component> --stack <stack> --ci [options]
```
