---
title: Customizing List Command Output
sidebar_label: Column Customization
---

# Customizing List Command Output
...
The column customization feature applies to the following commands:
...
**Example Usage:**
```yaml
# To display the stack name as a column value:
value: "{{ .stack_name }}"
```
---
