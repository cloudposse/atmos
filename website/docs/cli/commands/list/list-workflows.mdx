...
description: Use this command to list all workflows defined in your Atmos project
---
...
<CastPlayer title="atmos list workflows --help" src="/casts/screengrabs/atmos-list-workflows--help.cast" static chrome />
