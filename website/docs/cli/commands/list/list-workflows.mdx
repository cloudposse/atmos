...
<Intro>
List available Atmos workflows defined in your configuration. Shows workflow names, descriptions, and file locations to help discover automation capabilities in your project.
</Intro>
