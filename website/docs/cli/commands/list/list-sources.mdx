...
plat-ue2-dev       terraform   eks          github.com/cloudposse-terraform-components/aws-eks-cluster.git//src   1.450.0
plat-ue2-dev       terraform   vpc          github.com/cloudposse-terraform-components/aws-vpc.git//src   1.450.0
plat-ue2-dev       helmfile    nginx        github.com/cloudposse/helmfile-components//charts/nginx               1.0.0
plat-ue2-prod      terraform   eks          github.com/cloudposse-terraform-components/aws-eks-cluster.git//src   1.451.0
plat-ue2-prod      terraform   vpc          github.com/cloudposse-terraform-components/aws-vpc.git//src   1.451.0
```
...
terraform   eks          github.com/cloudposse-terraform-components/aws-eks-cluster.git//src   1.450.0
terraform   vpc          github.com/cloudposse-terraform-components/aws-vpc.git//src   1.450.0
...
plat-ue2-dev       terraform   vpc          github.com/cloudposse-terraform-components/aws-vpc.git//src   1.450.0
plat-ue2-prod      terraform   vpc          github.com/cloudposse-terraform-components/aws-vpc.git//src   1.451.0
plat-ue2-staging   terraform   vpc          github.com/cloudposse-terraform-components/aws-vpc.git//src   1.450.0
```
