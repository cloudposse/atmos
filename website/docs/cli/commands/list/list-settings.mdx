...
<Intro>
Display current Atmos configuration settings from atmos.yaml and environment variables. Helps debug configuration issues and verify which settings are active in your current environment.
</Intro>
