...
<Intro>
Display all Terraform or Helmfile variables for a component in a stack. Shows the exact variables that will be passed to the component after all inheritance and overrides are applied.
</Intro>
