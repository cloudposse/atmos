...
<DemoVideo id="list-vars" title="atmos list vars" showCaption={false} />

<CastPlayer title="atmos list vars --help" src="/casts/screengrabs/atmos-list-vars--help.cast" static chrome />
