...
<Intro>
List all values from stack configurations after inheritance and deep-merging. Shows the final resolved values that will be passed to components, helpful for debugging complex stack hierarchies.
</Intro>
