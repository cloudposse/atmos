...
<Intro>
Extract metadata for components and stacks from your Atmos configuration. Useful for building automation, generating documentation, or integrating with external tools that need to understand your infrastructure topology.
</Intro>
