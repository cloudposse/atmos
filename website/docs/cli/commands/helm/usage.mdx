...
<dl>
  ...
  <dd>Preview the changes an apply would make (server-side dry run).</dd>
  ...
  <dd>Install and list Helm CLI plugins (e.g. `helm-diff`, `helm-secrets`) used by helm and helmfile components.</dd>
</dl>
