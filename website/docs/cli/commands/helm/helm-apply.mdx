...
<dl>
  ...
  <dd>Comma-separated failure actions: `rollback`, `cleanup`, or both. The flag replaces the component policy for this invocation; `--on-failure=` clears inherited actions.</dd>
