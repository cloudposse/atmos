...
<dl>
  ...
  <dd>Uninstall a failed first install or roll a failed upgrade back. Enabling it promotes the default wait strategy to `watcher`. The deprecated alias is `--atomic`.</dd>
  ...
  <dd>Delete resources newly created by a failed upgrade.</dd>
