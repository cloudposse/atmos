...
<dl>
  ...
  <dd>Repeatable Helm-compatible value overrides for this render. They override stack-resolved values without changing configuration. See <a href="/cli/commands/helm/usage#runtime-value-overrides">runtime value overrides</a>.</dd>
