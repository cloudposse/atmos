...
```mermaid
graph LR
  aws_sso["aws-sso<br/>aws-sso"]:::provider:::default
  admin["admin<br/>aws/assume-role"]:::identity:::default
  developer["developer<br/>aws/assume-role"]:::identity
  aws_sso --> admin
  aws_sso --> developer
...
```mermaid
graph LR
  aws_sso["aws-sso<br/>aws-sso"]:::provider
  admin["admin<br/>aws/assume-role"]:::identity
  aws_sso --> admin
```
````
