...
<DemoVideo id="auth-exec" title="atmos auth exec" showCaption={false} />

<CastPlayer title="atmos auth exec --help" src="/casts/screengrabs/atmos-auth-exec--help.cast" static chrome />
