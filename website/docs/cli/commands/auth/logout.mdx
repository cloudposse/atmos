...
This removes all credentials for all configured identities and providers. Useful when switching AWS organizations or troubleshooting authentication issues.
