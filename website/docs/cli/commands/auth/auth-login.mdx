...
<dl>
  ...
  <dd>
    ...
    - Use the default identity if exactly one is configured
    - Show an interactive selector if no default identity is configured
    - Show an interactive selector if multiple default identities are configured
