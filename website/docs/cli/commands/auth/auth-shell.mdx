...
<DemoVideo id="auth-shell" title="atmos auth shell" showCaption={false} />

<CastPlayer title="atmos auth shell --help" src="/casts/screengrabs/atmos-auth-shell--help.cast" static chrome />
