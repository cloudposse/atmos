...
If you're using [Geodesic](https://github.com/cloudposse/geodesic) as your DevOps toolbox, you'll need to configure it to work with Atmos Auth.

See the [Configuring Geodesic with Atmos Auth](/cli/commands/auth/tutorials/configuring-geodesic-with-atmos-auth) guide for complete instructions on:
- Updating your Geodesic Dockerfile with required environment variables
- Configuring automatic authentication in your Makefile
- Setting up source profiles for assume-role utilities
