...
<CastPlayer title="atmos auth --help" src="/casts/screengrabs/atmos-auth--help.cast" static chrome />
...
<dl>
  ...
  <dd>
    ...
    <ul>
      <li>An identity name (e.g., <code>--identity admin</code> or <code>--identity=admin</code>)</li>
...
**Azure**
- **Interactive Browser**: `azure/interactive`
