...
<Intro>
Atmos Auth provides a unified authentication system for cloud providers, supporting identity chaining and credential management. Use this section to get started and to understand the architecture.
</Intro>
...
<dl>
  <dt>n/a</dt>
  <dd>No positional arguments. Use subcommands.</dd>
