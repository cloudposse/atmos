...
#### AWS Providers
- **AWS SSO**: `aws/iam-identity-center` - AWS IAM Identity Center (SSO) authentication
- **AWS SAML**: `aws/saml` - SAML-based authentication (Okta, Azure AD, etc.)

#### GitHub Providers
- **GitHub User**: [`github/user`](/cli/commands/auth/providers/github-user) - OAuth Device Flow for personal development
- **GitHub App**: [`github/app`](/cli/commands/auth/providers/github-app) - JWT-based authentication for automation and bots
- **GitHub OIDC**: [`github/oidc`](/cli/commands/auth/providers/github-oidc) - Keyless authentication for GitHub Actions
...
Atmos supports multiple GitHub authentication methods. See the dedicated provider documentation for detailed configuration:

#### GitHub User (Personal Development)

For local development with OAuth Device Flow - **works out of the box with zero configuration**. See [`github/user` provider documentation](/cli/commands/auth/providers/github-user).
...
auth:
  providers:
    github-user:
      kind: github/user
      # No client_id needed - uses official Atmos OAuth App by default
...
For bots and CI/CD with JWT signing. See [`github/app` provider documentation](/cli/commands/auth/providers/github-app).
...
For keyless authentication in GitHub Actions workflows. See [`github/oidc` provider documentation](/cli/commands/auth/providers/github-oidc).
