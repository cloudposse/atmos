...
3. **Writes configuration** to `~/.cache/atmos/aws/{provider}/provisioned-identities.yaml`
...
```
~/.cache/atmos/aws/{provider-name}/provisioned-identities.yaml
```
...
5. Writes to cache: `~/.cache/atmos/aws/{provider}/provisioned-identities.yaml`
...
2. Check cache exists: `ls ~/.cache/atmos/aws/{provider}/`
