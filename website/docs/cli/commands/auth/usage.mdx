...
- Default: `$XDG_DATA_HOME/atmos/keyring` (typically `~/.local/share/atmos/keyring` on Linux/Unix, `~/Library/Application Support/atmos/keyring` on macOS)
...
**macOS:**
- Credentials: `~/Library/Application Support/atmos/aws/<provider>/credentials`
- Config: `~/Library/Application Support/atmos/aws/<provider>/config`
