...
<DemoVideo id="auth-whoami" title="atmos auth whoami" showCaption={false} />

<CastPlayer title="atmos auth whoami --help" src="/casts/screengrabs/atmos-auth-whoami--help.cast" static chrome />
