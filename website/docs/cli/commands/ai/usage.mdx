...
It supports API providers (Anthropic, OpenAI, Gemini, GitHub Models, Grok, OpenRouter, DeepSeek, Z.AI, Ollama, AWS Bedrock, Azure OpenAI) and
CLI providers (Claude Code, OpenAI Codex, GitHub Copilot, opencode, Gemini CLI) that reuse your existing subscription.
...
<CastPlayer title="atmos ai --help" src="/casts/screengrabs/atmos-ai--help.cast" static chrome />
