...
vpc-migration         2025-10-30 14:30:00  2025-10-31 09:15:00  42        claude-sonnet-4-5-20250929   anthropic
```
...
<DocCardList items={[
  {type: 'link', href: '/cli/commands/ai/ask', label: 'atmos ai ask', description: 'Ask a one-time question without saving session'},
