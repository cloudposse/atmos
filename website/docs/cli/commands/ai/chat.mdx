...
|----------|---------------------|---------------|-------|
| Anthropic (Claude) | `ANTHROPIC_API_KEY` | `claude-3-5-sonnet-20241022` | Industry-leading reasoning |
...
| xAI (Grok) | `XAI_API_KEY` | `grok-beta` | Real-time data access |
| Ollama | `OLLAMA_API_KEY` | `llama3.3:70b` | Local models, no API key for local |
| AWS Bedrock | AWS credentials | `anthropic.claude-3-5-sonnet-20241022-v2:0` | Enterprise-grade, AWS security |
