...
<CollapsibleText type="tall">
  ...
  spec:
    ...
    sources:
      ...
      # See https://atmos.tools/vendoring/url-syntax for complete URL syntax documentation.
...
<dl>
  ...
  <dd>
    ...
    See [Vendor URL Syntax](/vendoring/url-syntax) for complete documentation on supported URL formats, authentication, and subdirectory syntax.
