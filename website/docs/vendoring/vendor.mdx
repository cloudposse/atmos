...
- [**Vendor Manifest**](/vendoring/vendor-manifest) Using `vendor.yaml` vendoring manifest file containing a list of all dependencies.
- [**Component Manifest**](/vendoring/component-manifest) Using `component.yaml` manifest file inside of a component directory. See below.
