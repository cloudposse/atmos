...
and [Remote State](/connections/remote-state) to get the outputs of a [Terraform/OpenTofu component](/components/components),
...
component, and then deep-merged using [Atmos Component Inheritance](/stacks/inheritance).
