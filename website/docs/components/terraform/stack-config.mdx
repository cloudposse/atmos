...
components:
  terraform:
    ...
    example:
      ...
      metadata:
        # Human-readable description of what this component does in this stack context.
...
<dl>
  <dt>`metadata.description` (optional)</dt>
  <dd>
  A human-readable description of what this component does in this stack context. Surfaces in `atmos describe component`, `atmos describe stacks`, and AI tooling. Unlike YAML comments, descriptions are schema-validated and inheritable via component metadata inheritance.
  ...
  **Example:**
  ...
  <dd>
  The `settings` block is a free-form map used to pass configuration information to [integrations](/integrations/github-actions) like Spacelift, Atlantis, or GitHub Actions.
