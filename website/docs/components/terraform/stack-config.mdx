...
<dl>
  ...
  <dd>
  A human-readable description of what this component does in this stack context. Surfaces in `atmos describe component`, `atmos describe stacks`, and AI tooling. Unlike YAML comments, descriptions are schema-validated and filterable.
