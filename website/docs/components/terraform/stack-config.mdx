...
<dl>
  ...
  **Example:**
  ...
  <dd>
  The `metadata` section extends functionality of the component. See [Common Component Attributes](/learn/stacks/define-components#metadata-attributes) for details on `type`, `enabled`, `locked`, and `component`.
...
- [Terraform Root Modules](/components/terraform) - Overview of Terraform components in Atmos
- [Terraform Backends](/components/terraform/backends) - Configure state storage
- [Terraform Providers](/components/terraform/providers) - Provider configuration and overrides
- [Common Component Attributes](/learn/stacks/define-components) - Attributes shared across all component types
