...
that `plan --ci` uploaded, generates a fresh plan, and compares them with the JSON plan-diff. This
guarantees that exactly what was reviewed gets applied — and nothing else.
