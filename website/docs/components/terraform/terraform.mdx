...
Explore a complete, working example that provisions a small AWS application stack — entirely offline, against a local AWS emulator.

<EmbedExample example="quick-start-advanced" />
