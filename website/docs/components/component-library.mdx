...
<Intro>
A component library is a collection of reusable "components" that are reused any number of times from within [Stacks](/stacks).  It's helpful to think of these "building blocks" as the essentials of infrastructure, like VPCs, clusters or databases. They should all be kept in a library.
</Intro>
