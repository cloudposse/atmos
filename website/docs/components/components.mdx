...
<Intro>
Components are the building blocks of your infrastructure. Each component is a Terraform root module, Helmfile, Packer template, Ansible playbook, or Rain CloudFormation template that does one thing well.
</Intro>
...
Atmos natively supports five kinds of components:
...
5. [Rain](/components/rain): These manage AWS CloudFormation stacks using Rain templates and Atmos stack configuration. By convention, we store Rain components in the `components/rain/` directory.
