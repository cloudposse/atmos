...
The most common use case for Atmos is implementing components using [Terraform "root modules"](https://developer.hashicorp.com/terraform/language/modules#the-root-module). Since Atmos is tool-agnostic, [custom commands](/custom-commands/custom-commands) can implement components for any tooling.
