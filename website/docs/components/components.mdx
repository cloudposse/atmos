...
<Intro>
Components are the building blocks of your infrastructure. Each component is a Terraform root module, Helmfile, Packer template, or Ansible playbook that does one thing well.
</Intro>
...
Atmos natively supports four kinds of components:
...
1. [Terraform](/components/terraform): These are stand-alone "root modules" that implement some piece of your infrastructure. For example, typical components might be an
   ...
   the [full library of SweetOps Terraform components on GitHub](https://github.com/cloudposse-terraform-components). By convention, we store
