...
<Intro>
Components are the building blocks of your infrastructure. They are opinionated, reusable units of infrastructure-as-code that solve specific problems: Terraform root modules, Helmfiles, Packer templates, Ansible playbooks, or Rain CloudFormation templates.
</Intro>
...
1. **Implementation** - The infrastructure code itself (a Terraform root module, Helmfile, Packer template, Ansible playbook, or Rain CloudFormation template)
...
Atmos natively supports five component types:
...
| **[Rain](/components/rain)** | CloudFormation templates | Manage AWS CloudFormation stacks |
...
│   └── webserver/
└── rain/                # Rain CloudFormation templates
    └── api/
```
...
- [Rain Components](/components/rain) — CloudFormation templates
