...
Beyond the native types, you can define **[custom component types](/components/custom)** to manage any tool—Kubernetes manifests, shell scripts, CDK apps, and more—with the same stack-based configuration.
