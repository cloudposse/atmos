...
id: custom
description: Bring any tool—Ansible, Kubernetes manifests, shell scripts, CDK, and more—under the same stack-based configuration used for Terraform, Helmfile, and Packer.
---
import Intro from '@site/src/components/Intro'
import EmbedExample from '@site/src/components/EmbedExample'

<Intro>
Beyond the native component types, Atmos lets you define **custom component types** so you can manage *any* tool—Kubernetes manifests, shell scripts, CDK apps, Ansible-as-a-script, and more—with the same stack-based configuration system used for Terraform, Helmfile, and Packer.
</Intro>
