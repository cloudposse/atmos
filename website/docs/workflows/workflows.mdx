...
<dl>
  ...
  <dd>Optional runtime override: `docker` or `podman`. When omitted, Atmos auto-detects the runtime.</dd>

  <dt>`container.runtime_auto_start`</dt>
  <dd>When supported, allow Atmos to attempt runtime recovery, such as starting a Podman machine.</dd>
