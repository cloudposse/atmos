...
You can use [Atmos Custom Commands](/custom-commands/custom-commands) in Atmos Workflows, and Atmos Workflows in [Atmos Custom Commands](/custom-commands/custom-commands)
...
the `vpc`, `eks/cluster` and `eks/alb-controller` [Atmos Components](/components/components) into
