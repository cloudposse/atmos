...
<Intro>
The **Strict Version Pinning** Design Pattern involves pinning every environment to specific component versions. While this traditional approach optimizes for reproducibility and rollback capabilities, it often creates divergence between environments and weakens the feedback loop during planning.
</Intro>

Strict Version Pinning is the most traditional approach to version management in infrastructure-as-code. Each environment explicitly declares which version of each component it uses, providing maximum control and reproducibility. However, this pattern requires careful management to avoid environment drift and must be applied with discipline to prevent state migration issues.
...
### 1. Place Version Pins in Stack Configuration

Each stack explicitly declares component versions:
  ...
  terraform:
    vpc:
      ...
      source:
        ...
        uri: "git::https://github.com/acme/terraform-components.git//modules/vpc?ref=v1.12.3"
```
</File>
...
components:
  terraform:
    vpc:
      ...
      source:
        # Development on latest version
        uri: "git::https://github.com/acme/terraform-components.git//modules/vpc?ref=v1.13.0"
```
</File>
...
components:
  terraform:
    vpc:
      ...
      source:
        # Staging on previous version
        uri: "git::https://github.com/acme/terraform-components.git//modules/vpc?ref=v1.12.4"
```
</File>
