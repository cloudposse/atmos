...
#### 5. [Continuous Version Deployment](/design-patterns/continuous-version-deployment) (Recommended Default)
**Trunk-based**: All environments deploy from the same component on the main branch, with automated testing and deployment pipelines. Decouples release from deploy using automation rather than VCS strategies. Promotes strong convergence, embraces trunk-based development, and allows easy preview of change impact across all dependent environments. This is the recommended default for most teams.
