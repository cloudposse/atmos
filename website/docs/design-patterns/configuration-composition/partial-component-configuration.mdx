...
This is not the same as Atmos [Component Inheritance](/howto/inheritance) where more than one Atmos components
...
import:
  ...
  # This is not the same as 'Atmos Component Inheritance' (https://atmos.tools/howto/inheritance)
