...
- `retry` - [Retry/backoff policy](/stacks/components/terraform/retry) for transient failures
- `provision` - Provisioning delivery settings (e.g. workdir, targets) for component types that support source/provision
