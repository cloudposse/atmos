...
:::tip
Refer to [Component Overrides](/stacks/overrides) for more information on the `overrides` section
:::
...
the [Layered Stack Configuration](/design-patterns/stack-organization/layered-stack-configuration) Atmos Design Pattern.
:::
...
- [Layered Stack Configuration](/design-patterns/stack-organization/layered-stack-configuration)
