...
The Atmos Version Manager tracks external artifacts and runtime dependencies. They work together with component source versioning patterns such as folder-based versioning, release channels, or strict component pinning. Version tracks provide a native catalog and lock file for versions that appear throughout configuration and CI:
