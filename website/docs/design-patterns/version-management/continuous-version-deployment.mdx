...
A core principle of this pattern is separating deployment (putting code in an environment) from release (making changes available to users). The industry has established that this decoupling increases speed and stability. As [LaunchDarkly emphasizes](https://launchdarkly.com/blog/why-decouple-deployments-from-releases/), "Decoupling deploy from release increases speed and stability when delivering software."
