...
components:
  terraform:
    vpc:
      ...
      settings:
        workspace_key_prefix: "dev/vpc"  # Keep stable across experiments
      vars:
...
components:
  terraform:
    ...
    database:
      ...
      settings:
        workspace_key_prefix: "dev/database"  # Stable across versions
      vars:
        engine: "postgres"
        engine_version: "15.4"
```
...
components:
  terraform:
    ...
    database:
      ...
      settings:
        workspace_key_prefix: "prod/database"  # Stable across versions
      vars:
        engine: "postgres"
...
components:
  terraform:
    critical-fix:
      ...
      settings:
        workspace_key_prefix: "prod/vpc"  # Keep stable during hotfix
      vars:
