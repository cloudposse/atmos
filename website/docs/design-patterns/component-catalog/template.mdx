---
title: Configuration Catalog Template
sidebar_position: 7
sidebar_label: With Templates
description: Configuration Catalog Template Atmos Design Pattern
---
...
Use the **Configuration Catalog Template** pattern when:
