...
- [Component Overrides](/design-patterns/configuration-composition/component-overrides) - Apply a mixin's settings to a subset of components via `overrides`
- [Component Retry](/stacks/components/terraform/retry) - A common use for a policy mixin: share retry conditions across components
