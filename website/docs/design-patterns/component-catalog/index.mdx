---
title: Component Catalog Patterns
sidebar_position: 5
sidebar_label: Component Catalog
description: Component Catalog Patterns in Atmos - Strategies for Organizing Reusable Component Configurations
...
#### 1. [Component Catalog with Mixins](/design-patterns/component-catalog/with-mixins)
...
#### 2. [Component Catalog Template](/design-patterns/component-catalog/template)
...
- [Component Catalog with Mixins](/design-patterns/component-catalog/with-mixins) - Combine catalogs with mixins for multi-dimensional inheritance
- [Component Catalog Template](/design-patterns/component-catalog/template) - Use templates for dynamic configuration generation

### Alternative Approaches
- [Component Inheritance](/design-patterns/component-inheritance) - Direct component inheritance without catalogs
- [Inline Component Configuration](/design-patterns/inline-component-configuration) - Configure components directly in stack files
- [Inline Component Customization](/design-patterns/inline-component-customization) - Customize components inline for simple cases
