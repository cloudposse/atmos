...
## Rollback Procedure
Change metadata.component back to "vpc/v1"
```
</File>
...
components:
  terraform:
    ...
    vpc:
      metadata:
        component: vpc/v3-preview  # Testing v3 preview
        inherits:
          - vpc/defaults
      settings:
        workspace_key_prefix: "dev/vpc"
...
components:
  terraform:
    ...
    vpc:
      metadata:
        component: vpc/v2  # Staging on stable v2
        inherits:
          - vpc/defaults
      settings:
...
components:
  terraform:
    ...
    vpc:
      metadata:
        component: vpc/v1  # Production on stable v1
        inherits:
          - vpc/defaults
      settings:
        workspace_key_prefix: "prod/vpc"
