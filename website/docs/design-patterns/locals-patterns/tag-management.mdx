...
Build tags incrementally for different resource types:
...
components:
  terraform:
    # Compute resources get required + compliance + compute tags
    eks:
      vars:
        tags:
          Namespace: "{{ .locals.namespace }}"
    ...
    # Data resources get required + compliance + data tags
    rds:
      vars:
        tags:
          Namespace: "{{ .locals.namespace }}"
