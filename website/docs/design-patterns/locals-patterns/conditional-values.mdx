...
Locals support all [Sprig functions](http://masterminds.github.io/sprig/). Common ones for conditionals:
...
- [Locals](/core-concepts/stacks/locals) - Core concept documentation
- [Sprig Functions](http://masterminds.github.io/sprig/) - Template function reference
- [Stack Templating](/templating/stacks) - Go template syntax in stacks
