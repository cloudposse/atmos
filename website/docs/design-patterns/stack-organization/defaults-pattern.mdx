...
- [Multi-Region Configuration](/design-patterns/stack-organization/multi-region-configuration) - Uses `_defaults.yaml` for stage-level defaults
- [Organizational Hierarchy Configuration](/design-patterns/stack-organization/organizational-hierarchy-configuration) - Full example of `_defaults.yaml` at every level
- [Component Catalog](/design-patterns/component-catalog) - Another pattern for organizing reusable configuration
