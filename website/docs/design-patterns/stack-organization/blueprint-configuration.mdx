...
If your blueprint defines defaults at the **component** level instead of the global level, you must override at the component level too. See [Variable Merge Order](/learn/merge-order) for why this matters.
...
- [Variable Merge Order](/learn/merge-order) — How Atmos resolves variable precedence
