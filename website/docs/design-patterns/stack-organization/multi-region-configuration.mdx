...
As your multi-region deployment grows, you may notice duplication across region stack files (e.g., the same `region`, `environment`, and `availability_zones` repeated). You can extract this into [Mixins](/howto/mixins) to keep your configuration DRY.
...
See [Mixins](/howto/mixins) for more details on this approach.
