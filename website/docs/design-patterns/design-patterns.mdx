...
- [Organizational Structure Configuration](/design-patterns/organizational-structure-configuration) - Structure for complex organizations
...
- [Component Inheritance](/design-patterns/component-inheritance) - Reuse component configuration across stacks
- [Abstract Component](/design-patterns/abstract-component) - Create base configurations that aren't deployed directly
- [Multiple Component Instances](/design-patterns/multiple-component-instances) - Deploy multiple instances of the same component
- [Partial Component Configuration](/design-patterns/partial-component-configuration) - Break large configurations into manageable parts
- [Layered Stack Configuration](/design-patterns/layered-stack-configuration) - Layer configurations for progressive customization
