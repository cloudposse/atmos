...
<Intro>
The **Inline Component Configuration** pattern is used when the [components](/components/components) in a [stack](/learn/stacks) are configured inline in the stack manifest without [importing](/stacks/imports) and reusing default/base configurations.
</Intro>
