...
<Intro>
**Inline Configuration** patterns define [components](/components/components) directly within [stack](/learn/stacks) manifests. This includes both fully inline configurations (no imports) and inline customizations of imported defaults.
</Intro>
...
- [Configuration Catalog with Mixins](/design-patterns/component-catalog/with-mixins)
