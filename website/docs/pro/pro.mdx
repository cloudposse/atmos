...
the same automation locally and in CI, handling auth, managing component dependencies, and keeping
configuration DRY across environments. It owns the execution layer — plan, apply, deploy.
