...
<dl>
  ...
  <dd>Workspace identifier for OIDC authentication. Not a secret. Maps to `pro.workspace_id`.</dd>
  ...
  <dd>Internal runtime token from OIDC exchange (advanced/internal). Do not set this manually; configure `pro.workspace_id` and GitHub Actions `id-token: write` instead.</dd>
</dl>
...
- [Pro Configuration](/cli/configuration/settings/pro) - Full configuration reference for `pro`
