...
<Terminal title="Performance heatmap output">
    ...
    ProcessStackConfig                           45   120.5ms    2.678ms    8.123ms        -
    LoadYAMLFile                                 32    65.3ms    2.041ms    5.432ms        -
    ProcessTemplates                             28    42.1ms    1.504ms    3.211ms        -
    ValidateComponentConfig                      18    18.7ms    1.039ms    2.145ms        -
    ```
</Terminal>
