...
You can also configure profiling through environment variables:

```shell
export ATMOS_PROFILER_ENABLED=true
export ATMOS_PROFILER_HOST=localhost
export ATMOS_PROFILER_PORT=6060
```

These environment variables will be overridden by CLI flags when specified.
