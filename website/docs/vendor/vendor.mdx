...
See [Source-Based Version Pinning](/design-patterns/version-management/source-based-versioning) for the design pattern and [atmos terraform source](/cli/commands/terraform/terraform-source) for CLI usage.
:::
