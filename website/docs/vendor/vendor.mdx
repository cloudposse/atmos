...
- [**Vendor Manifest**](/vendor/vendor-manifest) Using `vendor.yaml` vendoring manifest file containing a list of all dependencies.
- [**Component Manifest**](/vendor/vendor-manifest) Using `component.yaml` manifest file inside of a component directory. See below.
