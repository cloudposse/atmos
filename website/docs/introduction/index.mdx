...
<Intro>
Use Atmos to break your architecture into reusable [Components](/core-concepts/components/components) that you implement using [Terraform "root modules"](/core-concepts/components/terraform/terraform). Then, tie everything together using [Stack](/core-concepts/stacks/stacks) configurations defined in YAML.
</Intro>
