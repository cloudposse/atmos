...
So, it turns out they implementing CI/CD was not as straightforward as developers thought.
It's not as easy as deploying a container, that you can easily roll back. It's more like performing 
database migrations without transactions. It's a scary business. Controls are needed.
