...
Yes, refer to [Terraform Backends](/core-concepts/components/terraform-backends) for how to configure Terraform backends,
including [Terraform Cloud Settings](https://developer.hashicorp.com/terraform/cli/cloud/settings).

### Does Atmos work with CI/CD systems?

Yes, here's why it should work with any CI/CD system:
