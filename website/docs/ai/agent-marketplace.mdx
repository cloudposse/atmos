...
The Atmos Agent Marketplace is **not related to Anthropic's Claude marketplace**. This is Atmos's own system for installing and sharing specialized AI agents from GitHub repositories. These agents work within the Atmos ecosystem to provide domain-specific expertise for infrastructure management.
:::

:::caution Coming Soon
The Agent Marketplace infrastructure is implemented and ready to use. However, community-contributed agents are still in development. You can create and share your own agents today, but the official catalog of community agents is coming soon.
:::
