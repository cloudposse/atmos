...
Atmos supports 7 AI providers including cloud (Claude, GPT, Gemini, Grok), local (Ollama), and enterprise (AWS Bedrock, Azure OpenAI). See [AI Providers](/ai/providers) for complete configuration options.
:::
