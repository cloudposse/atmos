...
Use your locally installed Claude Code, OpenAI Codex, GitHub Copilot, opencode, or Gemini CLI binary. The CLI tool handles auth via its own subscription — no API key configuration needed.
