...
- **Interactive development with MCP** — `claude-code` or `codex-cli` (subscription, full MCP)
...
**MCP Pass-Through** — With CLI providers (`claude-code`, `codex-cli`), all configured MCP servers are
