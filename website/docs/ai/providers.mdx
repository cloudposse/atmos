...
providers:
  grok:
    model: "grok-4-latest"  # Recommended - auto-updates to latest stable
    # Alternative models:
    # model: "grok-4-0709"         # Fixed snapshot (July 9, 2025)
    # model: "grok-beta"           # Stable beta version
    # model: "grok-vision-beta"    # Vision capabilities
...
|-------|--------------|----------------|----------|----------|
| **Current Generation** | | | | |
| Grok 4 (Latest) | `grok-4-latest` | 2M tokens | Tool use, real-time search, auto-updates | Production use, always latest (recommended) |
| Grok 4 (Snapshot) | `grok-4-0709` | 2M tokens | Tool use, real-time search | Fixed version for consistency |
| Grok Beta | `grok-beta` | - | Stable beta features | Stable production use |
| Grok Vision Beta | `grok-vision-beta` | - | Vision capabilities | Image understanding tasks |
...
- `grok-4-latest` - Auto-updated to latest stable version (recommended for most users)
- `grok-4-0709` - Fixed snapshot from July 9, 2025 (for workflows requiring consistency)
- `grok-beta` - Stable beta version

**Model Selection Guide:**
- **For production (auto-update)**: `grok-4-latest` - always get latest features automatically
- **For consistency**: `grok-4-0709` - fixed snapshot, never changes
- **For stability**: `grok-beta` - proven stable beta version
- **For vision**: `grok-vision-beta` - image understanding capabilities
...
| Model | API Model ID | Notes |
|-------|--------------|-------|
| Grok 4 (Latest) | `grok-4-latest` | Auto-updated to latest stable ✅ **RECOMMENDED** |
| Grok 4 (Snapshot) | `grok-4-0709` | Fixed July 9, 2025 version |
| Grok Beta | `grok-beta` | Beta version, stable |
| Grok Vision Beta | `grok-vision-beta` | Vision capabilities |

:::tip Grok Naming Convention
- `<model>` or `<model>-latest` = Auto-updated to latest stable version
- `<model>-<date>` = Fixed snapshot, never changes (for consistency)
:::
...
providers:
  grok:
    model: "grok-4-latest"  # Use -latest suffix for auto-updates
    api_key_env: "XAI_API_KEY"
    base_url: "https://api.x.ai/v1"
```
