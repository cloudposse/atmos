...
|----------|---------------|----------------|----------|
| **Anthropic (Claude)** | `claude-3-5-sonnet-20241022` | API Key | Advanced reasoning, default choice |
...
| **AWS Bedrock** | `anthropic.claude-3-5-sonnet-20241022-v2:0` | AWS Credentials | Enterprise security, AWS integration |
