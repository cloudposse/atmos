...
description: Use Claude Code with Atmos via MCP server for development workflows
...
<dl>
  ...
  <dd>Built-in Atmos AI (many providers)</dd>
...
<dl>
  ...
  <dt>AI Provider</dt>
  <dd>**Claude Code Subagent:** Claude (Sonnet/Opus/Haiku). **Built-in Atmos AI:** many API providers (Claude, GPT, Gemini, GitHub Models, Grok, OpenRouter, DeepSeek, Z.AI, Ollama, Bedrock, Azure) plus CLI providers (Claude Code, Codex, Copilot, opencode, Gemini CLI).</dd>
