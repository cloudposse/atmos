...
While in an active chat session, you can manage sessions using built-in TUI features:
...
- **Select an AI provider** - Choose between Anthropic, OpenAI, Gemini, or Grok
