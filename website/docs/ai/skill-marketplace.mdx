...
:::info Marketplace Available
The Skill Marketplace is implemented with 21 official skills available for installation. You can also create and share your own skills. Community-contributed skills continue to grow.
:::
...
```bash
# Install all 21 official Atmos agent skills (recommended)
...
# Full GitHub path also works
atmos ai skill install github.com/cloudposse/atmos

# Full HTTPS URL
atmos ai skill install https://github.com/cloudposse/atmos.git

# SSH URL
atmos ai skill install git@github.com:cloudposse/atmos.git
```
</Terminal>
...
Downloading skills from https://github.com/cloudposse/atmos.git...
Discovered 21 skills in package:
  atmos-ansible, atmos-auth, atmos-components, atmos-config, ...

Install all 21 skills? [y/N] y

Installing atmos-ansible... done
Installing atmos-auth... done
Installing atmos-components... done
...
21 skills installed successfully.
...
+----------------------+-------------------------+---------+-----------------------------------------+-------------+
| atmos-terraform      | Terraform Expert        | 1.0.0   | github.com/cloudposse/atmos             | Enabled     |
| atmos-components     | Component Architect     | 1.0.0   | github.com/cloudposse/atmos             | Enabled     |
| atmos-stacks         | Atmos Stacks            | 1.0.0   | github.com/cloudposse/atmos             | Enabled     |
+----------------------+-------------------------+---------+-----------------------------------------+-------------+

Total: 3 skills (3 enabled)
```
...
atmos ai skill install yourorg/atmos-skill-terraform
...
## Marketplace Skills vs Custom Skills

Atmos has two types of skills:

| Feature | Marketplace Skills | Custom Skills |
|---------|-------------------|---------------|
| **Location** | `~/.atmos/skills/` | `atmos.yaml` config |
| **Installation** | `atmos ai skill install` | Add to config file |
| **Updates** | Git pull/reinstall | Edit config |
| **Sharing** | Share via GitHub | Team only (via config repo) |
| **Examples** | atmos-terraform, atmos-stacks, atmos-security | Company-specific |
| **Format** | Repository's `SKILL.md` | Inline in `atmos.yaml` |
| **Version Control** | Git tags/branches | Config file changes |

### When to Use Each

**Use Marketplace Skills:**
- Standard Atmos workflows
- Proven, tested official skills
- Specialized community tools
- Reusable across teams/organizations
- Version-controlled skills
- Examples: atmos-terraform, atmos-stacks, atmos-security, atmos-config, atmos-components
...
repository: https://github.com/yourorg/atmos-skill-state-migrator
---
...
### Multi-Cloud Security Validator

<File title="SKILL.md">
```markdown
---
name: multicloud-security
display_name: "Multi-Cloud Security Validator"
version: 1.5.0
...
# Skill: Multi-Cloud Security Validator
...
# Reinstall skills
atmos ai skill install user/skill1
atmos ai skill install user/skill2
```
</Terminal>

## Related Documentation

- [AI Skills](/ai/skills) - Skill system overview and configuration
...
- No prefix needed
- Use kebab-case
- Examples: `terraform-expert`, `cost-optimizer`, `policy-validator`
