...
<ActionCard title="MCP Command Reference">
    See flag details, transport modes, and HTTP endpoints for `atmos mcp start`.
    <div>
      <PrimaryCTA to="/cli/commands/mcp/start">Command Reference</PrimaryCTA>
    </div>
</ActionCard>

<ActionCard title="MCP Configuration">
    Configure AI tools and permissions for the MCP server in your `atmos.yaml`.
    <div>
