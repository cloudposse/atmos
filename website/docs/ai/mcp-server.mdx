...
claude mcp add --transport stdio atmos -- atmos mcp-server
...
# With specific scope
claude mcp add --scope project --transport stdio atmos -- atmos mcp-server
```
</Terminal>
...
```bash
# stdio transport (local server)
gemini mcp add atmos atmos mcp-server

# HTTP transport
gemini mcp add --transport http atmos http://localhost:8080

# With environment variables
gemini mcp add atmos -e ATMOS_BASE_PATH=/path/to/project atmos mcp-server
...
/mcp add atmos "atmos" "mcp-server"

# Add with environment variables
/mcp add atmos "atmos" "mcp-server" "--env=ATMOS_BASE_PATH=/path/to/project"
...
```bash
# stdio transport
grok mcp add atmos --transport stdio --command "atmos" --args "mcp-server"
