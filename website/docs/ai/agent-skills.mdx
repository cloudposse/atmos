...
<Intro>
Atmos ships a growing set of agent skills that give AI coding assistants deep, accurate knowledge of Atmos
...
<KeyPoints>
- Domain-specific skills covering every Atmos subsystem -- browse them all at [/ai/skills](/ai/skills)
