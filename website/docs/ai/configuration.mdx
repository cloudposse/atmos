...
:::info
LSP is an independent Atmos feature that can optionally be used by AI. For comprehensive LSP documentation, see [LSP Integration](/lsp/lsp).
:::
...
**Learn more:**
- [LSP Integration](/lsp/lsp) - Complete LSP documentation
- [LSP Configuration](/lsp/lsp#configuration-options) - Server setup
- [LSP Troubleshooting](/lsp/lsp#troubleshooting) - Common issues
