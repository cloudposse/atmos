...
settings:
  ai:
    ...
    default_skill: "general"              # Default AI skill (default: "general")
```
</File>

## AI Skills Configuration

Atmos AI includes specialized skills for different tasks. You can use built-in skills or create custom ones.

### Built-in Skills

Atmos ships with 5 built-in skills:
...
settings:
  ai:
    ...
    default_skill: "stack-analyzer"     # Use stack analyzer by default
