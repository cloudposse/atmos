...
2. **CI/CD Integrations**: [Native CI integration in GitHub Actions](/ci) is the recommended and actively developed path. Atmos also supports [Atlantis](/cli/configuration/integrations/atlantis); the [Spacelift integration](/deprecated/spacelift) is retained only for existing users.
