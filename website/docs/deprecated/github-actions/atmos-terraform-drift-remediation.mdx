---
title: Atmos Terraform Drift Remediation (Deprecated)
sidebar_position: 60
...
This action is used for drift remediation together with it's [companion action for drift detection](/deprecated/github-actions/atmos-terraform-drift-detection).
