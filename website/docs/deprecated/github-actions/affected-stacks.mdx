---
title: Affected Stacks (Deprecated)
sidebar_position: 30
...
:::warning Deprecated
This GitHub Action is deprecated. New projects should use [native CI integration](/ci), which runs `atmos describe affected --format=matrix` directly in your workflow. See the [matrix workflow example](/ci#advanced-multi-component-matrix) for the modern equivalent.
:::
