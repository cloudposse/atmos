...
:::warning Deprecated
This GitHub Action is deprecated. New projects should use [native CI integration](/ci), which runs `atmos describe affected --format=matrix` directly in your workflow. See the [matrix workflow example](/ci#multi-component-matrix) for the modern equivalent.
:::
