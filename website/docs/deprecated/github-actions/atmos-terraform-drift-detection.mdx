---
title: Atmos Terraform Drift Detection (Deprecated)
sidebar_position: 60
...
:::warning Deprecated
This GitHub Action is deprecated. New projects should use [native CI integration](/ci) — schedule a workflow that runs `atmos terraform plan` and surface drift via the native CI job summary.
:::
