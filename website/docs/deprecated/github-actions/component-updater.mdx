---
title: Component Updater (Deprecated)
sidebar_position: 40
sidebar_label: Component Updater
description: Legacy GitHub Action for updating vendored Atmos components
---
...
`cloudposse/github-action-atmos-component-updater` is deprecated.

Use Atmos’s native [vendored dependency management](/vendor/updates):
[`atmos vendor update`](/cli/commands/vendor/vendor-update) discovers and updates
vendored component versions, and
[`atmos vendor diff`](/cli/commands/vendor/vendor-diff) lets you review upstream changes first.

:::

<Intro>
Keep your infrastructure repositories current with the latest versions of [vendored components](/vendor/) using the [Atmos Component Updater GitHub Action](https://github.com/cloudposse/github-action-atmos-component-updater). This powerful action simplifies and accelerates the management of component updates across repositories by using pull requests, ensuring that updates are processed quickly, accurately, and without hassle.
</Intro>
...
3. List a Homepage URL of your choosing. This is required by GitHub, but you can use any URL. For example, use this legacy-action reference: `https://atmos.tools/deprecated/github-actions/component-updater/`
