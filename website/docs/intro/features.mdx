...
<FeatureGrid>
  ...
  <FeatureCard
    icon={<RiRefreshLine />}
    title="Native Component Updates"
    tagline="Stay current without hand-editing pins"
    description="The native Component Updater discovers eligible vendored-component releases, shows the upstream diff, updates version pins without rewriting YAML, and can pull the updated sources."
    benefits={[
