...
<FeatureGrid>
  ...
  <FeatureCard
    ...
    description="Run plan, apply, and drift detection directly in GitHub Actions with native CI integration. Affected stacks detection analyzes Git changes to identify exactly which components need deployment, saving CI time and reducing risk."
    benefits={[
