...
**Atmos is not a CI/CD replacement.** It complements your existing pipelines. We provide [GitHub Actions](/integrations/github-actions) and support for other [CI/CD integrations](/integrations/github-actions).
