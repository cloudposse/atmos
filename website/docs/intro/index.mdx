...
**Atmos is not a CI/CD replacement.** It complements your existing pipelines. We provide [native CI integration](/ci) for GitHub Actions and support for other [CI/CD integrations](/cli/configuration/integrations).
