...
It was designed to be used with CI/CD, so you can integrate with [GitHub Actions](https://atmos.tools/ci) or [Atlantis](https://atmos.tools/cli/configuration/integrations/atlantis).
