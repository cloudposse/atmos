...
It was designed to be used with CI/CD, so you can integrate with [GitHub Actions](https://atmos.tools/ci), [Spacelift](https://atmos.tools/cli/configuration/integrations/spacelift), or even [Atlantis](https://atmos.tools/cli/configuration/integrations/atlantis).
