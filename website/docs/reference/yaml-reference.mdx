...
When `key_delimiter` is enabled, you can use YAML quoting (single or double quotes) to prevent expansion. Quoted keys are always treated as literal key names:
