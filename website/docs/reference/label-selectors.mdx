...
:::tip Shell Quoting
Always wrap your selector expressions in quotes (e.g., `--selector="environment in (dev,staging)"`) to prevent shell parsing issues with commas, parentheses, and other special characters.
:::
...
atmos list components -l "environment=prod"
...
atmos describe stacks --selector="critical,environment=prod,!deprecated"
...
3. **Selectors evaluate the final merged labels** of each component
...
- [`atmos list values`](/cli/commands/list/values)
- [`atmos list vars`](/cli/commands/list/vars)
- [`atmos list settings`](/cli/commands/list/settings)
- [`atmos list metadata`](/cli/commands/list/metadata)
- [`atmos describe component`](/cli/commands/describe/component)
- [`atmos describe stacks`](/cli/commands/describe/stacks)
