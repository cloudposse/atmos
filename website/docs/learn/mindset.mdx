...
<Step>
    ...
    <CastPlayer title="Start your Project" src="/casts/screengrabs/demo-stacks/start-your-project.cast" command="# here's an example of what your folder structure will like..." static chrome />
    </details>
...
<Step>
    ...
    <details>
    <summary>See Example</summary>
    <CastPlayer title="Write your Components" src="/casts/screengrabs/demo-stacks/write-your-components.cast" command="# Then write your terraform root modules..." static chrome />
    </details>
...
<Step>
    ...
    <details>
    <summary>See Example</summary>
    <CastPlayer title="Define your Stacks" src="/casts/screengrabs/demo-stacks/define-your-stacks.cast" command="# Configure your stacks using YAML... easily import and inherit settings" static chrome />
    </details>
    <ActionCard>
...
<Step>
    ...
    Execute deployments with precision using Terraform's `plan` and `apply` commands, fully integrated with [native CI in GitHub Actions](/ci) for seamless deployment automation. Leverage [workflows](/workflows) to orchestrate more complicated deployments that involve multiple steps.
    ...
    <details>
    <summary>See Example</summary>
    <CastPlayer title="Atmos Stacks" src="/casts/screengrabs/demo-stacks/deploy.cast" command="# Deploy your stacks with the console UI or using GitHub Actions" static chrome />
    </details>
    <ActionCard>
