...
- **[Multiple Inheritance](/howto/inheritance)** - Mixins and hierarchical inheritance
- **[Stack Dependencies](/stacks/dependencies/components)** - Explicit component ordering
...
- **[Vendor Configuration](/vendor/)** - Pull components from remote sources
- **[Component Libraries](/vendor/component-manifest)** - Share components across teams
- **[Version Management](/vendor/vendor-config)** - Lock dependencies for consistency

<PrimaryCTA to="/vendor/">Learn Vendoring</PrimaryCTA>
</ActionCard>
...
- **[Component Library](https://github.com/cloudposse-terraform-components)** - Reusable Terraform components
