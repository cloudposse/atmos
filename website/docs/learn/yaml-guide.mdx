...
:::tip
Anchors are file-scoped—they only work within the same YAML file. For reuse across files, use Atmos [imports](/core-concepts/stacks/imports).
:::
...
If you need multiple configurations, use separate files and [imports](/core-concepts/stacks/imports).
