...
| Plugin | Skills |
|--------|--------|
| `atmos-cli` | atmos-terraform, atmos-helmfile, atmos-packer, atmos-ansible, atmos-workflows, atmos-custom-commands |
| `atmos-cli-configuration` | atmos-config, atmos-schemas, atmos-introspection, atmos-auth, atmos-stores, atmos-toolchain, atmos-devcontainer |
| `atmos-stacks` | atmos-stacks |
| `atmos-components` | atmos-components |
| `atmos-vendor` | atmos-vendoring |
| `atmos-validation` | atmos-validation |
| `atmos-integrations` | atmos-gitops |
| `atmos-functions` | atmos-templates |
...
```json
{
  ...
  "enabledPlugins": {
    "atmos-cli@cloudposse": true,
    "atmos-cli-configuration@cloudposse": true,
    "atmos-stacks@cloudposse": true,
    "atmos-components@cloudposse": true,
    "atmos-vendor@cloudposse": true,
    "atmos-validation@cloudposse": true,
    "atmos-integrations@cloudposse": true,
    "atmos-functions@cloudposse": true,
...
```bash
/plugin install atmos-cli@claude-plugin-directory
```
