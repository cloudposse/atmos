...
For configuring AI coding assistants (Claude Code, Cursor, Windsurf, GitHub Copilot, Gemini CLI, OpenAI Codex)
to use Atmos agent skills, see [Configure AI Assistants](/projects/setup-editor/ai-assistants). Browse every
available skill in the [Agent Skills Directory](/ai/skills).
