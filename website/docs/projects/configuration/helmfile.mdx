...
To automate the installation process, consider creating a [Custom Command](/custom-commands/custom-commands).
...
:::important
At this time, these settings cannot be overridden in the [Stack](/learn/stacks/#schema) configuration.
:::
