...
title: "atmos describe affected now detects providers, generate, backend changes, and more"
authors:
  - osterman
tags:
  - bugfix
...
The [`atmos describe affected`](/cli/commands/describe/affected) command now compares **every** provisioned component section between refs — including `providers`, `required_providers` (provider versions), `generate`, `backend`, `auth`, and `command`. Previously, changes to these sections were silently missed.
