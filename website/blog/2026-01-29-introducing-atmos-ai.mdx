...
authors: [atmos]
tags: [ai, productivity, infrastructure]
---
...
```bash
atmos ai chat --skill security-auditor

You: Audit our production VPC security

AI: [Switches to Security Auditor skill]
...
```bash
atmos ai chat --skill config-validator
...
Install community-created specialized skills following the [Agent Skills open standard](https://agentskills.io):

```bash
# Install custom skill
atmos ai skill install github.com/cloudposse/skill-cost-analyzer

# Use it
atmos ai chat --skill cost-analyzer
...
- [AI Skills](/ai/skills) - Built-in skills following the Agent Skills open standard
