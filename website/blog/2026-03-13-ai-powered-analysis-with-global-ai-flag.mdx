...
Add [`--ai`](/cli/global-flags#ai-powered-analysis-examples) to any Atmos command and get instant AI-powered analysis of the output. Successful plans get
...
Pair `--ai` with [`--skill`](/cli/global-flags#core-global-flags) for domain-specific expertise. Combine multiple skills with commas or repeated flags:
