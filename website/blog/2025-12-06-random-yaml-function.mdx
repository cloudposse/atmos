...
Need to generate random port numbers, worker IDs, or other numeric values in your Atmos configurations? The new [`!random`](/functions/yaml/random) YAML function makes it easy.
