...
The [`!terraform.output`](/functions/yaml/terraform.output) YAML function now works seamlessly with Terraform Cloud and Terraform Enterprise backends, enabling cross-component dependencies without switching backend types.
