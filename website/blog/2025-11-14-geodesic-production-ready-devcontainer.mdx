...
With [Atmos's native devcontainer support](/blog/native-devcontainer-support), using Geodesic is incredibly simple:
...
Follow our [step-by-step Geodesic tutorial](/tutorials/geodesic) for detailed setup instructions, or use this quick start:
...
Check out the [native devcontainer support announcement](/blog/native-devcontainer-support) to learn more about Atmos's devcontainer capabilities, or dive into the [examples](https://github.com/cloudposse/atmos/tree/main/examples/devcontainer) to get started immediately.

## Resources

- [Setting Up Geodesic Tutorial](/tutorials/geodesic) - Step-by-step guide to configuring Geodesic with Atmos
- [Geodesic GitHub Repository](https://github.com/cloudposse/geodesic)
- [Atmos Native Devcontainer Support](/blog/native-devcontainer-support)
