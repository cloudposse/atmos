...
When you authenticate with an identity, any integrations with `auto_provision: true` that reference that identity are triggered automatically:
...
✓ ECR login: 123456789012.dkr.ecr.us-west-2.amazonaws.com (expires in 12h)
```
