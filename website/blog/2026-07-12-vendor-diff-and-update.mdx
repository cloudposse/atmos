...
review the exact upstream diff, updates the pinned version in your YAML while preserving comments,
anchors, templates, and formatting, and can pull the updated sources in one command.
