...
When you run [`atmos terraform generate required-providers`](/cli/commands/terraform/generate), Atmos creates a `terraform_override.tf.json` file in your component directory:
...
For usage and configuration, see [Provider Generation](/components/terraform/providers).
