...
When you exit the shell, credentials are automatically removed. It's a simple pattern that helps prevent credential leakage and reduces the risk of running commands against the wrong environment.
