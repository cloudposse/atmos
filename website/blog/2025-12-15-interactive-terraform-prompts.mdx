...
All 22 terraform commands that require component and stack arguments now support interactive selection when these values are missing. This brings the [interactive prompts feature](/blog/interactive-flag-prompts) to the most frequently used Atmos commands.
