...
## What Changed
- Routed Terraform [`--all`](/cli/commands/terraform/plan#plan-all-components), [`--components`](/cli/commands/terraform/plan#plan-specific-components), and [`--query`](/cli/commands/terraform/plan#plan-components-by-query) through the scheduler-backed Terraform adapter.
