...
Previously, teams worked around this with third-party services like [autofix.ci](https://autofix.ci/).
Now this capability is built directly into Atmos.
...
- Maximum 200 changed files per commit
