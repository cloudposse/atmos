...
| Flag                           | Description                                                                |
|--------------------------------|----------------------------------------------------------------------------|
| [`--skip-init`](/cli/commands/terraform/usage#flags)                  | Skip terraform init before running command                                 |
...
| [`--skip-planfile`](/cli/commands/terraform/usage#flags)              | Skip writing the plan to a planfile                                        |
