...
Atmos now supports the [`!unset`](/functions/yaml/unset) YAML function, which **removes a key entirely** from a stack configuration during inheritance and merging. It's the clean way to drop a value that a parent stack or import defined, without resorting to workarounds.
