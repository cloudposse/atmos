...
Quickly identify which components and stacks are affected by your changes with the new [`atmos list affected`](/cli/commands/list/affected) command.

<!--truncate-->

## What Changed

We've added a new `atmos list affected` command that provides a human-readable table view of affected components and stacks between Git commits. This complements the existing [`atmos describe affected`](/cli/commands/describe/affected) command, which outputs detailed JSON/YAML for automation.
