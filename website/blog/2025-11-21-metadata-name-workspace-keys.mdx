...
The workaround was manually setting `backend.s3.workspace_key_prefix` on every component. This was error-prone and tedious. Plus, [metadata wasn't inherited](/changelog/metadata-inheritance) for legacy reasons, so you couldn't define it once in a base component.
