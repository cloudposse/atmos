...
optional long-running named container you operate with [`atmos container up/ps/logs/exec/restart/stop/rm/down`](/cli/commands/container/usage).
...
Compose shapes you already know. Inheritance ([`metadata.inherits`](/stacks/components/component-metadata#inherits)), abstract base components, catalogs,
