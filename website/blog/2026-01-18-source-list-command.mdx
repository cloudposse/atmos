...
plat-dev     vpc          github.com/cloudposse-terraform-components/aws-vpc.git//src   1.450.0
plat-prod    vpc          github.com/cloudposse-terraform-components/aws-vpc.git//src   1.450.0
```
...
eks          github.com/cloudposse-terraform-components/aws-eks-cluster.git//src   1.450.0
rds          github.com/cloudposse-terraform-components/aws-rds.git//src   1.449.0
vpc          github.com/cloudposse-terraform-components/aws-vpc.git//src   1.450.0
```
...
vpc/production   vpc       github.com/cloudposse-terraform-components/aws-vpc.git//src   1.450.0
vpc/staging      vpc       github.com/cloudposse-terraform-components/aws-vpc.git//src   1.450.0
```
...
plat-dev     terraform   vpc          github.com/cloudposse-terraform-components/aws-vpc.git//src   1.450.0
plat-prod    terraform   vpc          github.com/cloudposse-terraform-components/aws-vpc.git//src   1.450.0
```
