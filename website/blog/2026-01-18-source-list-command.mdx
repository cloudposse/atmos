...
plat-dev     vpc          github.com/cloudposse-terraform-components/aws-vpc.git//src   v1.539.0
plat-prod    vpc          github.com/cloudposse-terraform-components/aws-vpc.git//src   v1.539.0
```
...
eks          github.com/cloudposse-terraform-components/aws-eks-cluster.git//src   v1.539.0
rds          github.com/cloudposse-terraform-components/aws-rds.git//src   v1.535.9
vpc          github.com/cloudposse-terraform-components/aws-vpc.git//src   v1.539.0
```
...
vpc/production   vpc       github.com/cloudposse-terraform-components/aws-vpc.git//src   v1.539.0
vpc/staging      vpc       github.com/cloudposse-terraform-components/aws-vpc.git//src   v1.539.0
```
...
plat-dev     terraform   vpc          github.com/cloudposse-terraform-components/aws-vpc.git//src   v1.539.0
plat-prod    terraform   vpc          github.com/cloudposse-terraform-components/aws-vpc.git//src   v1.539.0
```
...
- [`atmos terraform source list`](/cli/commands/terraform/source/list) - List Terraform sources
- [`atmos helmfile source list`](/cli/commands/helmfile/source/list) - List Helmfile sources
- [`atmos packer source list`](/cli/commands/packer/source/list) - List Packer sources
