...
The [`atmos list components`](/cli/commands/list/components) command now correctly shows unique component definitions, supports stack filtering, and uses a new dedicated configuration namespace.
...
**[`atmos list instances`](/cli/commands/list/list-instances)** continues to show all instances:
```
