...
We've updated the [Custom Commands documentation](/core-concepts/custom-commands/custom-commands) with:
...
We've also added a comprehensive [Safe Argument Parsing PRD](/docs/prd/safe-argument-parsing.md) documenting the issue, fix, and best practices.
