...
|---------|---------|-------------|
| Devcontainers | [`atmos devcontainer`](/cli/commands/devcontainer) | Development container lifecycle management |
| Toolchain | [`atmos toolchain`](/cli/commands/toolchain/usage) | Tool version management and installation |
| Backend Provisioning | [`atmos terraform backend`](/cli/commands/terraform/terraform-backend) | Terraform state backend management |
| Workdir Management | [`atmos terraform workdir`](/cli/commands/terraform/workdir) | Component working directory management |
| Affected Components | [`atmos list affected`](/cli/commands/list/affected) | Identify changes for targeted CI/CD |
