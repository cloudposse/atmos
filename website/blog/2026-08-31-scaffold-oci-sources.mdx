...
<!--truncate-->
## The Problem
Both [`atmos scaffold generate`](/cli/commands/scaffold/generate) and [`atmos init`](/cli/commands/init) could already pull templates from git, HTTPS, and
...
already uses for [`atmos vendor pull`](/cli/commands/vendor/pull) and just-in-time component provisioning. Authentication
...
applied to git sources. [`--update`](/cli/commands/scaffold/generate)'s three-way merge, [`--git`](/cli/commands/scaffold/generate)/[`--no-git`](/cli/commands/scaffold/generate), and `--base-ref` all
