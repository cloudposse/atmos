...
See the [Custom Component Types documentation](/cli/configuration/commands/component#custom-component-types) for complete details.

For usage and configuration, see [Using Custom Component Types](/components/custom).
