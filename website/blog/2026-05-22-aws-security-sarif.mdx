...
The `atmos aws security analyze` command is the native Atmos command for turning AWS security findings into infrastructure-aware remediation guidance. It ingests findings from AWS Security Hub, Config, Inspector, GuardDuty, Macie, and Access Analyzer, then uses Atmos component tags and mapping heuristics to connect affected resources back to the stacks and components that manage them.
