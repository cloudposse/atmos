...
Atmos now includes a `source list` command to display components with source configuration. Both [`--stack`](/cli/commands/terraform/source/list#flags) and `[component]` arguments are optional, allowing flexible filtering across your infrastructure.
