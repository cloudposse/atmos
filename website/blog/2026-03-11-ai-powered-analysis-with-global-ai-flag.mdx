...
Pair `--ai` with `--skill` to give the AI deep knowledge of specific Atmos subsystems. The skills' system
prompts are prepended to the analysis, resulting in more accurate and actionable insights.
...
Combine multiple skills for cross-domain expertise. Use comma-separated values or repeated flags:

```bash
# Comma-separated skills
atmos terraform plan vpc -s ue1-prod --ai --skill atmos-terraform,atmos-stacks

# Repeated --skill flags
...
<Terminal title="atmos terraform plan --ai --skill terraform (not found)">
```console
...
<Terminal title="atmos terraform plan --ai --skill atmos-terraform">
```console
