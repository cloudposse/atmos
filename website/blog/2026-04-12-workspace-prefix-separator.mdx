...
4. Run [`atmos terraform plan`](/cli/commands/terraform/plan) to verify no unexpected changes

:::

For usage and configuration, see [Workspaces](/components/terraform/workspaces).
