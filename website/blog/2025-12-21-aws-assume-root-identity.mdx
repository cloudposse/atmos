...
Root access in AWS member accounts has been a standing liability. The credentials exist in every account whether anyone uses them or not, and proving who used them last means checking each account separately. AWS addressed this with Centralized Root Access, and Atmos now reaches it through the `aws/assume-root` identity kind.
...
Tell us how assume-root works for your organization, and open an issue at https://github.com/cloudposse/atmos/issues.
