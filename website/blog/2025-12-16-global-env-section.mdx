...
The global env section is visible via [`atmos describe config`](/cli/commands/describe/config):
...
For usage and configuration, see [Environment Variables](/cli/configuration/env).
