...
executed thousands of times per [`atmos describe component`](/cli/commands/describe/component), [`atmos terraform plan`](/cli/commands/terraform/plan), and every
...
For usage and configuration, see [Inherit Configurations in Atmos Stacks](/howto/inheritance).
