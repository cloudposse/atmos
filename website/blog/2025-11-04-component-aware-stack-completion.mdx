...
When running Terraform commands like [`atmos terraform plan <component> --stack <TAB>`](/cli/commands/terraform/plan), the shell completion now intelligently filters stack suggestions to only show stacks that contain the specified component.
