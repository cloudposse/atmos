...
- [`metadata.inherits`](/stacks/components/component-metadata#inherits) - defines the inheritance relationship itself
- `metadata.type` - component type is per-component (e.g., `abstract` shouldn't propagate to derived components)
...
See the [inheritance documentation](/howto/inheritance) for details.
