...
- Not knowing about features like [`!store`](/functions/yaml/store), [`!terraform.output`](/functions/yaml/terraform.output), or multi-provider authentication
...
See the [AI Agent Skills documentation](/cli/commands/ai/skill) for the full skill reference and [Configure AI Assistants](/projects/setup-editor/ai-assistants) for tool-specific setup instructions.
