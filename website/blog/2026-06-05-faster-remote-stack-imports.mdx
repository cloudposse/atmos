...
…Atmos previously cloned the **entire repository once for every import** and threw each clone away. A spoke with 80 imports of the hub meant ~80 clones per run — and because commands like [`atmos describe affected`](/cli/commands/describe/affected) process stacks twice (current vs. base ref), that doubled again.
