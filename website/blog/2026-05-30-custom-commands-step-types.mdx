...
For the complete step types reference, see the [Custom Commands documentation](/cli/configuration/commands#extended-step-types) and [Workflows documentation](/workflows/steps/type).
