...
Annotations and the summary need no special permissions. `ci.results` uploads to Code Scanning, which needs `security-events: write` (and GitHub Advanced Security on private repos).
