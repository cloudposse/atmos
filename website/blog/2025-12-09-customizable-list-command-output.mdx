...
Running [`atmos list instances`](/cli/commands/list/list-instances) gives you raw data, but not the specific view you need to answer these questions quickly.
...
- ✅ [`atmos list components`](/cli/commands/list/components) - Components in your project
- ✅ [`atmos list stacks`](/cli/commands/list/stacks) - Stack configurations
- ✅ [`atmos list workflows`](/cli/commands/list/list-workflows) - Available workflows
- ✅ [`atmos list vendor`](/cli/commands/list/list-vendor) - Vendored dependencies
