...
When using [`atmos terraform plan -s stack-name`](/cli/commands/terraform/plan) without specifying a component, the interactive
...
For usage and configuration, see [atmos terraform](/cli/commands/terraform/usage).
