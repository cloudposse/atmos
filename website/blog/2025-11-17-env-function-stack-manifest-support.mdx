...
The [`!env`](/functions/yaml/env) YAML function now supports reading environment variables from `env` sections defined in your stack manifests and Atmos configuration. This makes it easy to set defaults for environment variables and reference values from your infrastructure configuration.
...
- [Stack Manifest Templating](/templates)
...
For questions or feedback, join the discussion in our [GitHub Discussions](https://github.com/orgs/cloudposse/discussions).
