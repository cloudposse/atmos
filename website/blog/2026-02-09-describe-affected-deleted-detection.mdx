...
title: 'Describe Affected Now Detects Deleted Components and Stacks'
authors:
  - aknysh
tags:
  - feature
...
Previously, [`atmos describe affected`](/cli/commands/describe/affected) only detected components that were **modified** between two Git commits.
...
The [`atmos list affected`](/cli/commands/list/affected) command also supports deleted detection, providing a human-readable table view:
