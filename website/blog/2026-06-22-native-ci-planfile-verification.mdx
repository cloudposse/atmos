...
components:
  terraform:
    planfiles:
      ...
      on_missing: fail    # no stored plan was found (defaults to tracking `verify`)
      priority: [github]
      stores:
        github:
