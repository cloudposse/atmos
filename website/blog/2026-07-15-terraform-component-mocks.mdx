...
Atmos now supports **[component mocks](/stacks/components/mocks)**: literal, component-owned Terraform outputs that you enable explicitly with `--use-mocks`.
...
For usage and configuration, see [component output mocks](/stacks/components/mocks).
