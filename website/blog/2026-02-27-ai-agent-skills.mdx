...
Keep the downloaded directory structure intact -- don't flatten it. The `AGENTS.md` router references skills using relative paths that depend on the nested layout.
