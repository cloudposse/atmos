...
- **CLI**: `atmos-terraform`, `atmos-helmfile`, `atmos-packer`, `atmos-ansible`, `atmos-workflows`, `atmos-custom-commands`
- **CLI Configuration**: `atmos-config`, `atmos-schemas`, `atmos-introspection`, `atmos-auth`, `atmos-stores`, `atmos-toolchain`, `atmos-devcontainer`
- **Stacks**: `atmos-stacks`
- **Components**: `atmos-components`
- **Vendor**: `atmos-vendoring`
- **Validation**: `atmos-validation`
- **Integrations**: `atmos-gitops`
- **Functions**: `atmos-templates`
...
# Install the plugins you need (9 available, install what's relevant)
/plugin install atmos-cli@cloudposse
/plugin install atmos-cli-configuration@cloudposse
/plugin install atmos-stacks@cloudposse
/plugin install atmos-components@cloudposse
/plugin install atmos-vendor@cloudposse
/plugin install atmos-validation@cloudposse
/plugin install atmos-integrations@cloudposse
/plugin install atmos-functions@cloudposse
...
See the [AI Agent Skills documentation](/integrations/ai/agent-skills) for the full skill reference and [Configure AI Assistants](/projects/setup-editor/ai-assistants) for tool-specific setup instructions.
