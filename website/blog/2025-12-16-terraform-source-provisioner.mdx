...
The combined workflow operates in two steps:

```shell
# Step 1: Vendor the component (downloads to components/terraform/vpc/)
atmos terraform source pull vpc --stack dev

# Step 2: Run terraform (workdir provisioner copies to .workdir/terraform/dev-vpc/)
atmos terraform plan vpc -s dev
```

When you run `terraform plan`, the workdir provisioner automatically:
1. Creates `.workdir/terraform/dev-vpc/`
2. Copies the vendored component files
3. Runs Terraform in the isolated directory
