...
The `source` provisioner works seamlessly with the [workdir provisioner](/blog/component-workdir-isolation) for concurrent Terraform operations. When both are enabled, you get the best of both worlds:
