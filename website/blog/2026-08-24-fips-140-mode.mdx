...
only cryptography that's been validated against [FIPS](/cli/commands/version/usage) 140, the U.S. government's standard for
...
binary itself. Declarative secrets management ([`atmos secret keygen`](/cli/commands/secret/keygen) and the age-based SOPS
