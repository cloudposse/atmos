...
- **New [`atmos ansible playbook`](/cli/commands/ansible/playbook) command** executes Ansible playbooks with stack-based configuration
- **New [`atmos ansible version`](/cli/commands/ansible/version) command** displays Ansible version information
