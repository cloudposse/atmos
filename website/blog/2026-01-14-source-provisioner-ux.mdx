...
2. **Interactive delete confirmation**: Running [`atmos terraform source delete`](/cli/commands/terraform/source/delete) without `--force` now prompts for confirmation instead of erroring
