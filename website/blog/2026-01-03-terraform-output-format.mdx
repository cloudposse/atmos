...
The [`atmos terraform output`](/cli/commands/terraform/output) command now supports a [`--format`](/cli/commands/terraform/output#flags) flag, making it easy to export Terraform outputs in various formats for use in CI/CD workflows, scripts, and configuration files.
...
Use [`--flatten`](/cli/commands/terraform/output#flags) to expand nested maps and arrays into individual key/value pairs:
