...
To read an individual label in a template, use `{{ .metadata.labels.runner }}`. See the [template context reference](/templates) for accessing component configuration.
