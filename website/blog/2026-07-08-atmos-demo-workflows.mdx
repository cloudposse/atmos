...
Once the deploy finishes, the next question is usually what values it produced:
...
Once you know which stack you care about, drill into a single component's configuration:

<CastPlayer src="/casts/demo/fixtures/basic/describe-component.cast" title="atmos describe component" chrome controls scrubber />

Or zoom back out to see the deep-merged configuration for every stack at once:
