...
<Terminal title="atmos describe locals vpc -s prod-ue2 --provenance">
```yaml
...
For complete documentation, see [Locals in Stack Configuration](/core-concepts/stacks/locals).

## Related Features

- [Stack Templates](/core-concepts/stacks/templates) - Go templating in stack manifests
- [Configuration Provenance](/cli/commands/describe/component) - Track where values come from
- [YAML Functions](/core-concepts/stacks/yaml-functions) - Dynamic configuration with `!terraform.output`, `!env`, etc.
