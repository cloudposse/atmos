...
In Q1 2026, we're adding **automatic dependency detection** from YAML functions. Dependencies will be inferred automatically from [`!terraform.output`](/functions/yaml/terraform.output) and [`!terraform.state`](/functions/yaml/terraform.state) usage—no manual configuration needed.
