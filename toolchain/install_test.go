...
func TestRunInstallWithNoArgs(t *testing.T) {
	...
	err = RunInstall(nil, false, false)
	assert.NoError(t, err)
}
...
func TestRunInstall_WithValidToolSpec(t *testing.T) {
	...
	err = RunInstall([]string{"terraform@1.11.4"}, false, false)
	assert.NoError(t, err)
...
func TestRunInstall_WithSetAsDefault(t *testing.T) {
	...
	err = RunInstall([]string{"terraform@1.11.4"}, true, false)
	assert.NoError(t, err)
...
func TestRunInstall_WithInvalidToolSpec(t *testing.T) {
	...
	err = RunInstall([]string{"nonexistent-tool"}, false, false)
	assert.Error(t, err)
}
...
func TestRunInstall_WithCanonicalFormat(t *testing.T) {
	...
	err = RunInstall([]string{"hashicorp/terraform@1.11.4"}, false, false)
	assert.NoError(t, err)
...
func TestRunInstall_WithLatestKeyword(t *testing.T) {
	...
	err = RunInstall([]string{"terraform@latest"}, false, false)
	assert.NoError(t, err)
