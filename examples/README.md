...
6.  ├── demo-helmfile/            # Deploy NGINX on a local lightweight Kubernetes cluster (k3s, via the native emulator) using Helm.
...
11. ├── container-sandbox/        # Run workflow shell steps inside a shared container sandbox.
