...
- [ ] **IN PROGRESS:** Implement option (d+) — split entry points plus
      import-following scanner.
- [ ] Restore workflow_utils stack-loading path.
- [ ] Scenario coverage for Issue #2293 via `describe stacks` /
      `describe affected`.
