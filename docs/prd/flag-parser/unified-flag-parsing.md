...
**See also**:
- `docs/prd/flag-parser/global-flags-pattern.md` - Handling global/persistent flags via struct embedding
- `docs/prd/flag-parser/global-flags-examples.md` - Real examples with `--logs-level` and `--identity`
- `docs/prd/flag-parser/default-values-pattern.md` - Default value handling across all layers
...
- Atmos existing PRDs:
  ...
  - `docs/prd/flag-parser/` - Strongly-typed interpreter system (NEW)
