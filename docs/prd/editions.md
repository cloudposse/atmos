...
The journal ships with 10 entries reaching back to February 2025 (source of truth:
...
default in `describe component`, and the component filter defaulting to `schema`.
