---
name: general
description: General-purpose assistant for all Atmos operations. Use for infrastructure management, configuration, troubleshooting, and DevOps workflows with Atmos CLI.
license: Apache-2.0
metadata:
  author: cloudposse
  version: "1.0.0"
