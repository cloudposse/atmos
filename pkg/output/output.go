// Package output provides functionality to format and export component outputs
// (e.g. Terraform outputs, CloudFormation stack Outputs) in various formats
// suitable for CI/CD workflows, scripts, and configuration files.
package output
