...
func TestStackProcessor(t *testing.T) {
	...
	assert.Equal(t, "catalog/helmfile/infra-server-override", infraInfraServerOverrideComponentDeps[0])
	assert.Equal(t, "globals/globals", infraInfraServerOverrideComponentDeps[1])
	assert.Equal(t, "globals/tenant1-globals", infraInfraServerOverrideComponentDeps[2])
	assert.Equal(t, "globals/ue2-globals", infraInfraServerOverrideComponentDeps[3])
	assert.Equal(t, "tenant1/ue2/dev", infraInfraServerOverrideComponentDeps[4])
