...
const (
	...
	BeforeTerraformGeneratePlanfile HookEvent = "before.terraform.generate.planfile"
	AfterTerraformGeneratePlanfile  HookEvent = "after.terraform.generate.planfile"
)
