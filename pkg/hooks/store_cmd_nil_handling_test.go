...
func TestStoreCommand_IntermittentFailureHandling(t *testing.T) {
	...
	for i := 0; i < iterations; i++ {
		...
		t.Run(t.Name(), func(t *testing.T) {
			...
			mockGetter := func(cfg *schema.AtmosConfiguration, stack, component, output string, skipCache bool, authContext *schema.AuthContext, authManager any) (any, bool, error) {
