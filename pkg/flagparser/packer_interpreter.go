...
// PackerInterpreter provides strongly-typed access to parsed Packer command flags.
//
// Example usage:
//
...
func ParsePackerFlags(cmd *cobra.Command, v *viper.Viper, positionalArgs, passThroughArgs []string) PackerInterpreter {
	defer perf.Track(nil, "flagparser.ParsePackerFlags")()

	return PackerInterpreter{
