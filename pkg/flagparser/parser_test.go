...
func TestParsedConfig_ToTerraformInterpreter(t *testing.T) {
	tests := []struct {
		name           string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			interpreter := tt.parsedConfig.ToTerraformInterpreter()
...
func TestParsedConfig_ToTerraformInterpreter_Identity(t *testing.T) {
	tests := []struct {
		name                     string
		atmosFlags               map[string]interface{}
...
func TestParsedConfig_ToTerraformInterpreter_TypeSafety(t *testing.T) {
	...
	t.Run("weak_typing_old_way", func(t *testing.T) {
		...
		uploadStatus := parsedConfig.AtmosFlags["upload-status"].(bool)
		logsLevel := parsedConfig.AtmosFlags["logs-level"].(string)
