...
func (s Severity) String() string {
	defer perf.Track(nil, "sarif.Severity.String")()
...
func (f *Findings) Count() int {
	defer perf.Track(nil, "sarif.Findings.Count")()
...
func (f *Findings) CountsBySeverity() map[string]int {
	defer perf.Track(nil, "sarif.Findings.CountsBySeverity")()
...
func (f *Findings) HighestSeverity() Severity {
	defer perf.Track(nil, "sarif.Findings.HighestSeverity")()
...
func (f *Findings) SortedBySeverity() []Finding {
	defer perf.Track(nil, "sarif.Findings.SortedBySeverity")()
...
func Parse(data []byte) (*Findings, error) {
	defer perf.Track(nil, "sarif.Parse")()
