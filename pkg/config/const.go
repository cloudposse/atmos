...
const (
	...
	HelmRollbackOnFailureSectionName  = "rollback_on_failure"
	HelmAtomicSectionName             = "atomic"
	HelmWaitStrategySectionName       = "wait_strategy"
	HelmWaitSectionName               = "wait"
	HelmWaitForJobsSectionName        = "wait_for_jobs"
	HelmTimeoutSectionName            = "timeout"
	HelmCleanupOnFailSectionName      = "cleanup_on_fail"
