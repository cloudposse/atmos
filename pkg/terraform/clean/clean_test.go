...
func TestBuildCleanPath(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			componentPath: string(filepath.Separator) + filepath.Join("path", "to", "components"),
			expectedPath:  string(filepath.Separator) + filepath.Join("path", "to", "components", "base-vpc"),
			expectError:   false,
		},
		{
		...
		},
		{
			...
			componentPath: string(filepath.Separator) + filepath.Join("path", "to", "components"),
			expectedPath:  string(filepath.Separator) + filepath.Join("path", "to", "components"),
			expectError:   false,
		},
		{
			name: "No component",
