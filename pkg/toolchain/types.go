...
//go:generate go run go.uber.org/mock/mockgen@v0.6.0 -destination=mock_registry_test.go -package=toolchain github.com/cloudposse/atmos/pkg/toolchain/registry ToolRegistry
