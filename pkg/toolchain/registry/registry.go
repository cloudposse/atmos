...
//go:generate go run go.uber.org/mock/mockgen@v0.6.0 -destination=mock_registry_test.go -package=registry github.com/cloudposse/atmos/pkg/toolchain/registry ToolRegistry
