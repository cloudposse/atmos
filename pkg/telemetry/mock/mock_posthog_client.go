...
//
//	mockgen -destination=pkg/telemetry/mock/mock_posthog_client.go -package=mock_telemetry github.com/posthog/posthog-go Client
//
...
func (m *MockClient) CloseWithContext(arg0 context.Context) error {
	m.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) CloseWithContext(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CloseWithContext", reflect.TypeOf((*MockClient)(nil).CloseWithContext), arg0)
}
...
func (m *MockClient) GetFeatureFlag(arg0 posthog.FeatureFlagPayload) (any, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetFeatureFlagPayload(arg0 posthog.FeatureFlagPayload) (string, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) IsFeatureEnabled(arg0 posthog.FeatureFlagPayload) (any, error) {
	m.ctrl.T.Helper()
