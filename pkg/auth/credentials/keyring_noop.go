...
func (s *noopKeyringStore) Store(alias string, creds types.ICredentials, realm string) error {
...
// The realm parameter is accepted for interface compatibility but not used.
func (s *noopKeyringStore) Retrieve(alias string, realm string) (types.ICredentials, error) {
	defer perf.Track(nil, "credentials.noopKeyringStore.Retrieve")()

	log.Debug("Noop keyring: credentials managed externally", "alias", alias, "realm", realm)
...
// The realm parameter is accepted for interface compatibility but not used.
func (s *noopKeyringStore) Delete(alias string, realm string) error {
...
// The realm parameter is accepted for interface compatibility but not used.
func (s *noopKeyringStore) List(realm string) ([]string, error) {
...
// The realm parameter is accepted for interface compatibility but not used.
func (s *noopKeyringStore) IsExpired(alias string, realm string) (bool, error) {
