...
func (mr *MockProviderMockRecorder) Authenticate(ctx interface{}) *gomock.Call {
...
func (mr *MockProviderMockRecorder) Logout(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockProviderMockRecorder) PreAuthenticate(manager interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Authenticate indicates an expected call of Authenticate.
func (mr *MockIdentityMockRecorder) Authenticate(ctx, baseCreds interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Logout indicates an expected call of Logout.
func (mr *MockIdentityMockRecorder) Logout(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockIdentity) PostAuthenticate(ctx context.Context, stackInfo *schema.ConfigAndStacksInfo, providerName, identityName string, creds ICredentials) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PostAuthenticate", ctx, stackInfo, providerName, identityName, creds)
	ret0, _ := ret[0].(error)
	return ret0
}

// PostAuthenticate indicates an expected call of PostAuthenticate.
func (mr *MockIdentityMockRecorder) PostAuthenticate(ctx, stackInfo, providerName, identityName, creds interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PostAuthenticate", reflect.TypeOf((*MockIdentity)(nil).PostAuthenticate), ctx, stackInfo, providerName, identityName, creds)
}
...
// Authenticate indicates an expected call of Authenticate.
func (mr *MockAuthManagerMockRecorder) Authenticate(ctx, identityName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAuthManagerMockRecorder) GetProviderForIdentity(identityName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAuthManagerMockRecorder) GetProviderKindForIdentity(identityName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Logout indicates an expected call of Logout.
func (mr *MockAuthManagerMockRecorder) Logout(ctx, identityName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAuthManagerMockRecorder) LogoutAll(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAuthManagerMockRecorder) LogoutProvider(ctx, providerName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAuthManagerMockRecorder) Whoami(ctx, identityName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCredentialStoreMockRecorder) Delete(alias interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCredentialStoreMockRecorder) IsExpired(alias interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCredentialStoreMockRecorder) Retrieve(alias interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCredentialStoreMockRecorder) Store(alias, creds interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockValidatorMockRecorder) ValidateAuthConfig(config interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockValidatorMockRecorder) ValidateChains(identities, providers interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockValidatorMockRecorder) ValidateIdentity(name, identity, providers interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockValidatorMockRecorder) ValidateProvider(name, provider interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockICredentialsMockRecorder) BuildWhoamiInfo(info interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
