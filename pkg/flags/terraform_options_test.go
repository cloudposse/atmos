...
func TestTerraformOptions_IdentityFlag(t *testing.T) {
	tests := []struct {
		name                      string
		viperValue                string
		flagChanged               bool
...
func TestTerraformOptions_Embedding(t *testing.T) {
	// Test that TerraformOptions properly embeds GlobalFlags and implements CommandOptions.
	v := viper.New()
	v.Set("stack", "dev")
	...
	// Verify CommandOptions interface implementation.
...
func TestTerraformOptions_ZeroValues(t *testing.T) {
	// Test that zero-value TerraformOptions is safe to use.
...
func TestTerraformOptions_RealWorldScenarios(t *testing.T) {
	tests := []struct {
		name            string
		scenario        string
		viperValues     map[string]interface{}
		positionalArgs  []string
		passThroughArgs []string
		verify          func(t *testing.T, interpreter TerraformOptions)
	}{
		{
