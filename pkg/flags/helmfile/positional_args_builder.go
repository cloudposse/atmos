...
// PositionalArgsBuilder provides domain-specific builder for Helmfile command positional arguments.
...
//   - Auto-configures TargetField mapping to Options.Component
...
//	_, applyValidator, applyUsage := helmfile.NewPositionalArgsBuilder().
...
func NewPositionalArgsBuilder() *PositionalArgsBuilder {
	defer perf.Track(nil, "helmfile.NewPositionalArgsBuilder")()
...
func (b *PositionalArgsBuilder) WithComponent(required bool) *PositionalArgsBuilder {
	defer perf.Track(nil, "helmfile.PositionalArgsBuilder.WithComponent")()
...
func (b *PositionalArgsBuilder) Build() ([]*flags.PositionalArgSpec, cobra.PositionalArgs, string) {
	defer perf.Track(nil, "helmfile.PositionalArgsBuilder.Build")()
