...
func TestIdentityFlag_Methods(t *testing.T) {
	t.Run("flags.NewIdentitySelector creates flag with value", func(t *testing.T) {
		flag := flags.NewIdentitySelector("test-identity", true)
