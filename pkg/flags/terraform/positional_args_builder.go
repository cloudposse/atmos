...
// PositionalArgsBuilder provides domain-specific builder for Terraform command positional arguments.
...
//	_, deployValidator, deployUsage := terraform.NewPositionalArgsBuilder().
...
func NewPositionalArgsBuilder() *PositionalArgsBuilder {
	defer perf.Track(nil, "terraform.NewPositionalArgsBuilder")()
...
func (b *PositionalArgsBuilder) WithComponent(required bool) *PositionalArgsBuilder {
	defer perf.Track(nil, "terraform.PositionalArgsBuilder.WithComponent")()
