...
// TagInclude is the YAML tag for the include function.
const TagInclude = "!include"

// TagIncludeRaw is the YAML tag for the include.raw function.
const TagIncludeRaw = "!include.raw"
