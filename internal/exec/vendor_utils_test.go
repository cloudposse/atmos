...
func TestExecuteVendorPull(t *testing.T) {
	...
	files := []string{
		...
		"./components/terraform/mock2/outputs.tf",
		"./components/terraform/mock2/main.tf",
		"./components/terraform/mock2/variables.tf",
		"./components/terraform/mock2/versions.tf",
		"./components/terraform/mock2/README.md",
		"./components/terraform/mock1/outputs.tf",
		"./components/terraform/mock1/main.tf",
		"./components/terraform/mock1/variables.tf",
		"./components/terraform/mock1/versions.tf",
