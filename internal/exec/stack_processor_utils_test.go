...
// See docs/fixes/atmos-pro-template-regression-1205.md for details.
func TestAtmosProTemplateRegression(t *testing.T) {
	stacksBasePath := "../../tests/fixtures/scenarios/atmos-pro-template-regression/stacks"
	filePath := "../../tests/fixtures/scenarios/atmos-pro-template-regression/stacks/deploy/test.yaml"
