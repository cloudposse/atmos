...
var (
	...
	ErrInvalidComponentBackendTypeSection     = errors.New("invalid component backend_type section in the file")
	ErrInvalidComponentBackendSection         = errors.New("invalid component backend section in the file")
	ErrInvalidComponentRemoteStateBackendType = errors.New("invalid component remote_state_backend_type section in the file")
	ErrInvalidComponentRemoteStateBackend     = errors.New("invalid component remote_state_backend section in the file")
	ErrInvalidComponentOverridesSection       = errors.New("invalid component overrides section in the file")
	ErrInvalidTerraformOverridesSection       = errors.New("invalid terraform overrides section in the file")
	ErrInvalidHelmfileOverridesSection        = errors.New("invalid helmfile overrides section in the file")
	ErrInvalidComponentBasePathSection        = errors.New("invalid component base_path section in the file")
	ErrInvalidComponentCommandSection         = errors.New("invalid component command section in the file")
	ErrInvalidComponentDepsSection            = errors.New("invalid component deps section in the file")
	ErrInvalidComponentInheritanceChain       = errors.New("invalid component inheritance chain in the file")
