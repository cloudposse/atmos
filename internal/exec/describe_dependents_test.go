...
func TestDescribeDependentsExec_Execute_Success_NoQuery(t *testing.T) {
	...
	// Mock functions
	mockExecuteDescribeDependents := func(config *schema.AtmosConfiguration, component, stack string, includeSettings bool, processTemplates bool, processFunctions bool, skip []string, onlyInStack string) ([]schema.Dependent, error) {
...
func TestDescribeDependentsExec_Execute_Success_WithQuery(t *testing.T) {
	...
	exec := &describeDependentsExec{
		atmosConfig: atmosConfig,
		executeDescribeDependents: func(atmosConfig *schema.AtmosConfiguration, component, stack string, includeSettings bool, processTemplates bool, processFunctions bool, skip []string, onlyInStack string) ([]schema.Dependent, error) {
			return dependents, nil
		},
