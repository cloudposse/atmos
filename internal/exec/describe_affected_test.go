...
func TestDescribeAffectedScenarios(t *testing.T) {
	...
	// Now correctly detects all affected stacks including tgw/attachment components and prod stacks
	expected := []schema.Affected{
		...
		// Prod stacks - these are new stacks added in stacks-affected
		{
			Component:            "vpc",
			ComponentType:        "terraform",
			ComponentPath:        componentPath,
