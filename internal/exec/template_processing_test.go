...
func TestGetSprigFuncMap_Concurrent(t *testing.T) {
	...
	for i := 0; i < numGoroutines; i++ {
		go func() {
			...
			funcMap := templating.SprigFuncMap()
			if funcMap == nil {
