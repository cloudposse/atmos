...
var (
	// ErrNoVendorSourcesFound indicates a full vendor sweep found neither a vendor.yaml manifest
	// nor any component.yaml manifests under any component type.
	...
	// ErrValidateEverythingFlag indicates '--everything' was combined with '--component', '--stack',
	// '--tags', or '--labels', which is not allowed since '--everything' already selects every source.
