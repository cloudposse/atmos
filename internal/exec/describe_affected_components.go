...
// processTerraformComponents processes all Terraform components in a stack.
//
//nolint:cyclop,funlen,unused // Kept as reference implementation, replaced by processTerraformComponentsIndexed
func processTerraformComponents(
	stackName string,
...
// processHelmfileComponents processes all Helmfile components in a stack.
//
//nolint:cyclop,dupl,funlen,unused // Similar structure to processPackerComponents but for different component type; kept as reference
func processHelmfileComponents(
	stackName string,
...
// processPackerComponents processes all Packer components in a stack.
//
//nolint:cyclop,dupl,funlen,unused // Similar structure to processHelmfileComponents but for different component type; kept as reference
func processPackerComponents(
	stackName string,
...
// checkSettingsAndDependencies checks settings section and depends_on configuration.
//
//nolint:unused // Kept as reference implementation, replaced by checkSettingsAndDependenciesIndexed
func checkSettingsAndDependencies(
	affected *[]schema.Affected,
	atmosConfig *schema.AtmosConfiguration,
	componentName string,
	stackName string,
	...
	// Check settings.depends_on.
	return checkDependencyChanges(
		affected, atmosConfig, componentName, stackName, componentType,
		componentSection, settingsSection, changedFiles,
		includeSpaceliftAdminStacks, currentStacks, includeSettings,
	)
}

// checkDependencyChanges checks if dependent files or folders have changed.
// This helper reduces cyclomatic complexity of checkSettingsAndDependencies.
//
//nolint:unused // Kept as reference implementation, replaced by checkDependencyChangesIndexed
func checkDependencyChanges(
	affected *[]schema.Affected,
	atmosConfig *schema.AtmosConfiguration,
	componentName string,
	stackName string,
...
// ==============================================================================
// Indexed versions using changedFilesIndex (P9.4 optimization)
// ==============================================================================
