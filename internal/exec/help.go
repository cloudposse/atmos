...
func processHelp(componentType string, command string) error {
	if len(command) == 0 {
		...
		if componentType == "terraform" {
			...
			fmt.Println(" - 'atmos terraform deploy' command executes 'terraform apply -auto-approve' (sets the '-auto-approve' flag when running 'terraform apply')")
			...
			fmt.Println(" - 'atmos terraform apply' and 'atmos terraform deploy' commands commands support '--planfile' flag to specify the path " +
