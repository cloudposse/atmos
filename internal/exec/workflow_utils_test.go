...
// Tests for the stack-loading behavior of checkAndMergeDefaultIdentity have
// been removed. The function no longer performs a global raw-YAML pre-scan of
// stack files — that behavior was the root cause of Issues #2293 and
// discussion #122 (see
// docs/fixes/2026-04-08-atmos-auth-identity-resolution-fixes.md). The helper
// now only reads `atmosConfig.Auth.Identities`, which is expected to have
// been populated by the exec-layer stack processor for the target stack.
