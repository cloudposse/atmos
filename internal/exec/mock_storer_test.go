...
//
//	mockgen -package=exec -destination=mock_storer_test.go github.com/go-git/go-git/v5/storage Storer
//
...
func (m *MockStorer) AddAlternate(remote string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddAlternate", remote)
	ret0, _ := ret[0].(error)
	return ret0
}

// AddAlternate indicates an expected call of AddAlternate.
func (mr *MockStorerMockRecorder) AddAlternate(remote any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddAlternate", reflect.TypeOf((*MockStorer)(nil).AddAlternate), remote)
}

// CheckAndSetReference mocks base method.
func (m *MockStorer) CheckAndSetReference(new, old *plumbing.Reference) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CheckAndSetReference", new, old)
	ret0, _ := ret[0].(error)
	return ret0
}

// CheckAndSetReference indicates an expected call of CheckAndSetReference.
func (mr *MockStorerMockRecorder) CheckAndSetReference(new, old any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CheckAndSetReference", reflect.TypeOf((*MockStorer)(nil).CheckAndSetReference), new, old)
}
...
func (mr *MockStorerMockRecorder) EncodedObject(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStorerMockRecorder) EncodedObjectSize(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStorerMockRecorder) HasEncodedObject(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStorerMockRecorder) IterEncodedObjects(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockStorer) Module(name string) (storage.Storer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Module", name)
...
func (mr *MockStorerMockRecorder) Module(name any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Module", reflect.TypeOf((*MockStorer)(nil).Module), name)
}
...
func (mr *MockStorerMockRecorder) Reference(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStorerMockRecorder) RemoveReference(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStorerMockRecorder) SetConfig(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStorerMockRecorder) SetEncodedObject(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStorerMockRecorder) SetIndex(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStorerMockRecorder) SetReference(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStorerMockRecorder) SetShallow(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
