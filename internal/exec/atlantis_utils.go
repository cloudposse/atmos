...
// BuildAtlantisProjectNameFromComponentConfig2 builds an Atlantis project name from the component config
func BuildAtlantisProjectNameFromComponentConfig2(
	cliConfig schema.CliConfiguration,
