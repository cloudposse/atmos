...
var (
	...
	ErrTargetDirRequired                      = errors.New("target directory required")
	ErrLoadInitTemplates                      = errors.New("failed to load init templates")
	...
	ErrScaffoldMissingName                    = errors.New("scaffold name is required")
	ErrScaffoldInvalidPrompt                  = errors.New("invalid prompt configuration")
	ErrInvalidTemplateData                    = errors.New("invalid template data structure")
	...
	ErrUnprocessedTemplate                    = errors.New("unprocessed template syntax")
	ErrMergeConflict                          = errors.New("merge conflict")
	ErrCreateIOContext                        = errors.New("failed to create I/O context")
