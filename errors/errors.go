...
var (
	...
	ErrWebhookURLRequired            = errors.New("url is required for webhook step")
	ErrWebhookInvalidMethod          = errors.New("invalid HTTP method for webhook step")
	ErrWebhookBodyFormConflict       = errors.New("webhook step cannot set both body and form")
	ErrWebhookInvalidExpectPattern   = errors.New("invalid expect.response regex pattern for webhook step")
	ErrWebhookRequestFailed          = errors.New("webhook request failed")
	ErrWebhookUnexpectedStatus       = errors.New("webhook response did not match expected status")
	ErrWebhookUnexpectedResponse     = errors.New("webhook response body did not match expected pattern")
