...
var (
	...
	ErrAIProjectInstructionsNotFound  = errors.New("project instructions file (ATMOS.md) not found")
	ErrAIProjectInstructionsNotLoaded = errors.New("project instructions not loaded")
	ErrAIProjectInstructionsExists    = errors.New("project instructions file already exists")
