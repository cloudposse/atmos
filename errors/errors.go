...
var (
	...
	ErrMissingSVGRenderer                    = errors.New("missing SVG renderer; SVG output is not currently supported")
	ErrMissingRenderOutput                   = errors.New("specify at least one output flag: --svg, --gif, or --mp4")
