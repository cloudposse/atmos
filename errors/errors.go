...
var (
	...
	ErrAICommandCompoundNotAllowed  = errors.New("compound shell commands are not allowed for security reasons")
	ErrAICommandParseFailed         = errors.New("failed to parse shell command")
