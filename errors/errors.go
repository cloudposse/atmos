...
var (
	...
	ErrMCPConfigReadFailed      = errors.New("failed to read config file")
	ErrMCPConfigParseFailed     = errors.New("failed to parse config file")
	ErrMCPConfigWriteFailed     = errors.New("failed to write config file")
