...
require (
	...
	github.com/getsentry/sentry-go v0.45.1 // Pinned: cockroachdb/errors v1.12.0 (latest) still references sentry.Event.Extra, which was removed in sentry-go v0.46.0. Bump after cockroachdb/errors releases a compatible version.
