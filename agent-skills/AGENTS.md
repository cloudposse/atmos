...
| Migrating to Atmos from Terraform, Terraform Workspaces, or a task runner (Make, Just, or Task): layout, workspace mapping, remote-state bridge, task-to-command mapping | `atmos-migration`       | `agent-skills/skills/atmos-migration/SKILL.md`       |
