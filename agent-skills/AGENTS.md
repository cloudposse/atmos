...
| Migrating to Atmos from native Terraform/OpenTofu, Terraform Workspaces, or Terramate: layout, workspace mapping, remote-state bridge, generate_hcl/script decomposition, Atlantis-to-Native-CI migration | `atmos-migration`       | `agent-skills/skills/atmos-migration/SKILL.md`       |
