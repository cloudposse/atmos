...
| Migrating to Atmos from native Terraform/OpenTofu, Terraform Workspaces, or Terramate (layout, workspace mapping, remote-state bridge, generate_hcl/script decomposition), Atlantis-to-Native-CI migration, or CLI tool-version migration from mise/Aqua CLI to the Atmos toolchain | `atmos-migration`       | `agent-skills/skills/atmos-migration/SKILL.md`       |
