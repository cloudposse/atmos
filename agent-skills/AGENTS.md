...
| Migrating to Atmos from native Terraform/OpenTofu or Terraform Workspaces, or migrating CLI tool-version management from mise or Aqua CLI to the Atmos toolchain | `atmos-migration`       | `agent-skills/skills/atmos-migration/SKILL.md`       |
