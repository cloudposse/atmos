...
| Migrating to Atmos from native Terraform/OpenTofu or Terraform Workspaces: layout, workspace mapping, remote-state bridge, Atlantis-to-Native-CI migration | `atmos-migration`       | `agent-skills/skills/atmos-migration/SKILL.md`       |
