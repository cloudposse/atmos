...
| GitHub Actions `concurrency` around jobs or workflows that invoke `atmos` | Do not treat it as a FIFO deployment queue; reconsider it if cancellation can leave Terraform locks |
